...
from typing import Callable, IO, List, Dict, Union, Tuple, Any
...
TYPE_MAP: Dict[TypeAnnotation, Tuple[str, ...]] = {
    bytes: ("bytes", "blob"),
    bool: ("boolean",),
    Callable[..., Any]: ("function",),
    BaseClient: ("botocore or boto3 Client",),
    datetime: ("datetime", "timestamp"),
    Dict[str, Any]: ("dict", "structure", "map"),
    float: ("float", "double"),
    int: ("int", "integer", "long"),
    IO[Any]: ("a file-like object", "seekable file-like object"),
    List[Any]: ("list",),
    ...
    Union[bytes, IO]: ("bytes or seekable file-like object",),
    Union[str, Dict]: ("str or dict",),
...
TYPE_MAP_REVERSED: Dict[str, TypeAnnotation] = {}
for type_annotation, str_reprs in TYPE_MAP.items():
    for str_repr in str_reprs:
        TYPE_MAP_REVERSED[str_repr] = type_annotation
