...
class Client(BaseClient):
    ...
    def count_pending_activity_tasks(
        ...
        approximation and isn't guaranteed to be exact. If you specify a task list that no activity task
        was ever scheduled in then ``0`` is returned.
    ...
    def count_pending_decision_tasks(
        ...
        approximation and isn't guaranteed to be exact. If you specify a task list that no decision task
        was ever scheduled in then ``0`` is returned.
          ...
          - *(dict) --*
            ...
            - **configuration** *(dict) --*
              ...
              - **defaultTaskList** *(dict) --*
                ...
                ``ScheduleActivityTask``   Decision . You can override the default registered task list
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **latestExecutionContext** *(string) --*
              ...
              The latest executionContext provided by the decider for this workflow execution. A decider
              can provide an executionContext (a free-form string) when closing a decision task using
          ...
          - *(dict) --*
            ...
            - **configuration** *(dict) --*
              ...
              - **defaultTaskStartToCloseTimeout** *(string) --*
                ...
                task for executions of this workflow type might take before returning completion or
                failure. If the task doesn'tdo close in the specified time then the task is automatically
                timed out and rescheduled. If the decider eventually reports a completion or failure, it is
                ignored. This default can be overridden when starting a workflow execution using the
    ...
    def get_workflow_execution_history(
        ...
        **Request Syntax**
        ...
        :param nextPageToken:
          ...
          retrieve the next page. Keep all other arguments unchanged. Each pagination token expires after
          60 seconds. Using an expired pagination token will return a ``400`` error: "``Specified token has
        ...
        :param reverseOrder:
          ...
          When set to ``true`` , returns the events in reverse order. By default the results are returned
                ...
                'events': [
                    {
                        ...
                        |'RecordMarkerFailed'|'TimerStarted'|'StartTimerFailed'|'TimerFired'
                        |'TimerCanceled'|'CancelTimerFailed'|'StartChildWorkflowExecutionInitiated'
                ...
                * ``WorkflowExecutionTimedOut`` – The workflow execution was closed because a time out was
                ...
                - **completeWorkflowExecutionFailedEventAttributes** *(dict) --*
                  ...
                  - **cause** *(string) --*
                    ...
                    .. note::
                      ...
                      lacked sufficient permissions. For details and example IAM policies, see `Using IAM
                ...
                - **workflowExecutionContinuedAsNewEventAttributes** *(dict) --*
                  ...
                  - **decisionTaskCompletedEventId** *(integer) --*
                    ...
                    The ID of the ``DecisionTaskCompleted`` event corresponding to the decision task that
                    resulted in the ``ContinueAsNewWorkflowExecution`` decision that started this
                ...
                - **startChildWorkflowExecutionInitiatedEventAttributes** *(dict) --*
                  ...
                  - **childPolicy** *(string) --*
                    ...
                    by explicitly calling the  TerminateWorkflowExecution action or due to an expired
                    timeout.
                ...
                - **childWorkflowExecutionCompletedEventAttributes** *(dict) --*
                  ...
                  - **startedEventId** *(integer) --*
                    ...
                    execution was started. This information can be useful for diagnosing problems by
    ...
    def list_activity_types(
        ...
        specified name and registration status. The result includes information like creation date, current
        status of the activity, etc. The results may be split into multiple pages. To retrieve subsequent
    ...
    def poll_for_activity_task(
        ...
        context, means that an ActivityTask is returned, but that the value of taskToken is an empty
        string. If a task is returned, the worker should use its type to identify and process it correctly.
    ...
    def poll_for_decision_task(
        ...
        .. warning::
          ...
          pages, make additional calls to ``PollForDecisionTask`` using the ``nextPageToken`` returned by
          the initial call. Note that you do *not* call ``GetWorkflowExecutionHistory`` with this
        ...
        **Request Syntax**
        ...
        :param nextPageToken:
          ...
          .. note::
            ...
            retrieve the next page of history records. Calling  PollForDecisionTask with a
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **events** *(list) --*
              ...
              A paginated list of history events of the workflow execution. The decider uses this during
              the processing of the decision task.
    ...
    def register_workflow_type(
        ...
        .. warning::
          ...
          configuration settings of a workflow type once it is registered and it must be registered as a
          new version.
    ...
    def respond_activity_task_canceled(
        ...
        is reported as open while a worker is processing it. A task is closed after it has been specified
        in a call to  RespondActivityTaskCompleted , RespondActivityTaskCanceled,
        ...
        :param decisions:
          ...
          - *(dict) --*
            ...
            * ``StartTimer`` – Starts a timer for this workflow execution and records a ``TimerStarted``
            ...
            keep policies readable. For details and example IAM policies, see `Using IAM to Manage Access
            ...
            * The ordering of decisions should follow a logical flow. Some decisions might not make sense
            in the current context of the workflow execution and therefore fails.
            ...
            * ``ScheduleActivityTaskFailed`` – A ``ScheduleActivityTask`` decision failed. This could
            happen if the activity type specified in the decision isn't registered, is in a deprecated
            ...
            * `` StartChildWorkflowExecutionDecisionAttributes ``
            ...
            - **scheduleActivityTaskDecisionAttributes** *(dict) --*
              ...
              - **heartbeatTimeout** *(string) --*
                ...
                the activity task is automatically timed out. If the worker subsequently attempts to record
                a heartbeat or returns a result, it is ignored. This overrides the default heartbeat
            ...
            - **continueAsNewWorkflowExecutionDecisionAttributes** *(dict) --*
              ...
              - **executionStartToCloseTimeout** *(string) --*
                ...
                .. note::
                  ...
                  as a default for the workflow type or through this field. If neither this field is set
              ...
              - **taskStartToCloseTimeout** *(string) --*
                ...
                .. note::
                  ...
                  A task start-to-close timeout for the new workflow execution must be specified either as
            ...
            - **startChildWorkflowExecutionDecisionAttributes** *(dict) --*
              ...
              - **executionStartToCloseTimeout** *(string) --*
                ...
                .. note::
                  ...
                  is set nor a default execution start-to-close timeout was specified at registration time
    ...
    def start_workflow_execution(
        ...
        **Request Syntax**
        ...
        :param workflowId: **[REQUIRED]**
          ...
          a custom identifier with the workflow execution. You may specify the same identifier if a
          workflow execution is logically a *restart* of a previous execution. You cannot have two open
        ...
        :param taskPriority:
          ...
          The task priority to use for this workflow execution. This overrides any default priority that
          was assigned when the workflow type was registered. If not set, then the default task priority
          for the workflow type is used. Valid values are integers that range from Java's
          ``Integer.MIN_VALUE`` (-2147483648) to ``Integer.MAX_VALUE`` (2147483647). Higher numbers
          indicate higher priority.
        ...
        :param input:
          ...
          The input for the workflow execution. This is a free form string which should be meaningful to
          the workflow you are starting. This ``input`` is made available to the new workflow execution in
