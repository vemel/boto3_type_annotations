...
class Client(BaseClient):
    ...
    def delete_utterances(self, botName: str, userId: str) -> None:
        ...
        Use the ``DeleteStoredUtterances`` operation to manually delete stored utterances for a specific
        user.
    ...
    def get_utterances_view(
        ...
        .. note::
          ...
          request information for up to 5 versions in each request. The response contains information about
    ...
    def put_bot(
        ...
        **Request Syntax**
        ...
        :param voiceId:
          ...
          `Available Voices <http://docs.aws.amazon.com/polly/latest/dg/voicelist.html>`__ in the *Amazon
