          ...
          ::

            {
                'failedItems': {
                    'string': {
                        'failureCode':
                        'INVALID_ARN'|'DUPLICATE_ARN'|'ITEM_DOES_NOT_EXIST'|'ACCESS_DENIED'
    ...
    def create_assessment_target(
        ...
        **Request Syntax**
        ...
        :param assessmentTargetName: **[REQUIRED]**
          ...
          The user-defined name that identifies the assessment target that you want to create. The name
    ...
    def create_assessment_template(
        ...
        **Request Syntax**
        ...
        :param userAttributesForFindings:
          ...
          Attribute object). Within an assessment template, each key must be unique.
    ...
    def list_exclusions(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          You can use this parameter when paginating results. Set the value of this parameter to null on
          your first call to the ListExclusionsRequest action. Subsequent calls to the action fill
          nextToken in the request with the value of nextToken from the previous response to continue
          listing data.
    ...
    def preview_agents(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          You can use this parameter when paginating results. Set the value of this parameter to null on
          your first call to the **PreviewAgents** action. Subsequent calls to the action fill
          **nextToken** in the request with the value of **NextToken** from the previous response to
          continue listing data.
    ...
    def stop_assessment_run(
        ...
        **Request Syntax**
        ...
        :param stopAction:
          ...
          and the findings generation process. SKIP_EVALUATION cancels the assessment run immediately,
    ...
    def subscribe_to_event(self, resourceArn: str, event: str, topicArn: str) -> None:
        ...
        **Request Syntax**
        ...
        :param resourceArn: **[REQUIRED]**
          ...
          The ARN of the assessment template that is used during the event for which you want to receive
          SNS notifications.
    ...
    def update_assessment_target(
        ...
        **Request Syntax**
        ...
        :param resourceGroupArn:
          ...
          The ARN of the resource group that is used to specify the new resource group to associate with
