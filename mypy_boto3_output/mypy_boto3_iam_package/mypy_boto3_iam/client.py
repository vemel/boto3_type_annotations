...
class Client(BaseClient):
    ...
    def add_role_to_instance_profile(
        ...
        AWS because of `eventual consistency <https://en.wikipedia.org/wiki/Eventual_consistency>`__ . To
    ...
    def attach_role_policy(self, RoleName: str, PolicyArn: str) -> None:
        ...
        to a role, the managed policy becomes part of the role's permission (access) policy.
    ...
    def create_account_alias(self, AccountAlias: str) -> None:
        ...
        **Request Syntax**
        ...
        :param AccountAlias: **[REQUIRED]**
          ...
          This parameter allows (through its `regex pattern <http://wikipedia.org/wiki/regex>`__ ) a string
          of characters consisting of lowercase letters, digits, and dashes. You cannot start or finish
    ...
    def create_open_id_connect_provider(
        ...
        **Request Syntax**
        ...
        :param Url: **[REQUIRED]**
          ...
          submit a URL that has already been used for an OpenID Connect provider in the AWS account, you
          will get an error.
    ...
    def create_policy(
        ...
        Policies <https://docs.aws.amazon.com/IAM/latest/UserGuide/policies-managed-versions.html>`__ in
        the *IAM User Guide* .
    ...
    def create_role(
        ...
        limitations on role names and the number of roles you can create, go to `Limitations on IAM
        Entities <https://docs.aws.amazon.com/IAM/latest/UserGuide/LimitationsOnEntities.html>`__ in the
        *IAM User Guide* .
        ...
        **Request Syntax**
        ...
        :param MaxSessionDuration:
          ...
          operations or the ``assume-role*`` CLI operations but does not apply when you use those
        ...
        :param Tags:
          ...
          .. note::
            ...
            If any one of the tags is invalid or if you exceed the allowed number of tags per role, then
            the entire request fails and the role is not created.
    ...
    def create_service_specific_credential(
        ...
        the service specified in the request. These credentials are generated by IAM, and can be used only
    ...
    def create_user(
        ...
        For information about limitations on the number of IAM users you can create, see `Limitations on
        IAM Entities <https://docs.aws.amazon.com/IAM/latest/UserGuide/LimitationsOnEntities.html>`__ in
        the *IAM User Guide* .
    ...
    def delete_access_key(self, AccessKeyId: str, UserName: str = None) -> None:
        ...
        If you do not specify a user name, IAM determines the user name implicitly based on the AWS access
        key ID signing the request. This operation works for access keys under the AWS account.
        Consequently, you can use this operation to manage AWS account root user credentials even if the
    ...
    def delete_policy(self, PolicyArn: str) -> None:
        ...
        * Delete all versions of the policy using  DeletePolicyVersion . To list the policy's versions, use
         ListPolicyVersions . You cannot use  DeletePolicyVersion to delete the version that is marked as
         the default version. You delete the policy's default version in the next step of the process.
    ...
    def delete_server_certificate(self, ServerCertificateName: str) -> None:
        ...
        .. warning::
          ...
          Balancing to stop accepting traffic. We recommend that you remove the reference to the
          certificate from Elastic Load Balancing before using this command to delete the certificate. For
    ...
    def delete_service_linked_role(
        ...
        If you submit a deletion request for a service-linked role whose linked service is still accessing
        a resource, then the deletion task fails. If it fails, the  GetServiceLinkedRoleDeletionStatus API
        operation returns the reason for the failure, usually including the resources that must be deleted.
        To delete the service-linked role, you must first remove those resources from the linked service
        and then submit the deletion request again. Resources are specific to the service that is linked to
    ...
    def generate_organizations_access_report(
        ...
        *IAM User Guide* .
        ...
        and an optional AWS Organizations policy ID. This data includes a list of services that are allowed
        ...
        *IAM User Guide* .
        ...
        .. warning::
          ...
          any of the command line tools. An unexpected entry in the service last accessed data does not
          mean that an account has been compromised, because the request might have been denied. Refer to
          your CloudTrail logs as the authoritative source for information about all API calls and whether
          they were successful or denied access. For more information, see `Logging IAM Events with
          CloudTrail <https://docs.aws.amazon.com/IAM/latest/UserGuide/cloudtrail-integration.html>`__ in
          the *IAM User Guide* .

        This operation returns a ``JobId`` . Use this parameter in the ``  GetOrganizationsAccessReport ``
        operation to check the status of the report generation. To check the status of this request, use
        the ``JobId`` parameter in the ``  GetOrganizationsAccessReport `` operation and test the
        ``JobStatus`` response parameter. When the job is complete, you can retrieve the report.
        ...
        * **Account** – When you specify another account as the entity, the resulting report lists all of
        the services allowed by SCPs that are attached to the account and its parents. For each service,
        the report includes data for only the specified account.
        ...
        * **Root** – When you specify the root entity and a policy ID, the resulting report lists all of
        the services that are allowed by the specified SCP. For each service, the report includes data for
        all accounts in your organization to which the SCP applies. This data excludes the master account,
        because the master account is not limited by SCPs. If the SCP is not attached to any entities in
        the organization, then the report will return a list of services with no data.
        ...
        * **OU** – When you specify an OU entity and a policy ID, the resulting report lists all of the
        ...
        the OU that are affected by the SCP might not be included in the data. This data excludes the
        master account, because the master account is not limited by SCPs. If the SCP is not attached to
        the OU or one of its children, the report will return a list of services with no data.
        ...
        **Request Syntax**
        ...
        :param OrganizationsPolicyId:
          ...
          SCP attempted to access an AWS service.
    ...
    def generate_service_last_accessed_details(
        ...
        .. warning::
          ...
          successful ones. This includes all attempts that were made using the AWS Management Console, the
          AWS API through any of the SDKs, or any of the command line tools. An unexpected entry in the
          service last accessed data does not mean that your account has been compromised, because the
          request might have been denied. Refer to your CloudTrail logs as the authoritative source for
          information about all API calls and whether they were successful or denied access. For more
          information, see `Logging IAM Events with CloudTrail
          <https://docs.aws.amazon.com/IAM/latest/UserGuide/cloudtrail-integration.html>`__ in the *IAM
          User Guide* .
    ...
    def get_access_key_last_used(
        ...
        the date and time of last use, along with the AWS service and Region that were specified in the
        last request made with that key.
    ...
    def get_context_keys_for_custom_policy(
        ...
        as a list of one or more strings. To get the context keys from policies associated with an IAM
        ...
        context of an API query request. Context keys can be evaluated by testing against a value specified
        in an IAM policy. Use ``GetContextKeysForCustomPolicy`` to understand what key names and values you
        must supply when you call  SimulateCustomPolicy . Note that all parameters are shown in unencoded
    ...
    def get_context_keys_for_principal_policy(
        ...
        specified IAM entity. The entity can be an IAM user, group, or role. If you specify a user, then
        the request also includes all of the policies attached to groups that the user is a member of.
        ...
        Context keys are variables maintained by AWS and its services that provide details about the
        context of an API query request. Context keys can be evaluated by testing against a value in an IAM
        policy. Use  GetContextKeysForPrincipalPolicy to understand what key names and values you must
        supply when you call  SimulatePrincipalPolicy .
        ...
        **Request Syntax**
        ...
        :param PolicySourceArn: **[REQUIRED]**
          ...
          a group or a role, then it includes only those context keys that are found in policies attached
          to that entity. Note that all parameters are shown in unencoded form here for clarity, but must
    ...
    def get_open_id_connect_provider(
        ...
        **Request Syntax**
        ...
        :param OpenIDConnectProviderArn: **[REQUIRED]**
          ...
          for. You can get a list of OIDC provider resource ARNs by using the  ListOpenIDConnectProviders
          operation.
    ...
    def get_organizations_access_report(
        ...
        using the ``  GenerateOrganizationsAccessReport `` operation. This operation retrieves the status
        ...
        be enabled for your organization root. You must have permissions to perform this operation. For
        more information, see `Refining Permissions Using Service Last Accessed Data
        <https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_access-advisor.html>`__ in the
        *IAM User Guide* .
    ...
    def get_policy(self, PolicyArn: str) -> ClientGetPolicyResponseTypeDef:
        ...
        and the total number of IAM users, groups, and roles to which the policy is attached. To retrieve
        the list of the specific users, groups, and roles that the policy is attached to, use the
        ListEntitiesForPolicy API. This API returns metadata about the policy. To retrieve the actual
        policy document for a specific version of the policy, use  GetPolicyVersion .
    ...
    def get_role(self, RoleName: str) -> ClientGetRoleResponseTypeDef:
        ...
        see `Working with Roles <https://docs.aws.amazon.com/IAM/latest/UserGuide/WorkingWithRoles.html>`__
        .
    ...
    def get_service_last_accessed_details(
        ...
        complete, you can retrieve the generated report. The report includes a list of AWS services that
        ...
        details about the most recent access attempt. If there was no attempt, the service is listed
    ...
    def list_entities_for_policy(
        ...
        **Request Syntax**
        ...
        :param EntityFilter:
          ...
          specified policy are returned. This parameter is optional. If it is not included, all attached
          entities (users, groups, and roles) are returned. The argument for this parameter must be one of
    ...
    def list_instance_profiles_for_role(
        ...
        Instance Profiles <https://docs.aws.amazon.com/IAM/latest/UserGuide/AboutInstanceProfiles.html>`__ .
    ...
    def list_mfa_devices(
        ...
        lists all the MFA devices associated with the specified user. If you do not specify a user name,
        IAM determines the user name implicitly based on the AWS access key ID signing the request for this
        API.
    ...
    def list_policies(
        ...
        in your AWS account, set ``Scope`` to ``Local`` . To list only AWS managed policies, set ``Scope``
        to ``AWS`` .
    ...
    def list_policies_granting_service_access(
        ...
        * **Role** – The list of policies includes only the managed and inline policies that are attached
        to the role.
    ...
    def list_role_tags(
        ...
        **Request Syntax**
        ...
        :param RoleName: **[REQUIRED]**
          ...
          This parameter accepts (through its `regex pattern <http://wikipedia.org/wiki/regex>`__ ) a
          string of characters that consist of upper and lowercase alphanumeric characters with no spaces.
    ...
    def list_roles(
        ...
        """
        Lists the IAM roles that have the specified path prefix. If there are none, the operation returns
        an empty list. For more information about roles, go to `Working with Roles
        <https://docs.aws.amazon.com/IAM/latest/UserGuide/WorkingWithRoles.html>`__ .
    ...
    def list_virtual_mfa_devices(
        ...
        specify an assignment status, the operation returns a list of all virtual MFA devices. Assignment
    ...
    def put_group_policy(
        ...
        .. note::
          ...
          Query Requests <https://docs.aws.amazon.com/IAM/latest/UserGuide/IAM_UsingQueryAPI.html>`__ in
          the *IAM User Guide* .
    ...
    def put_user_permissions_boundary(
        ...
        .. warning::
          ...
          a permissions policy to the user. To learn how the effective permissions for a user are
    ...
    def put_user_policy(
        ...
        use  AttachUserPolicy . To create a new managed policy, use  CreatePolicy . For information about
        policies, see `Managed Policies and Inline Policies
        <https://docs.aws.amazon.com/IAM/latest/UserGuide/policies-managed-vs-inline.html>`__ in the *IAM
        User Guide* .
    ...
    def remove_client_id_from_open_id_connect_provider(
        ...
        **Request Syntax**
        ...
        :param OpenIDConnectProviderArn: **[REQUIRED]**
          ...
          You can get a list of OIDC provider ARNs by using the  ListOpenIDConnectProviders operation.
    ...
    def resync_mfa_device(
        ...
        For more information about creating and working with virtual MFA devices, go to `Using a Virtual
        MFA Device <https://docs.aws.amazon.com/IAM/latest/UserGuide/Using_VirtualMFA.html>`__ in the *IAM
        User Guide* .
    ...
    def simulate_custom_policy(
        ...
        The simulation does not perform the API operations; it only checks the authorization to determine
        if the simulated policies allow or deny the operations.
        ...
        **Request Syntax**
        ...
        :param PolicyInputList: **[REQUIRED]**
          ...
          <https://docs.aws.amazon.com/IAM/latest/APIReference/API_GetFederationToken.html>`__ or one of
          the `AssumeRole <https://docs.aws.amazon.com/IAM/latest/APIReference/API_AssumeRole.html>`__ API
        ...
        :param ResourceOwner:
          ...
          does not identify its owner in the resource ARN. Examples of resource ARNs include an S3 bucket
          or object. If ``ResourceOwner`` is specified, it is also used as the account owner of any
        ...
        :param ResourceHandlingOption:
          ...
          resource. If the EC2 scenario includes VPC, then you must supply the network-interface resource.
          If it includes an IP subnet, then you must specify the subnet resource. For more information on
          the EC2 scenario options, see `Supported Platforms
                ...
                - **ResourceSpecificResults** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **MatchedStatements** *(list) --*
                      ...
                      on the resource, if *any* statement denies that operation, then the explicit deny
                    ...
                    - **MissingContextValues** *(list) --*
                      ...
                      ``ResourceArns`` parameter, then any missing context values are instead included
    ...
    def simulate_principal_policy(
        ...
        and AWS resources to determine the policies' effective permissions. The entity can be an IAM user,
        ...
        **Request Syntax**
        ...
        :param PolicySourceArn: **[REQUIRED]**
          ...
          are associated with that entity. If you specify a user, the simulation also includes all policies
        ...
        :param ResourceOwner:
          ...
          included in the simulation. If the ``ResourceOwner`` parameter is not specified, then the owner
          of the resources and the resource policy defaults to the account of the identity provided in
          ``CallerArn`` . This parameter is required only if you specify a resource-based policy and
          account that owns the resource is different from the account that owns the simulated calling user
          ``CallerArn`` .
        ...
        :param CallerArn:
          ...
          If you do not specify a ``CallerArn`` , it defaults to the ARN of the user that you specify in
    ...
    def tag_user(self, UserName: str, Tags: List[ClientTagUserTagsTypeDef]) -> None:
        ...
        * **Access control** - Reference tags in IAM user-based and resource-based policies. You can use
        ...
        attached. You can also restrict access to only those resources that have a certain tag attached.
        For examples of policies that show how to use tags to control access, see `Control Access Using IAM
        Tags <https://docs.aws.amazon.com/IAM/latest/UserGuide/access_tags.html>`__ in the *IAM User Guide*
        .
    ...
    def update_access_key(
        ...
        If the ``UserName`` is not specified, the user name is determined implicitly based on the AWS
        access key ID used to sign the request. This operation works for access keys under the AWS account.
        Consequently, you can use this operation to manage AWS account root user credentials even if the
        AWS account has no associated users.
    ...
    def update_account_password_policy(
        ...
        **Request Syntax**
        ...
        :param AllowUsersToChangePassword:
          ...
          <https://docs.aws.amazon.com/IAM/latest/UserGuide/HowToPwdIAMUser.html>`__ in the *IAM User
          Guide* .
    ...
    def update_assume_role_policy(self, RoleName: str, PolicyDocument: str) -> None:
        ...
        referred to as the "role trust policy". For more information about roles, go to `Using Roles to
    ...
    def update_server_certificate(
        ...
        .. note::
          ...
          see `Access Management <https://docs.aws.amazon.com/IAM/latest/UserGuide/access.html>`__ in the
          *IAM User Guide* .
    ...
    def upload_server_certificate(
        ...
        <https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_iam-limits.html>`__ in the *IAM User
        Guide* .
    ...
    def upload_ssh_public_key(
        ...
        IAM user to an AWS CodeCommit repository. For more information about using SSH keys to authenticate
