...
class AccountPasswordPolicy(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        ...
        AccountPasswordPolicy resource. Note that the load and reload methods are the same method and can
...
class ServerCertificate(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        ...
        ServerCertificate resource. Note that the load and reload methods are the same method and can be
...
class ServiceResourceVirtualMfaDevicesCollection(ResourceCollection):
    ...
    def filter(
        ...
        """
        Creates an iterable of all VirtualMfaDevice resources in the collection filtered by kwargs passed
        to method.
