...
class Client(BaseClient):
    ...
    def create_comment(
        ...
        **Request Syntax**
        ...
        :param NotifyCollaborators:
          ...
          Set this parameter to TRUE to send an email out to the document collaborators after the comment
          is created.
    ...
    def describe_users(
        ...
        **Request Syntax**
        ...
        :param Fields:
          ...
          A comma-separated list of values. Specify "STORAGE_METADATA" to include the user storage quota
    ...
    def get_current_user(
        ...
        """
        Retrieves details of the current user for whom the authentication token was generated. This is not
        a valid action for SigV4 (administrative API) clients.
    ...
    def get_document_path(
        ...
        only includes the IDs of the parent folders in the path. You can limit the maximum number of
        levels. You can also request the names of the parent folders.
    ...
    def get_folder_path(
        ...
        only includes the IDs of the parent folders in the path. You can limit the maximum number of
        levels. You can also request the parent folder names.
