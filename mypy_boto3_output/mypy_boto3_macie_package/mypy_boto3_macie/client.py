...
class Client(BaseClient):
    ...
    def disassociate_s3_resources(
        ...
        memberAccountId is specified, the action removes specified S3 resources from Macie for the
    ...
    def list_s3_resources(
        ...
        memberAccountId is specified, the action lists the S3 resources associated with Amazon Macie for
    ...
    def update_s3_resources(
        ...
        specified, the action updates the classification types of the S3 resources associated with Amazon
        Macie for the current master account. If memberAccountId is specified, the action updates the
        classification types of the S3 resources associated with Amazon Macie for the specified member
        account.
        ...
        **Request Syntax**
        ...
        :param memberAccountId:
          ...
          The AWS ID of the Amazon Macie member account whose S3 resources' classification types you want
          to update.
