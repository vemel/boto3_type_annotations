...
class Client(BaseClient):
    ...
    def batch_detect_dominant_language(
        ...
        **Request Syntax**
        ...
        :param TextList: **[REQUIRED]**
          ...
          documents. Each document should contain at least 20 characters and must contain fewer than 5,000
    ...
    def create_document_classifier(
        ...
        you provide a set of training documents that labeled with the categories that you want to use.
        After the classifier is trained you can use it to categorize a set of labeled documents into the
    ...
    def create_entity_recognizer(
        ...
        is submitted, you can check job status using the API.
    ...
    def describe_document_classifier(
        ...
        **Request Syntax**
        ...
        :param DocumentClassifierArn: **[REQUIRED]**
          ...
          The Amazon Resource Name (ARN) that identifies the document classifier. The operation returns
    ...
    def describe_dominant_language_detection_job(
        ...
        """
        Gets the properties associated with a dominant language detection job. Use this operation to get
    ...
    def describe_topics_detection_job(
        ...
        """
        Gets the properties associated with a topic detection job. Use this operation to get the status of
        a detection job.
    ...
    def detect_dominant_language(
        ...
        **Request Syntax**
        ...
        :param Text: **[REQUIRED]**
          ...
          A UTF-8 text string. Each string should contain at least 20 characters and must contain fewer
    ...
    def start_entities_detection_job(
        ...
        be used for custom entity recognition, the optional ``EntityRecognizerArn`` must be used in order
        to provide access to the recognizer being used to detect the custom entity.
    ...
    def tag_resource(
        ...
        """
        Associates a specific tag with an Amazon Comprehend resource. A tag is a key-value pair that adds
