...
def boto3_client(
    ...
    if session is not None:
        return session.client("mediapackage", **kwargs)
    return boto3.client("mediapackage", **kwargs)
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_harvest_jobs_paginator(client: Client) -> ListHarvestJobsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_origin_endpoints_paginator(client: Client) -> ListOriginEndpointsPaginator:
    """
