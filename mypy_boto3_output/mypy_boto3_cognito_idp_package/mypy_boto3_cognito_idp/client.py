...
class Client(BaseClient):
    ...
    def admin_create_user(
        ...
        Alternatively, you can call AdminCreateUser with “SUPPRESS” for the ``MessageAction`` parameter,
        ...
        **Request Syntax**
        ...
        :param UserAttributes:
          ...
          * **phone_number** : The phone number of the user to whom the message that contains the code and
          username will be sent. Required if the ``phone_number_verified`` attribute is set to ``True`` ,
        ...
        :param TemporaryPassword:
          ...
          specified when you created the user pool. To reset the account after that time limit, you must
    ...
    def admin_disable_provider_for_user(
        ...
        If the user to disable is a Cognito User Pools native username + password user, they are not
        permitted to use their password to sign-in. If the user to disable is a linked external IdP user,
        any link between that user and an existing user is removed. The next time the external user (no
        longer attached to the previously linked ``DestinationUser`` ) signs in, they must create a new
        user account. See .
        ...
        To disable a native username + password user, the ``ProviderName`` value must be ``Cognito`` and
        the ``ProviderAttributeName`` must be ``Cognito_Subject`` , with the ``ProviderAttributeValue``
        ...
        values that were used for the ``SourceUser`` when the identities were originally linked in the
        ...
        **Request Syntax**
        ...
        :param AuthFlow: **[REQUIRED]**
          ...
          * ``USER_PASSWORD_AUTH`` : Non-SRP authentication flow; USERNAME and PASSWORD are passed
          directly. If a user migration Lambda trigger is set, this flow will invoke the user migration
    ...
    def admin_link_provider_for_user(
        ...
        external identity provider (``SourceUser`` ) based on a specified attribute name and value from the
        external identity provider. This allows you to create a link from the existing user account to an
        external federated user identity that has not yet been used to sign in, so that the federated user
        identity can be used to sign in as the existing user account.
    ...
    def admin_reset_user_password(
        ...
        verified phone number exists for the user, or if email verification is selected and a verified
        email exists for the user, calling this API will also result in sending a message to the end user
        ...
        **Request Syntax**
        ...
        :param ClientMetadata:
          ...
          You create custom workflows by assigning AWS Lambda functions to user pool triggers. When you use
          the AdminResetUserPassword API action, Amazon Cognito invokes the function that is assigned to
          the *custom message* trigger. When Amazon Cognito invokes this function, it passes a JSON
          ...
          AdminResetUserPassword request. In your function code in AWS Lambda, you can process the
    ...
    def admin_respond_to_auth_challenge(
        ...
        **Request Syntax**
        ...
        :param ClientMetadata:
          ...
          You create custom workflows by assigning AWS Lambda functions to user pool triggers. When you use
          the AdminRespondToAuthChallenge API action, Amazon Cognito invokes any functions that are
          assigned to the following triggers: *pre sign-up* , *custom message* , *post authentication* ,
          *user migration* , *pre token generation* , *define auth challenge* , *create auth challenge* ,
          and *verify auth challenge response* . When Amazon Cognito invokes any of these functions, it
          passes a JSON payload, which the function receives as input. This payload contains a
          ``clientMetadata`` attribute, which provides the data that you assigned to the ClientMetadata
          parameter in your AdminRespondToAuthChallenge request. In your function code in AWS Lambda, you
    ...
    def admin_set_user_mfa_preference(
        ...
        will be used to authenticate a user if multiple factors are enabled. If multiple options are
        enabled and no preference is set, a challenge to choose an MFA option will be returned during sign
        in.
    ...
    def admin_set_user_password(
        ...
        InitiateAuth/AdminInitiateAuth response will contain the ``NEW_PASSWORD_REQUIRED`` challenge. If
        the user does not sign in before it expires, the user will not be able to sign in and their
    ...
    def admin_set_user_settings(
        ...
        """
         *This action is no longer supported.* You can use it to configure only SMS MFA. You can't use it
         to configure TOTP software token MFA. To configure either type of MFA, use the
    ...
    def confirm_sign_up(
        ...
        **Request Syntax**
        ...
        :param ForceAliasCreation:
          ...
          confirmation already exists as an alias with a different user, the API call will migrate the
          alias from the previous user to the newly created user being confirmed. If set to ``False`` , the
        ...
        :param ClientMetadata:
          ...
          provides the data that you assigned to the ClientMetadata parameter in your ConfirmSignUp
          request. In your function code in AWS Lambda, you can process the ``clientMetadata`` value to
          enhance your workflow for your specific needs.
    ...
    def create_resource_server(
        ...
        **Request Syntax**
        ...
        :param Identifier: **[REQUIRED]**
          ...
          A unique resource server identifier for the resource server. This could be an HTTPS endpoint
    ...
    def create_user_pool_client(
        ...
        **Request Syntax**
        ...
        :param WriteAttributes:
          ...
          client lacks write access to a mapped attribute, Amazon Cognito throws an error when it attempts
          to update the attribute. For more information, see `Specifying Identity Provider Attribute
    ...
    def forgot_password(
        ...
        **Request Syntax**
        ...
        :param ClientMetadata:
          ...
          This payload contains a ``clientMetadata`` attribute, which provides the data that you assigned
          to the ClientMetadata parameter in your ForgotPassword request. In your function code in AWS
    ...
    def get_user_attribute_verification_code(
        ...
        **Request Syntax**
        ...
        :param ClientMetadata:
          ...
          attribute, which provides the data that you assigned to the ClientMetadata parameter in your
          GetUserAttributeVerificationCode request. In your function code in AWS Lambda, you can process
        ...
        **Request Syntax**
        ...
        :param ClientMetadata:
          ...
          * User migration
          ...
          function code in AWS Lambda, you can process the ``validationData`` value to enhance your
          workflow for your specific needs.
    ...
    def resend_confirmation_code(
        ...
        **Request Syntax**
        ...
        :param ClientMetadata:
          ...
          You create custom workflows by assigning AWS Lambda functions to user pool triggers. When you use
          the ResendConfirmationCode API action, Amazon Cognito invokes the function that is assigned to
          the *custom message* trigger. When Amazon Cognito invokes this function, it passes a JSON
          payload, which the function receives as input. This payload contains a ``clientMetadata``
          attribute, which provides the data that you assigned to the ClientMetadata parameter in your
          ResendConfirmationCode request. In your function code in AWS Lambda, you can process the
          ``clientMetadata`` value to enhance your workflow for your specific needs.
    ...
    def respond_to_auth_challenge(
        ...
        **Request Syntax**
        ...
        :param ClientMetadata:
          ...
          , *create auth challenge* , and *verify auth challenge* . When Amazon Cognito invokes any of
          ...
          ClientMetadata parameter in your RespondToAuthChallenge request. In your function code in AWS
          Lambda, you can process the ``clientMetadata`` value to enhance your workflow for your specific
          needs.
    ...
    def sign_up(
        ...
        **Request Syntax**
        ...
        :param ClientMetadata:
          ...
          triggers: *pre sign-up* , *custom message* , and *post confirmation* . When Amazon Cognito
          invokes any of these functions, it passes a JSON payload, which the function receives as input.
          This payload contains a ``clientMetadata`` attribute, which provides the data that you assigned
          to the ClientMetadata parameter in your SignUp request. In your function code in AWS Lambda, you
          can process the ``clientMetadata`` value to enhance your workflow for your specific needs.
    ...
    def tag_resource(self, ResourceArn: str, Tags: List[str]) -> Dict[str, Any]:
        ...
        Each tag consists of a key and value, both of which you define. A key is a general category for
        more specific values. For example, if you have two versions of a user pool, one for testing and
        another for production, you might assign an ``Environment`` tag key to both user pools. The value
        of this key might be ``Test`` for one user pool and ``Production`` for the other.

        Tags are useful for cost tracking and access control. You can activate your tags so that they
        appear on the Billing and Cost Management console, where you can track the costs associated with
        your user pools. In an IAM policy, you can constrain permissions for user pools based on specific
        tags or tag values.
    ...
    def verify_software_token(
        ...
        """
        Use this API to register a user's entered TOTP code and mark the user's software token MFA status
        as "verified" if successful. The request takes an access token or a session string, but not both.
