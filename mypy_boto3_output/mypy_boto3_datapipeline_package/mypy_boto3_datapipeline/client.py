...
class Client(BaseClient):
    ...
    def activate_pipeline(
        ...
        If you need to pause the pipeline to investigate an issue with a component, such as a data source
        or script, call  DeactivatePipeline .
    ...
    def describe_objects(
        ...
        **Request Syntax**
        ...
        :param objectIds: **[REQUIRED]**
          ...
          The IDs of the pipeline objects that contain the definitions to be described. You can pass as
          many as 25 identifiers in a single call to ``DescribeObjects`` .
        ...
        :param marker:
          ...
          The starting point for the results to be returned. For the first call, this value should be
          empty. As long as there are more results, continue to call ``DescribeObjects`` with the marker
    ...
    def describe_pipelines(
        ...
        Using account credentials, you can retrieve metadata about pipelines that you or your IAM users
        have created. If you are using an IAM user account, you can retrieve metadata about only those
    ...
    def list_pipelines(self, marker: str = None) -> ClientListPipelinesResponseTypeDef:
        ...
        **Request Syntax**
        ...
        :param marker:
          ...
          The starting point for the results to be returned. For the first call, this value should be
          empty. As long as there are more results, continue to call ``ListPipelines`` with the marker
          value from the previous call to retrieve the next set of results.
    ...
    def poll_for_task(
        ...
        To accomodate this, set the socket timeout in your task runner to 90 seconds. The task runner
        should not call ``PollForTask`` again on the same ``workerGroup`` until it receives a response, and
        ...
        **Request Syntax**
        ...
        :param workerGroup: **[REQUIRED]**
          ...
          The type of task the task runner is configured to accept and process. The worker group is set as
          a field on objects in the pipeline when they are created. You can only specify a single value for
    ...
    def query_objects(
        ...
        **Request Syntax**
        ...
        :param marker:
          ...
          The starting point for the results to be returned. For the first call, this value should be
          empty. As long as there are more results, continue to call ``QueryObjects`` with the marker value
    ...
    def report_task_progress(
        ...
        If a task runner does not report its status after 5 minutes, AWS Data Pipeline assumes that the
        task runner is unable to process the task and reassigns the task in a subsequent response to
    ...
    def report_task_runner_heartbeat(
        ...
        **Request Syntax**
        ...
        :param taskrunnerId: **[REQUIRED]**
          ...
          The ID of the task runner. This value should be unique across your AWS account. In the case of
          AWS Data Pipeline Task Runner launched on a resource managed by AWS Data Pipeline, the web
          service provides a unique identifier when it launches the application. If you have written a
          custom task runner, you should assign a unique identifier for the task runner.
    ...
    def set_status(self, pipelineId: str, objectIds: List[str], status: str) -> None:
        ...
        status that can be set depends on the type of object (for example, DataNode or Activity). You
        cannot perform this operation on ``FINISHED`` pipelines and attempting to do so returns
    ...
    def set_task_status(
        ...
        provide information about the final status. A task runner makes this call regardless of whether the
        task was sucessful. A task runner does not need to call ``SetTaskStatus`` for tasks that are
