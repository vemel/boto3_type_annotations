...
def boto3_client(
    ...
    if session is not None:
        return session.client("datapipeline", **kwargs)
    return boto3.client("datapipeline", **kwargs)


# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_objects_paginator(client: Client) -> DescribeObjectsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_query_objects_paginator(client: Client) -> QueryObjectsPaginator:
    """
