...
class Client(BaseClient):
    ...
    def delete_member(self, NetworkId: str, MemberId: str) -> Dict[str, Any]:
        ...
        the ``DeleteMember`` action is carried out as the result of an approved proposal to remove a
        member. If ``MemberId`` is the last member in a network specified by the last AWS account, the
