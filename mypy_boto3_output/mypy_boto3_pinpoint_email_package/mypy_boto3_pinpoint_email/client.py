...
class Client(BaseClient):
    ...
    def create_configuration_set_event_destination(
        ...
        clicks, bounces, and complaints. *Event destinations* are places that you can send information
        about these events to. For example, you can send event data to Amazon SNS to receive notifications
        when you receive bounces or complaints, or you can use Amazon Kinesis Data Firehose to stream data
    ...
    def create_dedicated_ip_pool(
        ...
        that are associated with your Amazon Pinpoint account. You can associate a pool with a
        configuration set. When you send an email that uses that configuration set, Amazon Pinpoint sends
    ...
    def create_deliverability_test_report(
        ...
        spread across several major email providers. After about 24 hours, the test is complete, and you
        can use the ``GetDeliverabilityTestReport`` operation to view the results of the test.
        ...
        **Request Syntax**
        ...
        :param ReportName:
          ...
          A unique name that helps you to identify the predictive inbox placement test when you retrieve
          the results.
    ...
    def create_email_identity(
        ...
        """
        Verifies an email identity for use with Amazon Pinpoint. In Amazon Pinpoint, an identity is an
        email address or domain that you use when you send email. Before you can use an identity to send
        email with Amazon Pinpoint, you first have to verify it. By verifying an address, you demonstrate
        that you're the owner of the address, and that you've given Amazon Pinpoint permission to send
        email from the address.
    ...
    def delete_configuration_set(self, ConfigurationSetName: str) -> Dict:
        ...
        send. You apply a configuration set to an email by including a reference to the configuration set
        in the headers of the email. When you apply a configuration set to an email, all of the rules in
    ...
    def delete_configuration_set_event_destination(
        ...
        bounces or complaints, or you can use Amazon Kinesis Data Firehose to stream data to Amazon S3 for
        long-term storage.
    ...
    def get_blacklist_reports(
        ...
        **Request Syntax**
        ...
        :param BlacklistItemNames: **[REQUIRED]**
          ...
          specify the dedicated IP addresses that you use to send email using Amazon Pinpoint or Amazon SES.
    ...
    def get_deliverability_dashboard_options(
        ...
        When you use the Deliverability dashboard, you pay a monthly subscription charge, in addition to
        any other fees that you accrue by using Amazon Pinpoint. For more information about the features
    ...
    def list_configuration_sets(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          A token returned from a previous call to ``ListConfigurationSets`` to indicate the position in
    ...
    def list_domain_deliverability_campaigns(
        ...
        **Request Syntax**
        ...
        :param EndDate: **[REQUIRED]**
          ...
          The last day, in Unix time format, that you want to obtain deliverability data for. This value
          has to be less than or equal to 30 days after the value of the ``StartDate`` parameter.
    ...
    def list_email_identities(
        ...
        that are verified as well as those that aren't.
    ...
    def list_tags_for_resource(
        ...
        """
        Retrieve a list of the tags (keys and values) that are associated with a specified resource. A
        *tag* is a label that you optionally define and associate with a resource in Amazon Pinpoint. Each
    ...
    def put_deliverability_dashboard_option(
        ...
        """
        Enable or disable the Deliverability dashboard for your Amazon Pinpoint account. When you enable
        the Deliverability dashboard, you gain access to reputation, deliverability, and other metrics for
    ...
    def tag_resource(
        ...
        and manage resources in different ways, such as by purpose, owner, environment, or other criteria.
