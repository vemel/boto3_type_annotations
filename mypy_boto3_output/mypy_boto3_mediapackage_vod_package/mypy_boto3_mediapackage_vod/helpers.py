...
def boto3_client(
    ...
    if session is not None:
        return session.client("mediapackage-vod", **kwargs)
    return boto3.client("mediapackage-vod", **kwargs)


# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_assets_paginator(client: Client) -> ListAssetsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_packaging_configurations_paginator(
    client: Client,
) -> ListPackagingConfigurationsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_packaging_groups_paginator(client: Client) -> ListPackagingGroupsPaginator:
    """
