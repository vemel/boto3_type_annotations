...
class Client(BaseClient):
    ...
    def create_file_system(
        ...
        """
        Creates a new, empty file system. The operation requires a creation token in the request that
        Amazon EFS uses to ensure idempotent creation (calling the operation with same creation token has
        no effect). If a file system does not currently exist that is owned by the caller's AWS account
        ...
        * Returns with the description of the created file system.
        ...
        The idempotent operation allows you to retry a ``CreateFileSystem`` call without risk of creating
        an extra file system. This can happen when an initial call fails in a way that leaves it uncertain
        ...
        initial call had succeeded in creating a file system, the client can learn of its existence from
        the ``FileSystemAlreadyExists`` error.
    ...
    def create_mount_target(
        ...
        **Request Syntax**
        ...
        :param SecurityGroups:
          ...
          Up to five VPC security group IDs, of the form ``sg-xxxxxxxx`` . These must be for the same VPC
          as subnet specified.
    ...
    def create_tags(
        ...
        with the value provided in the request. If you add the ``Name`` tag to your file system, Amazon EFS
        ...
        **Request Syntax**
        ...
        :param FileSystemId: **[REQUIRED]**
          ...
          The ID of the file system whose tags you want to modify (String). This operation modifies the
    ...
    def delete_file_system(self, FileSystemId: str) -> None:
        ...
        .. note::
          ...
          check the file system deletion status by calling the  DescribeFileSystems operation, which
          returns a list of file systems in your account. If you pass file system ID or creation token for
          the deleted file system, the  DescribeFileSystems returns a ``404 FileSystemNotFound`` error.
    ...
    def delete_mount_target(self, MountTargetId: str) -> None:
        ...
        This operation forcibly breaks any mounts of the file system by using the mount target that is
        being deleted, which might disrupt instances or applications using those mounts. To avoid
        applications getting cut off abruptly, you might consider unmounting any mounts of the mount
        target, if feasible. The operation also deletes the associated network interface. Uncommitted
        writes might be lost, but breaking a mount target using this operation does not corrupt the file
        system itself. The file system you created remains. You can mount an EC2 instance in your VPC by
    ...
    def delete_tags(self, FileSystemId: str, TagKeys: List[str]) -> None:
        ...
        tags and related restrictions, see `Tag Restrictions
    ...
    def describe_file_systems(
        ...
        order of file systems returned across the responses of a multi-call iteration is unspecified.
    ...
    def describe_mount_target_security_groups(
        ...
        """
        Returns the security groups currently in effect for a mount target. This operation requires that
        the network interface of the mount target has been created and the lifecycle state of the mount
    ...
    def describe_mount_targets(
        ...
        system. When requesting all of the current mount targets, the order of mount targets returned in
        ...
        **Request Syntax**
        ...
        :param MaxItems:
          ...
          automatically set to 10, and other values are ignored. The response is paginated at 10 per page
        ...
        :param MountTargetId:
          ...
          (Optional) ID of the mount target that you want to have described (String). It must be included
          in your request if ``FileSystemId`` is not included.
    ...
    def modify_mount_target_security_groups(
        ...
        request. This operation requires that the network interface of the mount target has been created
