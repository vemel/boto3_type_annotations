    ...
    def describe_voices(
        ...
        **Request Syntax**
        ...
        :param LanguageCode:
          ...
          filtering the list of voices returned. If you don't specify this optional parameter, all
        ...
        :param IncludeAdditionalLanguageCodes:
          ...
          as an additional language. For instance, if you request all languages that use US English
          (es-US), and there is an Italian voice that speaks both Italian (it-IT) and US English, that
                ...
                'Voices': [
                    {
                        ...
                        'AdditionalLanguageCodes': [
                            ...
                            |'en-US'|'es-ES'|'es-MX'|'es-US'|'fr-CA'|'fr-FR'|'is-IS'|'it-IT'|'ja-JP'
                            |'hi-IN'|'ko-KR'|'nb-NO'|'nl-NL'|'pl-PL'|'pt-BR'|'pt-PT'|'ro-RO'|'ru-RU'
                            |'sv-SE'|'tr-TR',
                        ],
                        'SupportedEngines': [
                            'standard'|'neural',
    ...
    def start_speech_synthesis_task(
        ...
        **Request Syntax**
        ...
        :param Engine:
          ...
          text for speech synthesis. Using a voice that is not supported for the engine selected will
          result in an error.
    ...
    def synthesize_speech(
        ...
        **Request Syntax**
        ...
        :param LexiconNames:
          ...
          List of one or more pronunciation lexicon names you want the service to apply during synthesis.
          Lexicons are applied only if the language of the lexicon is the same as the language of the
          voice. For information about storing lexicons, see `PutLexicon
