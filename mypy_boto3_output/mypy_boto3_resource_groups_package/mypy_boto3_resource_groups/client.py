    ...
    def create_group(
        ...
        **Request Syntax**
        ...
        :param Name: **[REQUIRED]**
          ...
          characters, including letters, numbers, hyphens, dots, and underscores. The name cannot start
          with ``AWS`` or ``aws`` ; these are reserved. A resource group name must be unique within your
          account.
        ...
        :param Tags:
          ...
          have a maximum character length of 128 characters, and tag values can have a maximum length of
          256 characters.
    ...
    def tag(self, Arn: str, Tags: List[str]) -> ClientTagResponseTypeDef:
        ...
        **Request Syntax**
        ...
        :param Tags: **[REQUIRED]**
          ...
          The tags to add to the specified resource. A tag is a string-to-string map of key-value pairs.
