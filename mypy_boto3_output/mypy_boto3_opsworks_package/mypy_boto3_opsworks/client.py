...
class Client(BaseClient):
    ...
    def clone_stack(
        ...
        **Request Syntax**
        ...
        :param Region:
          ...
          The cloned stack AWS region, such as "ap-northeast-2". For more information about AWS regions,
        ...
        :param DefaultOs:
          ...
          * A custom AMI: ``Custom`` . You specify the custom AMI you want to use when you create
          instances. For more information about how to use custom AMIs with OpsWorks, see `Using Custom
          AMIs <https://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-custom-ami.html>`__ .
        ...
        :param DefaultAvailabilityZone:
          ...
          ``DefaultSubnetId`` , the subnet must be in the same zone. For more information, see the
        ...
        :param DefaultSubnetId:
          ...
          subnet must be in that zone. For information on default values and when this parameter is
        ...
        :param DefaultRootDeviceType:
          ...
          stack, but you can override it when you create an instance. For more information, see `Storage
          for the Root Device
        ...
        :param AgentVersion:
          ...
          * Fixed version - Set this parameter to your preferred agent version. To update the agent
          ...
          then automatically installs that version on the stack's instances.
    ...
    def create_deployment(
        ...
        <https://docs.aws.amazon.com/opsworks/latest/userguide/workingapps-deploying.html>`__ and `Run
        Stack Commands
    ...
    def create_instance(
        ...
        **Request Syntax**
        ...
        :param InstanceType: **[REQUIRED]**
          ...
          values that you use to specify the various types are in the **API Name** column of the
        ...
        :param SubnetId:
          ...
          instance in a different subnet.
        ...
        :param InstallUpdatesOnBoot:
          ...
          value is ``true`` . To control when updates are installed, set this value to ``false`` . You must
          then update your instances manually by using  CreateDeployment to run the ``update_dependencies``
    ...
    def create_layer(
        ...
        **Request Syntax**
        ...
        :param Type: **[REQUIRED]**
          ...
          The layer type. A stack cannot have more than one built-in layer of the same type. It can have
        ...
        :param CustomInstanceProfileArn:
          ...
          The ARN of an IAM profile to be used for the layer's EC2 instances. For more information about
        ...
        **Request Syntax**
        ...
        :param Region: **[REQUIRED]**
          ...
          .. note::
            ...
            the ``--region`` parameter is set to ``us-east-1`` , and the ``--stack-region`` parameter is
            set to one of the following, then the stack uses a legacy or *classic* region: ``us-west-1,
            ...
            regions are supported as classic regions in the ``us-east-1`` API endpoint. Because it is a
            best practice to choose the regional endpoint that is closest to where you manage AWS, we
            recommend that you use regional endpoints for new stacks. The AWS CLI common ``--region``
            parameter always specifies a regional API endpoint; it cannot be used to specify a classic AWS
    ...
    def describe_apps(
        ...
        **Request Syntax**
        ...
        :param StackId:
          ...
          The app stack ID. If you use this parameter, ``DescribeApps`` returns a description of the apps
    ...
    def describe_ecs_clusters(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          call ``DescribeEcsClusters`` again and assign that token to the request object's ``NextToken``
        ...
        :param MaxResults:
          ...
          To receive a paginated response, use this parameter to specify the maximum number of results to
          be returned with a single call. If the number of available results exceeds this maximum, the
          response includes a ``NextToken`` value that you can assign to the ``NextToken`` request
                            ...
                            'LogStreams': [
                                {
                                    ...
                                    |'koi8_u'|'mac_cyrillic'|'mac_greek'|'mac_iceland'|'mac_latin2'
              ...
              - *(dict) --*
                  ...
                  - **LogStreams** *(list) --*
                    ...
                    - *(dict) --*
                      ...
                      - **FileFingerprintLines** *(string) --*
                        ...
                        '1', meaning the first line is used to calculate the fingerprint. Fingerprint lines
                        are not sent to CloudWatch Logs unless all specified lines are available.
                      ...
                      - **Encoding** *(string) --*
                        ...
                        default is ``utf_8`` . Encodings supported by Python ``codecs.decode()`` can be
                        used here.
                ...
                - **VolumeConfigurations** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **VolumeType** *(string) --*
                      ...
                      * ``gp2`` - General Purpose (SSD). General purpose volumes must have a minimum size
                      of 1 GiB and a maximum size of 16384 GiB.
                ...
                - **DefaultRecipes** *(dict) --*
                  ...
                  **deploy** , **undeploy** , and **shutdown** . For each layer, AWS OpsWorks Stacks runs a
                  set of standard recipes for each event. You can also provide custom recipes for any or
                  all layers and events. AWS OpsWorks Stacks runs custom event recipes after the standard
    ...
    def describe_volumes(
        ...
        **Request Syntax**
        ...
        :param VolumeIds:
          ...
          Am array of volume IDs. If you use this parameter, ``DescribeVolumes`` returns descriptions of
    ...
    def grant_access(
        ...
        **Request Syntax**
        ...
        :param ValidForInMinutes:
          ...
          this period, the user will no longer be able to use the credentials to log in. If the user is
          logged in at the time, he or she automatically will be logged out.
    ...
    def reboot_instance(self, InstanceId: str) -> None:
        ...
        Instances <https://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-starting.html>`__
        .
    ...
    def register_instance(
        ...
        .. note::
          ...
          instance with the stack. ``RegisterInstance`` handles only the second step. You should instead
          use the AWS CLI ``register`` command, which performs the entire registration operation. For more
    ...
    def stop_instance(self, InstanceId: str, Force: bool = None) -> None:
        ...
        reinstalled when you restart the instance. You can stop an Amazon EBS-backed instance without
        losing data. For more information, see `Starting, Stopping, and Rebooting Instances
        <https://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-starting.html>`__ .
        ...
        **Request Syntax**
        ...
        :param Force:
          ...
          or EBS-backed, adding the ``Force`` parameter to the ``StopInstances`` API call disassociates the
          AWS OpsWorks Stacks instance from EC2, and forces deletion of *only* the OpsWorks Stacks
          instance. You must also delete the formerly-associated instance in EC2 after troubleshooting and
    ...
    def unassign_instance(self, InstanceId: str) -> None:
        ...
        in the stack as an unassigned instance, and can be assigned to another layer as needed. You cannot
        use this action with instances that were created with AWS OpsWorks Stacks.

         **Required Permissions** : To use this action, an IAM user must have a Manage permissions level
         for the stack or an attached policy that explicitly grants permissions. For more information about
         user permissions, see `Managing User Permissions
         <https://docs.aws.amazon.com/opsworks/latest/userguide/opsworks-security-users.html>`__ .
    ...
    def update_app(
        ...
        **Request Syntax**
        ...
        :param Environment:
          ...
          associated data structure - which includes the variables' names, values, and protected flag
          values - cannot exceed 20 KB. This limit should accommodate most if not all use cases. Exceeding
          it will cause an exception with the message, "Environment: is too large (maximum is 20 KB)."
    ...
    def update_layer(
        ...
        **Request Syntax**
        ...
        :param InstallUpdatesOnBoot:
          ...
          value is ``true`` . To control when updates are installed, set this value to ``false`` . You must
          then update your instances manually by using  CreateDeployment to run the ``update_dependencies``
          stack command or manually running ``yum`` (Amazon Linux) or ``apt-get`` (Ubuntu) on the instances.
    ...
    def update_stack(
        ...
        **Request Syntax**
        ...
        :param UseOpsworksSecurityGroups:
          ...
          AWS OpsWorks Stacks provides a standard set of built-in security groups, one for each layer,
          which are associated with layers by default. ``UseOpsworksSecurityGroups`` allows you to provide
