...
class Client(BaseClient):
    ...
    def create_db_cluster_parameter_group(
        ...
        must modify the group after creating it using  ModifyDBClusterParameterGroup . Once you've created
        a DB cluster parameter group, you need to associate it with your DB cluster using  ModifyDBCluster
    ...
    def create_db_instance(
        ...
        **Request Syntax**
        ...
        :param KmsKeyId:
          ...
          ``KmsKeyId`` parameter, then Amazon Neptune will use your default encryption key. AWS KMS creates
          the default encryption key for your AWS account. Your AWS account has a different default
        ...
        :param MonitoringInterval:
          ...
          DB instance. To disable collecting Enhanced Monitoring metrics, specify 0. The default is 0.
    ...
    def create_event_subscription(
        ...
        source. If you specify a SourceType but do not specify a SourceIdentifier, you receive notice of
        the events for that source type for all your Neptune sources. If you do not specify either the
        ...
        **Request Syntax**
        ...
        :param SourceIds:
          ...
          The list of identifiers of the event sources for which events are returned. If not specified,
        ...
        **Request Syntax**
        ...
        :param FinalDBSnapshotIdentifier:
          ...
          .. note::
            ...
            Specifying this parameter and also setting the SkipFinalShapshot parameter to true results in
            an error.
    ...
    def describe_db_cluster_snapshots(
        ...
        **Request Syntax**
        ...
        :param DBClusterIdentifier:
          ...
          be used in conjunction with the ``DBClusterSnapshotIdentifier`` parameter. This parameter is not
          case-sensitive.
        ...
        :param SnapshotType:
          ...
          * ``public`` - Return all DB cluster snapshots that have been marked as public.
          ...
          snapshots are returned. You can include shared DB cluster snapshots with these results by setting
          the ``IncludeShared`` parameter to ``true`` . You can include public DB cluster snapshots with
    ...
    def describe_db_clusters(
        ...
        **Request Syntax**
        ...
        :param DBClusterIdentifier:
          ...
          The user-supplied DB cluster identifier. If this parameter is specified, information from only
    ...
    def describe_db_engine_versions(
        ...
        **Request Syntax**
        ...
        :param MaxRecords:
          ...
          The maximum number of records to include in the response. If more than the ``MaxRecords`` value
          is available, a pagination token called a marker is included in the response so that the
    ...
    def describe_db_parameter_groups(
        ...
        **Request Syntax**
        ...
        :param Marker:
          ...
          An optional pagination token provided by a previous ``DescribeDBParameterGroups`` request. If
          this parameter is specified, the response includes only records beyond the marker, up to the
          value specified by ``MaxRecords`` .
    ...
    def modify_db_cluster(
        ...
        **Request Syntax**
        ...
        :param ApplyImmediately:
          ...
          changes to the ``NewDBClusterIdentifier`` and ``MasterUserPassword`` values are applied during
          the next maintenance window. All other changes are applied immediately, regardless of the value
    ...
    def modify_db_cluster_parameter_group(
        ...
        """
        Modifies the parameters of a DB cluster parameter group. To modify more than one parameter, submit
        a list of the following: ``ParameterName`` , ``ParameterValue`` , and ``ApplyMethod`` . A maximum
        ...
        .. warning::
          ...
          as the default for a new DB cluster. This is especially important for parameters that are
          ...
          Groups* option of the Amazon Neptune console or the  DescribeDBClusterParameters command to
    ...
    def modify_db_cluster_snapshot_attribute(
        ...
        To view which AWS accounts have access to copy or restore a manual DB cluster snapshot, or whether
        a manual DB cluster snapshot public or private, use the  DescribeDBClusterSnapshotAttributes API
        action.
    ...
    def modify_db_instance(
        ...
        """
        Modifies settings for a DB instance. You can change one or more database configuration parameters
        by specifying these parameters and the new values in the request. To learn what modifications you
        can make to your DB instance, call  DescribeValidDBInstanceModifications before you call
        ModifyDBInstance .
        ...
        **Request Syntax**
        ...
        :param ApplyImmediately:
          ...
          maintenance window. Some parameter changes can cause an outage and are applied on the next call
          to  RebootDBInstance , or the next failure reboot.
        ...
        :param PreferredMaintenanceWindow:
          ...
          situation, and the change is asynchronously applied as soon as possible. If there are pending
          actions that cause a reboot, and the maintenance window is changed to include the current time,
          then changing this parameter will cause a reboot of the DB instance. If moving this window to the
          current time, there must be at least 30 minutes between the current time and end of the window to
        ...
        :param OptionGroupName:
          ...
          Indicates that the DB instance should be associated with the specified option group. Changing
          this parameter doesn't result in an outage except in the following case and the change is applied
          during the next maintenance window unless the ``ApplyImmediately`` parameter is set to ``true``
          for this request. If the parameter change results in an option group that enables OEM, this
          change can cause a brief (sub-second) period during which new connections are rejected but
          existing connections are not interrupted.
    ...
    def modify_db_subnet_group(
        ...
        **Request Syntax**
        ...
        :param DBSubnetGroupName: **[REQUIRED]**
          ...
          The name for the DB subnet group. This value is stored as a lowercase string. You can't modify
          the default subnet group.
    ...
    def reset_db_cluster_parameter_group(
        ...
        **Request Syntax**
        ...
        :param ResetAllParameters:
          ...
          A value that is set to ``true`` to reset all parameters in the DB cluster parameter group to
          their default values, and ``false`` otherwise. You can't use this parameter if there is a list of
    ...
    def restore_db_cluster_to_point_in_time(
        ...
        **Request Syntax**
        ...
        :param KmsKeyId:
          ...
          * If the DB cluster is encrypted, then the restored DB cluster is encrypted using the KMS key
