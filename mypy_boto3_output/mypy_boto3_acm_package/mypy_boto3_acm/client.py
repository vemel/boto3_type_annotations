...
class Client(BaseClient):
    ...
    def add_tags_to_certificate(
        ...
        the certificate on input by its Amazon Resource Name (ARN). You specify the tag by using a
        key-value pair.

        You can apply a tag to just one certificate if you want to identify a specific characteristic of
        that certificate, or you can apply the same tag to multiple certificates if you want to filter for
        a common relationship among those certificates. Similarly, you can apply the same tag to multiple
        resources if you want to specify a relationship among those resources. For example, you can add the
        same tag to an ACM certificate and an Elastic Load Balancing load balancer to indicate that they
        are both used by the same website. For more information, see `Tagging ACM certificates
          ...
          ::

            {
                'Certificate': {
                    ...
                    |'PCA_INVALID_ARN'|'PCA_INVALID_STATE'|'PCA_REQUEST_FAILED'|'PCA_RESOURCE_NOT_FOUND'
            ...
            - **Certificate** *(dict) --*
              ...
              - **RenewalSummary** *(dict) --*
                ...
                - **DomainValidationOptions** *(list) --*
                  ...
                  different from the initial validation that occurs as a result of the  RequestCertificate
    ...
    def export_certificate(
        ...
        """
        Exports a private certificate issued by a private certificate authority (CA) for use anywhere. You
        can export the certificate, the certificate chain, and the encrypted private key associated with
        the public key embedded in the certificate. You must store the private key securely. The private
        key is a 2048 bit RSA key. You must provide a passphrase for the private key when exporting it. You
    ...
    def get_certificate(
        ...
        """
        Retrieves a certificate specified by an ARN and its certificate chain . The chain is an ordered
        list of certificates that contains the end entity certificate, intermediate certificates of
        subordinate CAs, and the root certificate in that order. The certificate and certificate chain are
        base64 encoded. If you want to decode the certificate to see the individual fields, you can use
        OpenSSL.
    ...
    def import_certificate(
        ...
        <https://docs.aws.amazon.com/acm/latest/userguide/acm-services.html>`__ allow only certificate
        types and keys they support to be associated with their resources. Further, their support differs
        depending on whether the certificate is imported into IAM or into ACM. For more information, see
        the documentation for each service. For more information about importing certificates into ACM, see
    ...
    def list_certificates(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          receive a response with truncated results. Set it to the value of ``NextToken`` from the response
          you just received.

        :type MaxItems: integer
        :param MaxItems:

          Use this parameter when paginating results to specify the maximum number of items to return in
    ...
    def renew_certificate(self, CertificateArn: str) -> None:
        ...
        with this operation. In order to renew your ACM PCA certificates with ACM, you must first `grant
        the ACM service principal permission to do so
    ...
    def request_certificate(
        ...
        """
        Requests an ACM certificate for use with other AWS services. To request an ACM certificate, you
        must specify a fully qualified domain name (FQDN) in the ``DomainName`` parameter. You can also
        ...
        <https://docs.aws.amazon.com/acm/latest/userguide/gs-acm-validate-email.html>`__ . We recommend
        that you use DNS validation. ACM issues public certificates after receiving approval from the
        domain owner.
        ...
        **Request Syntax**
        ...
        :param DomainName: **[REQUIRED]**
          ...
          The first domain name you enter cannot exceed 63 octets, including periods. Each subsequent
        ...
        :param IdempotencyToken:
          ...
          multiple times with the same idempotency token within one hour, ACM recognizes that you are
        ...
        :param CertificateAuthorityArn:
          ...
          <https://docs.aws.amazon.com/acm-pca/latest/userguide/PcaWelcome.html>`__ user guide. The ARN
          must have the following form:
