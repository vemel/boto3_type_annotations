...
class Client(BaseClient):
                        ...
                        'triggerConfigurations': [
                            {
                                ...
                                'triggerEvents': [
                                    ...
                                    |'InstanceStart'|'InstanceSuccess'|'InstanceFailure'|'InstanceReady',
                                ]
                            },
                        ],
                        'alarmConfiguration': {
    ...
    def batch_get_deployment_targets(
        ...
        **Request Syntax**
        ...
        :param targetIds:
          ...
          type of the targets and their formats. The maximum number of deployment target IDs you can
          specify is 25.
          ...
          * For deployments that use the AWS Lambda compute platform, the target IDs are the names of
          Lambda functions, and their target type is ``instanceTarget`` .

          * For deployments that use the Amazon ECS compute platform, the target IDs are pairs of Amazon
          ECS clusters and services specified using the format ``<clustername>:<servicename>`` . Their
    ...
    def continue_deployment(
        ...
        environment to instances in the replacement environment without waiting for a specified wait time
        ...
        **Request Syntax**
        ...
        :param deploymentWaitType:
          ...
          start shifting traffic. TERMINATION_WAIT indicates the traffic is shifted, but the original
    ...
    def create_deployment_group(
        ...
        **Request Syntax**
        ...
        :param deploymentConfigName:
          ...
          <https://docs.aws.amazon.com/codedeploy/latest/userguide/deployment-configurations.html>`__ in
...

            {
                'deploymentInfo': {
                    ...
                    'errorInformation': {
                        ...
                        |'HOOK_EXECUTION_FAILURE'|'IAM_ROLE_MISSING'|'IAM_ROLE_PERMISSIONS'
                        |'INTERNAL_ERROR'|'INVALID_ECS_SERVICE'|'INVALID_LAMBDA_CONFIGURATION'
                        |'INVALID_LAMBDA_FUNCTION'|'INVALID_REVISION'|'MANUAL_STOP'
                        |'MISSING_BLUE_GREEN_DEPLOYMENT_CONFIGURATION'|'MISSING_ELB_INFORMATION'
                        |'MISSING_GITHUB_TOKEN'|'NO_EC2_SUBSCRIPTION'|'NO_INSTANCES'|'OVER_MAX_INSTANCES'
                        |'RESOURCE_LIMIT_EXCEEDED'|'REVISION_MISSING'|'THROTTLED'|'TIMEOUT',
                        'message': 'string'
                    },
                    'createTime': datetime(2015, 1, 1),
                    'startTime': datetime(2015, 1, 1),
    ...
    def list_applications(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          An identifier returned from the previous list applications call. It can be used to return the
    ...
    def list_deployment_groups(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          An identifier returned from the previous list deployment groups call. It can be used to return
          the next set of deployment groups in the list.
    ...
    def list_deployment_instances(
        ...
        .. note::
          ...
          types. ``ListDeploymentInstances`` throws an exception if it is used with a compute platform
          other than EC2/On-premises or AWS Lambda.
    ...
    def list_on_premises_instances(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          An identifier returned from the previous list on-premises instances call. It can be used to
    ...
    def list_tags_for_resource(
        ...
        """
        Returns a list of tags for the resource identified by a specified ARN. Tags are used to organize
        ...
        **Request Syntax**
        ...
        :param ResourceArn: **[REQUIRED]**
          ...
          The ARN of a CodeDeploy resource. ``ListTagsForResource`` returns all the tags associated with
          the resource that is identified by the ``ResourceArn`` .
    ...
    def put_lifecycle_event_hook_execution_status(
        ...
        """
        Sets the result of a Lambda validation function. The function validates one or both lifecycle
        events (``BeforeAllowTraffic`` and ``AfterAllowTraffic`` ) and returns ``Succeeded`` or ``Failed`` .
        ...
        **Request Syntax**
        ...
        :param lifecycleEventHookExecutionId:
          ...
          The execution ID of a deployment's lifecycle hook. A deployment lifecycle hook is specified in
          the ``hooks`` section of the AppSpec file.
    ...
    def stop_deployment(
        ...
        **Request Syntax**
        ...
        :param autoRollbackEnabled:
          ...
          Indicates, when a deployment is stopped, whether instances that have been updated should be
          rolled back to the previous version of the application revision.
    ...
    def update_deployment_group(
        ...
        **Request Syntax**
        ...
        :param ec2TagFilters:
          ...
          The replacement set of Amazon EC2 tags on which to filter, if you want to change them. To keep
        ...
        :param autoScalingGroups:
          ...
          The replacement list of Auto Scaling groups to be included in the deployment group, if you want
          to change them. To keep the Auto Scaling groups, enter their names. To remove Auto Scaling
