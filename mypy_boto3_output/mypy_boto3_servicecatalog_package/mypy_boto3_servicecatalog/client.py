...
class Client(BaseClient):
    ...
    def delete_provisioning_artifact(
        ...
        cannot delete the last provisioning artifact for a product, because a product must have at least
        one provisioning artifact.
    ...
    def disable_aws_organizations_access(
        ...
        Current shares will not be in sync with your organization structure if it changes after calling
        this API. This API can only be called by the master account in the organization.
    ...
    def enable_aws_organizations_access(
        ...
        By calling this API Service Catalog will make a call to organizations:EnableAWSServiceAccess on
        your behalf so that your shares can be in sync with any changes in your AWS Organizations structure.
    ...
    def provision_product(
        ...
        based on a CloudFormation template launches a CloudFormation stack and its underlying resources.
    ...
    def search_provisioned_products(
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          ``provisioningArtifact`` , ``type`` , ``status`` , ``tags`` , ``userArn`` , and
          ``userArnSession`` .
    ...
    def update_provisioned_product(
        ...
        **Request Syntax**
        ...
        :param PathId:
          ...
          The new path identifier. This value is optional if the product has a default path, and required
    ...
    def update_provisioned_product_properties(
        ...
        **Request Syntax**
        ...
        :param ProvisionedProductProperties: **[REQUIRED]**
          ...
          longer use ``DescribeRecord`` , but can still see the product's history from when he was an owner
          using ``ListRecordHistory`` .

          If a provisioned product ownership is assigned to an end user, they can see and perform any
          action through the API or Service Catalog console such as update, terminate, and execute service
          actions. If an end user provisions a product and the owner is updated to someone else, they will
          no longer be able to see or perform any actions through API or the Service Catalog console on
