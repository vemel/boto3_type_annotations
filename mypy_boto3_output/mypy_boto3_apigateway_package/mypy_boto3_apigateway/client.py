        ...
        **Request Syntax**
        ...
        :param identitySource:
          ...
          * For a ``TOKEN`` or ``COGNITO_USER_POOLS`` authorizer, this is required and specifies the
          request header mapping expression for the custom header holding the authorization token submitted
          by the client. For example, if the token header name is ``Auth`` , the header mapping expression
        ...
        <https://docs.aws.amazon.com/apigateway/latest/developerguide/apigateway-integrate-with-cognito.html>`__
            ...
            - **authorizerUri** *(string) --*
              ...
              indicates that the remaining substring in the URI should be treated as the path to the
            ...
            - **identitySource** *(string) --*
              ...
              * For the ``REQUEST`` authorizer, this is required when authorization caching is enabled. The
              ...
              this is true does the authorizer invoke the authorizer Lambda function, otherwise, it returns
              a 401 Unauthorized response without calling the Lambda function. The valid value is a string
            ...
            - **identityValidationExpression** *(string) --*
              ...
              value is a regular expression. For ``COGNITO_USER_POOLS`` authorizers, API Gateway will match
              the ``aud`` field of the incoming token from the client against the specified regular
              expression. It will invoke the authorizer's Lambda function when there is a match. Otherwise,
              it will return a 401 Unauthorized response without calling the Lambda function. The
    ...
    def create_domain_name(
        ...
        **Request Syntax**
        ...
        :param regionalCertificateArn:
          ...
          The reference to an AWS-managed certificate that will be used by regional endpoint for this
          domain name. AWS Certificate Manager is the only supported source.
        ...
        **Request Syntax**
            ...
            - **resourceMethods** *(dict) --*
              ...
              - *(string) --*
                ...
                - *(dict) --*
                  ...
                  resources. A **Method** resource is integrated with an  Integration resource. Both
                  consist of a request and one or more responses. The method request takes the client input
                  that is passed to the back end through the integration request. A method response returns
                  the output from the back end to the client through an integration response. A method
                  request is embodied in a **Method** resource, whereas an integration request is embodied
                  in an  Integration resource. On the other hand, a method response is represented by a
        ...
        <https://docs.aws.amazon.com/apigateway/latest/developerguide/how-to-method-settings.html>`__
                  ...
                  - **methodResponses** *(dict) --*
                    ...
                    specifies the response returned to the caller from the back end through the integration
                    response.
        ...
        <https://docs.aws.amazon.com/apigateway/latest/developerguide/how-to-create-api.html>`__
                  ...
                  - **methodIntegration** *(dict) --*
                    ...
                    - **credentials** *(string) --*
                      ...
                      the role's Amazon Resource Name (ARN). To require that the caller's identity be
                      passed through from the request, specify the string ``arn:aws:iam::\*:user/\*`` . To
                      use resource-based permissions on supported AWS services, specify null.
                    ...
                    - **requestParameters** *(dict) --*
                      ...
                      value is a method request parameter value or static value that must be enclosed
                      within single quotes and pre-encoded as required by the back end. The method request
        ...
        <https://docs.aws.amazon.com/apigateway/latest/developerguide/how-to-create-api.html>`__
                  ...
                  - **authorizationScopes** *(list) --*
                    ...
                    the incoming request. The method invocation is authorized if any method scopes matches
                    a claimed scope in the access token. Otherwise, the invocation is not authorized. When
                    the method scope is configured, the client must provide an access token instead of an
    ...
    def create_rest_api(
        ...
        **Request Syntax**
        ...
        :param minimumCompressionSize:
          ...
          enabled, compression or decompression is not applied on the payload if the payload size is
        ...
        **Request Syntax**
        ...
        <https://docs.aws.amazon.com/apigateway/latest/developerguide/apigateway-integrate-with-cognito.html>`__
                ...
                - **identityValidationExpression** *(string) --*
                  ...
                  regular expression. It will invoke the authorizer's Lambda function when there is a
                  match. Otherwise, it will return a 401 Unauthorized response without calling the Lambda
        ...
        **Request Syntax**
          ...
          - *(dict) --*
            ...
            - **items** *(list) --*
              ...
              - *(dict) --*
                ...
                API host name is of the ``{restapi-id}.execute-api.{region}.amazonaws.com`` format. With
        ...
        <https://docs.aws.amazon.com/apigateway/latest/developerguide/how-to-custom-domains.html>`__
                ...
                - **regionalDomainName** *(string) --*
                  ...
                  set up this association by adding a DNS record that points the custom domain name to this
                ...
                - **distributionHostedZoneId** *(string) --*
                  ...
                  valid value is ``Z2FDTNDATAQYW2`` for all the regions. For more information, see `Set up
    ...
    def get_export(
        ...
        **Request Syntax**
        ...
        :param parameters:
          ...
          the requested ``exportType`` . For ``exportType``  ``oas30`` and ``swagger`` , any combination of
          the following parameters are supported: ``extensions='integrations'`` or
        ...
        **Request Syntax**
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            the back end through the integration request. A method response returns the output from the
            back end to the client through an integration response. A method request is embodied in a
            **Method** resource, whereas an integration request is embodied in an  Integration resource. On
            the other hand, a method response is represented by a  MethodResponse resource, whereas an
        ...
        <https://docs.aws.amazon.com/apigateway/latest/developerguide/how-to-method-settings.html>`__
            ...
            - **requestParameters** *(dict) --*
              ...
              (``false`` ). The method request parameter names defined here are available in  Integration
            ...
            - **methodResponses** *(dict) --*
              ...
              following:
               ...
               "/restapis/uojnr9hd57/resources/0cjtch/methods/GET/responses/200" },
               "methodresponse:update": { "href":
               "/restapis/uojnr9hd57/resources/0cjtch/methods/GET/responses/200" } }, "responseModels": {
               "application/json": "Empty" }, "responseParameters": { "method.response.header.operator":
               false, "method.response.header.operand_2": false, "method.response.header.operand_1": false
               }, "statusCode": "200" }``
        ...
        <https://docs.aws.amazon.com/apigateway/latest/developerguide/how-to-create-api.html>`__
                  ...
                  - **responseParameters** *(dict) --*
                    ...
                    response payload in the form of ``integration.response.body.{JSON-expression}`` , where
                    ``JSON-expression`` is a valid JSON expression without the ``$`` prefix.)
                  ...
                  - **responseModels** *(dict) --*
                    ...
                    are represented as a key/value map, with a content-type as the key and a  Model name as
                    the value.
            ...
            - **methodIntegration** *(dict) --*
              ...
              Gets the method's integration responsible for passing the client-submitted request to the
              back end and performing necessary transformations to make the request compliant with the back
              end.
              ...
              - **type** *(string) --*
                ...
                * ``AWS`` : for integrating the API method request with an AWS service action, including
                ...
                * ``HTTP_PROXY`` : for integrating the API method request with an HTTP endpoint, including
                a private HTTP endpoint within a VPC, with the client request passed through as-is. This is
                also referred to as the HTTP proxy integration.
              ...
              - **uri** *(string) --*
                ...
                * For ``AWS`` or ``AWS_PROXY`` integrations, the URI is of the form
                ...
                used for an AWS service action-based API, using an ``Action={name}&{p1}={v1}&p2={v2}...``
              ...
              - **connectionId** *(string) --*
                ...
                VpcLink used for the integration when ``connectionType=VPC_LINK`` and undefined, otherwise.

              - **credentials** *(string) --*

                Specifies the credentials required for the integration, if any. For AWS integrations, three
                options are available. To specify an IAM Role for API Gateway to assume, use the role's
                Amazon Resource Name (ARN). To require that the caller's identity be passed through from
                the request, specify the string ``arn:aws:iam::\*:user/\*`` . To use resource-based
              ...
              - **requestParameters** *(dict) --*
                ...
                a method request parameter value or static value that must be enclosed within single quotes
              ...
              - **passthroughBehavior** *(string) --*
                ...
                the integration request to the back end without transformation. A content type is unmapped
                if no mapping template is defined in the integration or the content type does not match any
                of the mapped content types, as specified in ``requestTemplates`` . The valid value is one
                of the following:
        ...
        <https://docs.aws.amazon.com/apigateway/latest/developerguide/how-to-create-api.html>`__
                    ...
                    - **selectionPattern** *(string) --*
                      ...
                      Specifies the regular expression (regex) pattern used to choose an integration
                      response based on the response from the back end. For example, if the success
                      response returns nothing and the error response returns some string, you could use
                      the ``.+`` regex to match error response. However, make sure that the error response
                      does not contain any newline (``\n`` ) character in such cases. If the back end is an
                      AWS Lambda function, the AWS Lambda function error header is matched. For all other
                    ...
                    - **responseParameters** *(dict) --*
                      ...
                      of single quotes, or a JSON expression from the integration response body. The
        ...
        **Request Syntax**
                ...
                - **resourceMethods** *(dict) --*
                  ...
                  - *(string) --*
                    ...
                    - *(dict) --*
                      ...
                      request. A method response returns the output from the back end to the client through
                      an integration response. A method request is embodied in a **Method** resource,
                      whereas an integration request is embodied in an  Integration resource. On the other
                      hand, a method response is represented by a  MethodResponse resource, whereas an
                      integration response is represented by an  IntegrationResponse resource.
        ...
        <https://docs.aws.amazon.com/cli/latest/reference/apigateway/get-integration.html>`__
                        ...
                        - **connectionType** *(string) --*
                          ...
                          is ``INTERNET`` for connections through the public routable internet or
                        ...
                        - **passthroughBehavior** *(string) --*
                          ...
                          * ``WHEN_NO_TEMPLATES`` : passes the method request body through the integration
                          ...
                          selected, the method request of an unmapped content-type will be rejected with an
        ...
        <https://docs.aws.amazon.com/apigateway/latest/developerguide/how-to-create-api.html>`__
                              ...
                              - **responseParameters** *(dict) --*
                                ...
                                the pattern of ``method.response.header.{name}`` , where ``name`` is a
                      ...
                      - **authorizationScopes** *(list) --*
                        ...
                        invocation is not authorized. When the method scope is configured, the client must
    ...
    def get_sdk(
        ...
        **Request Syntax**
        ...
        :param parameters:
          ...
          A string-to-string key-value map of query parameters ``sdkType`` -dependent properties of the
          SDK. For ``sdkType`` of ``objectivec`` or ``swift`` , a parameter named ``classPrefix`` is
          required. For ``sdkType`` of ``android`` , parameters named ``groupId`` , ``artifactId`` ,
        ...
        **Request Syntax**
        ...
        :param uri:
          ...
          * For ``HTTP`` or ``HTTP_PROXY`` integrations, the URI must be a fully formed, encoded HTTP(S)
          ...
          where ``connectionType`` is not ``VPC_LINK`` , or private integration, where ``connectionType``
          ...
          * For ``AWS`` or ``AWS_PROXY`` integrations, the URI is of the form
          ...
          integrated AWS service (e.g., ``s3`` ); and ``{subdomain}`` is a designated subdomain supported
          by certain AWS service for fast host-name lookup. ``action`` can be used for an AWS service
        ...
        :param requestParameters:
          ...
          end. The key is an integration request parameter name and the associated value is a method
        ...
        :param passthroughBehavior:
          ...
          request, and the available mapping templates specified as the ``requestTemplates`` property on
    ...
    def put_method(
        ...
        **Request Syntax**
        ...
        :param requestParameters:
          ...
          ``method.request.{location}.{name}`` , where ``location`` is ``querystring`` , ``path`` , or
          ``header`` and ``name`` is a valid and unique parameter name. The value associated with the key
          is a Boolean flag indicating whether the parameter is required (``true`` ) or optional (``false``
    ...
    def put_method_response(
        ...
        **Request Syntax**
        ...
        :param responseParameters:
          ...
          response header names must match the pattern of ``method.response.header.{name}`` , where
          ``name`` is a valid and unique header name. The response parameter names defined here are
          available in the integration response to be mapped from an integration response header expressed
          in ``integration.response.header.{name}`` , a static value enclosed within a pair of single
          quotes (e.g., ``'application/json'`` ), or a JSON expression from the back-end response payload
          in the form of ``integration.response.body.{JSON-expression}`` , where ``JSON-expression`` is a
    ...
    def put_rest_api(
        ...
        **Request Syntax**
        ...
        :param parameters:
          ...
          an imported API, set ``ignore=documentation`` as a ``parameters`` value, as in the AWS CLI
          command of ``aws apigateway import-rest-api --parameters ignore=documentation --body
          'file:///path/to/imported-api-body.json'`` .
        ...
        :param patchOperations:
          ...
          http://tools.ietf.org/html/rfc6902#section-4 for an explanation of how each operation is used.
            ...
            - **path** *(string) --*
              ...
              property value is a JSON object (e.g., ``{"name": {"child/name": "child-value"}}`` ), the
              path for the ``child/name`` property will be ``/name/child~1name`` . Any slash ("/")
              character appearing in path names must be escaped with "~1", as shown in the example above.
