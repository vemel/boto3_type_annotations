...
class Client(BaseClient):
    ...
    def create_replication_job(
        ...
        """
        Creates a replication job. The replication job schedules periodic replication runs to replicate
        your server to AWS. Each replication run creates an Amazon Machine Image (AMI).
    ...
    def generate_change_set(
        ...
        """
        Generates a target change set for a currently launched stack and writes it to an Amazon S3 object
        in the customer’s Amazon S3 bucket.
    ...
    def get_connectors(
        ...
        **Request Syntax**
        ...
        :param maxResults:
          ...
          The maximum number of results to return in a single call. The default value is 50. To retrieve
