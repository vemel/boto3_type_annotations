...
class Client(BaseClient):
    ...
    def get_dashboard_embed_url(
        ...
        <https://docs.aws.amazon.com/en_us/quicksight/latest/user/embedding.html>`__ .
    ...
    def register_user(
        ...
        """
        .. _https://docs.aws.amazon.com/cli/latest/reference/sts/assume-role.html:
        ...
        The condition resource is the Amazon Resource Name (ARN) for the IAM user or role, and the session
        name.
        ...
        **Request Syntax**
        ...
        :param SessionName:
          ...
          https://docs.aws.amazon.com/cli/latest/reference/sts/assume-role.html`__ in the *AWS CLI
          Reference.*
