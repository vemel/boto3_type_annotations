...
class Client(BaseClient):
    ...
    def describe_bandwidth_rate_limit(
        ...
        no bandwidth rate limiting is in effect.
    ...
    def list_tags_for_resource(
        ...
        """
        Lists the tags that have been added to the specified resource. This operation is only supported in
        the cached volume, stored volume and tape gateway type.
    ...
    def remove_tags_from_resource(
        ...
        """
        Removes one or more tags from the specified resource. This operation is only supported in the
        cached volume, stored volume and tape gateway types.
