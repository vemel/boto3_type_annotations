...
class Client(BaseClient):
    ...
    def add_ip_routes(
        ...
        """
        If the DNS server for your on-premises domain uses a publicly addressable IP address, you must add
        a CIDR address block to correctly route traffic to and from your Microsoft AD on Amazon Web
        Services. *AddIpRoutes* adds this address block. You can also use *AddIpRoutes* to facilitate
        routing traffic that uses public IP ranges from your Microsoft AD on AWS to a peer VPC.
    ...
    def create_log_subscription(
        ...
        """
        Creates a subscription to forward real time Directory Service domain controller security logs to
        the specified CloudWatch log group in your AWS account.
        ...
        **Request Syntax**
        ...
        :param DirectoryId: **[REQUIRED]**
          ...
          Identifier (ID) of the directory to which you want to subscribe and receive real-time logs to
    ...
    def describe_event_topics(
        ...
        If no input parameters are provided, such as DirectoryId or TopicName, this request describes all
        of the associations in the account.
    ...
    def describe_trusts(
        ...
        If no input parameters are provided, such as DirectoryId or TrustIds, this request describes all
        the trust relationships belonging to the account.
                ...
                'Trusts': [
                    {
                        ...
                        'TrustDirection': 'One-Way: Outgoing'|'One-Way: Incoming'|'Two-Way',
                        'TrustState':
                        'Creating'|'Created'|'Verifying'|'VerifyFailed'|'Verified'|'Updating'
                        |'UpdateFailed'|'Updated'|'Deleting'|'Deleted'|'Failed',
                        'CreatedDateTime': datetime(2015, 1, 1),
                        'LastUpdatedDateTime': datetime(2015, 1, 1),
    ...
    def enable_sso(
        ...
        **Request Syntax**
        ...
        :param UserName:
          ...
          are only used to enable single sign-on and are not stored by the service. The AD Connector
    ...
    def share_directory(
        ...
        **Request Syntax**
        ...
        :param ShareNotes:
          ...
          request includes a typed message to help the directory consumer administrator determine whether
          to approve or reject the share invitation.
    ...
    def update_number_of_domain_controllers(
        ...
        current value and new value (provided through this API call), domain controllers will be added or
        removed. It may take up to 45 minutes for any new domain controllers to become fully active once
        the requested number of domain controllers is updated. During this time, you cannot make another
        update request.
