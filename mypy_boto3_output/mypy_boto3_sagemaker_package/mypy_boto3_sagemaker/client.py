...
class Client(BaseClient):
    ...
    def add_tags(
        ...
        """
        Adds or overwrites one or more tags for the specified Amazon SageMaker resource. You can add tags
        to notebook instances, training jobs, hyperparameter tuning jobs, batch transform jobs, models,
    ...
    def create_endpoint(
        ...
        uses the endpoint to provision resources and deploy models. You create the endpoint configuration
        with the `CreateEndpointConfig
        ...
        SageMaker uses AWS Security Token Service to download model artifacts from the S3 path you
        provided. AWS STS is activated in your IAM user account by default. If you previously deactivated
        AWS STS for a region, you need to reactivate AWS STS for that region. For more information, see
        `Activating and Deactivating AWS STS i an AWS Region
    ...
    def create_endpoint_config(
        ...
        deploy and the resources that you want Amazon SageMaker to provision. Then you call the
        ...
        **Request Syntax**
        ...
        :param KmsKeyId:
          ...
          .. note::
            ...
            Nitro-based instances do not support encryption with AWS KMS. If any of the models that you
            specify in the ``ProductionVariants`` parameter use nitro-based instances, do not specify a
            ...
            For more information about storage volumes on nitro-based instances, see `Amazon EBS and NVMe
            on Linux Instances
            <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/nvme-ebs-volumes.html>`__ .
    ...
    def create_hyper_parameter_tuning_job(
        ...
        """
        Starts a hyperparameter tuning job. A hyperparameter tuning job finds the best version of a model
    ...
    def create_labeling_job(
        ...
        * The Amazon Mechanical Turk workforce. This is the largest workforce, but it should only be used
        ...
        labeled by a human. Automated data labeling uses *active learning* to determine if a data object
        can be labeled by machine or if it needs to be sent to a human worker. For more information, see
    ...
    def create_model_package(
        ...
        To create a model package by specifying a Docker container that contains your inference code and
        the Amazon S3 location of your model artifacts, provide values for ``InferenceSpecification`` . To
    ...
    def create_notebook_instance(
        ...
        * Launches an EC2 instance of the type specified in the request in the Amazon SageMaker VPC. If you
        ...
        work in Jupyter notebooks. For example, you can write code to explore a dataset that you can use
        for model training, train a model, host models by creating Amazon SageMaker endpoints, and validate
        hosted models.
        ...
        **Request Syntax**
        ...
        :param DirectInternetAccess:
          ...
          to ``Disabled`` this notebook instance will be able to access resources only in your VPC, and
          will not be able to connect to Amazon SageMaker training and endpoint services unless your
        ...
        :param VolumeSizeInGB:
          ...
          The size, in GB, of the ML storage volume to attach to the notebook instance. The default value
          is 5 GB.
    ...
    def create_presigned_notebook_instance_url(
        ...
        IAM authorization policies for this API are also enforced for every HTTP request and WebSocket
        frame that attempts to connect to the notebook instance.For example, you can restrict access to
        this API and to the URL that it returns to a list of IP addresses that you specify. Use the
        ``NotIpAddress`` condition operator and the ``aws:SourceIP`` condition context key to specify the
        list of IP addresses that you want to have access to the notebook instance. For more information,
        see `Limit Access to a Notebook Instance by IP Address
    ...
    def create_training_job(
        ...
        * ``RoleARN`` - The Amazon Resource Number (ARN) that Amazon SageMaker assumes to perform tasks on
        your behalf during model training. You must grant this role the necessary permissions so that
        ...
        **Request Syntax**
        ...
        :param InputDataConfig:
          ...
          two channels of input data, ``training_data`` and ``validation_data`` . The configuration for
          each channel provides the S3, EFS, or FSx location where the input data is stored. It also
          provides information about the stored data: the MIME type, compression method, and whether the
          ...
          data files from an S3 bucket to a local directory in the Docker container, or makes it available
          as input streams. For example, if you specify an EFS location, input data files will be made
        ...
        :param EnableInterContainerTrafficEncryption:
          ...
          especially if you use a deep learning algorithm in distributed training. For more information,
          see `Protect Communications Between ML Compute Instances in a Distributed Training Job
    ...
    def create_transform_job(
        ...
        **Request Syntax**
        ...
        :param MaxConcurrentTransforms:
          ...
          on execution-parameters, see `How Containers Serve Requests
        ...
        :param MaxPayloadInMB:
          ...
          (without metadata). The value in ``MaxPayloadInMB`` must be greater than, or equal to, the size
          of a single record. To estimate the size of a record in MB, divide the size of your dataset by
          the number of records. To ensure that the records fit within the maximum payload size, we
    ...
    def create_workteam(
        ...
        **Request Syntax**
        ...
        :param MemberDefinitions: **[REQUIRED]**
          ...
          A list of ``MemberDefinition`` objects that contains objects that identify the Amazon Cognito
          user pool that makes up the work team. For more information, see `Amazon Cognito User Pools
    ...
    def list_hyper_parameter_tuning_jobs(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          response includes a ``NextToken`` . To retrieve the next set of tuning jobs, use the token in the
          next request.
    ...
    def list_model_packages(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          If the response to a previous ``ListModelPackages`` request was truncated, the response includes
          a ``NextToken`` . To retrieve the next set of model packages, use the token in the next request.
    ...
    def list_models(
        ...
        **Request Syntax**
        ...
        :param CreationTimeAfter:
          ...
          A filter that returns only models with a creation time greater than or equal to the specified
          time (timestamp).
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          .. note::
            ...
            You might specify a filter or a sort order in your request. When response is truncated, you
            must use the same values for the filer and sort order in the next request.
    ...
    def list_transform_jobs(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          If the result of the previous ``ListTransformJobs`` request was truncated, the response includes
          a ``NextToken`` . To retrieve the next set of transform jobs, use the token in the next request.
                            ...
                            'SecondaryStatusTransitions': [
                                {
                                    ...
                                    |'Downloading'|'DownloadingTrainingImage'|'Training'|'Uploading'
                                    |'Stopping'|'Stopped'|'MaxRuntimeExceeded'|'Completed'|'Failed'
    ...
    def start_notebook_instance(self, NotebookInstanceName: str) -> None:
        ...
        storage volume. After configuring the notebook instance, Amazon SageMaker sets the notebook
        instance status to ``InService`` . A notebook instance's status must be ``InService`` before you
    ...
    def update_notebook_instance(
        ...
        **Request Syntax**
        ...
        :param DisassociateLifecycleConfig:
          ...
          the notebook instance. This operation is idempotent. If you specify a lifecycle configuration
        ...
        :param VolumeSizeInGB:
          ...
          The size, in GB, of the ML storage volume to attach to the notebook instance. The default value
          is 5 GB. ML storage volumes are encrypted, so Amazon SageMaker can't determine the amount of
    ...
    def update_notebook_instance_lifecycle_config(
        ...
        **Request Syntax**
        ...
        :param OnStart:
          ...
          the notebook instance. The shell script must be a base64-encoded string.
