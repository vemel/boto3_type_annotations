...
class PlatformEndpoint(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        ...
        PlatformEndpoint resource. Note that the load and reload methods are the same method and can be
        used interchangeably.
...
class Subscription(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        ...
        Subscription resource. Note that the load and reload methods are the same method and can be used
        interchangeably.
...
class ServiceResourcePlatformApplicationsCollection(ResourceCollection):
    ...
    def filter(
        ...
        """
        Creates an iterable of all PlatformApplication resources in the collection filtered by kwargs
        passed to method.
...
class PlatformApplicationEndpointsCollection(ResourceCollection):
    ...
    def filter(
        ...
        """
        Creates an iterable of all PlatformEndpoint resources in the collection filtered by kwargs passed
        to method.
