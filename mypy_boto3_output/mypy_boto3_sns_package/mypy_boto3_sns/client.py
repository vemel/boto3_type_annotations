...
class Client(BaseClient):
    ...
    def confirm_subscription(
        ...
        subscription and returns its Amazon Resource Name (ARN). This call requires an AWS signature only
    ...
    def create_platform_application(
        ...
        service. For WNS, PlatformPrincipal is "Package Security Identifier". For MPNS, PlatformPrincipal
        is "TLS certificate". For Baidu, PlatformPrincipal is "API key".

        For APNS/APNS_SANDBOX, PlatformCredential is "private key". For GCM, PlatformCredential is "API
        ...
        attribute for the ``CreatePlatformEndpoint`` action. For more information, see `Using Amazon SNS
        Mobile Push Notifications <https://docs.aws.amazon.com/sns/latest/dg/SNSMobilePush.html>`__ . For
        more information about obtaining the PlatformPrincipal and PlatformCredential for each of the
        supported push notification services, see `Getting Started with Apple Push Notification Service
        <https://docs.aws.amazon.com/sns/latest/dg/mobile-push-apns.html>`__ , `Getting Started with Amazon
        Device Messaging <https://docs.aws.amazon.com/sns/latest/dg/mobile-push-adm.html>`__ , `Getting
        Started with Baidu Cloud Push <https://docs.aws.amazon.com/sns/latest/dg/mobile-push-baidu.html>`__
        , `Getting Started with Google Cloud Messaging for Android
        <https://docs.aws.amazon.com/sns/latest/dg/mobile-push-gcm.html>`__ , `Getting Started with MPNS
        <https://docs.aws.amazon.com/sns/latest/dg/mobile-push-mpns.html>`__ , or `Getting Started with WNS
        <https://docs.aws.amazon.com/sns/latest/dg/mobile-push-wns.html>`__ .
        ...
        **Request Syntax**
        ...
        :param Platform: **[REQUIRED]**
          ...
          Notification Service), APNS_SANDBOX, and GCM (Google Cloud Messaging).
    ...
    def create_platform_endpoint(
        ...
        such as GCM and APNS. ``CreatePlatformEndpoint`` requires the PlatformApplicationArn that is
    ...
    def get_endpoint_attributes(
        ...
        such as GCM and APNS. For more information, see `Using Amazon SNS Mobile Push Notifications
        <https://docs.aws.amazon.com/sns/latest/dg/SNSMobilePush.html>`__ .
    ...
    def list_endpoints_by_platform_application(
        ...
        such as GCM and APNS. The results for ``ListEndpointsByPlatformApplication`` are paginated and
    ...
    def list_platform_applications(
        ...
        and GCM. The results for ``ListPlatformApplications`` are paginated and return a limited list of
    ...
    def publish(
        ...
        To use the ``Publish`` action for sending a message to a mobile endpoint, such as an app on a
        ...
        **Request Syntax**
        ...
        :param Message: **[REQUIRED]**
          ...
          .. warning::
            ...
            The ``Message`` parameter is always a string. If you set ``MessageStructure`` to ``json`` , you
            must string-encode the ``Message`` parameter.
          ...
          * For SMS, each message can contain up to 140 characters. This character limit depends on the
          ...
          truncated mid-word but are cut off at whole-word boundaries. The total size limit for a single
          SMS ``Publish`` action is 1,600 characters.
        ...
        :param MessageStructure:
          ...
          * contain at least a top-level JSON key of "default" with a value that is a string.
          ...
          Console, go to `Create Different Messages for Each Protocol
          <https://docs.aws.amazon.com/sns/latest/gsg/Publish.html#sns-message-formatting-by-protocol>`__
    ...
    def set_platform_application_attributes(
        ...
        services, such as APNS and GCM. For more information, see `Using Amazon SNS Mobile Push
        Notifications <https://docs.aws.amazon.com/sns/latest/dg/SNSMobilePush.html>`__ . For information
        on configuring attributes for message delivery status, see `Using Amazon SNS Application Attributes
        for Message Delivery Status <https://docs.aws.amazon.com/sns/latest/dg/sns-msg-status.html>`__ .
        ...
        **Request Syntax**
        ...
        :param Attributes: **[REQUIRED]**
          ...
          * ``PlatformCredential`` – The credential received from the notification service. For
          APNS/APNS_SANDBOX, PlatformCredential is private key. For GCM, PlatformCredential is "API key".
          For ADM, PlatformCredential is "client secret".

          * ``PlatformPrincipal`` – The principal received from the notification service. For
          APNS/APNS_SANDBOX, PlatformPrincipal is SSL certificate. For GCM, PlatformPrincipal is not
        ...
        **Request Syntax**
        ...
        :param attributes: **[REQUIRED]**
          ...
          following attribute names:
           ...
           send SMS messages. When Amazon SNS determines that sending an SMS message would incur a cost
           that exceeds this limit, it stops sending SMS messages within minutes.
    ...
    def subscribe(
        ...
        create a subscription, the endpoint owner must call the ``ConfirmSubscription`` action with the
        token from the confirmation message. Confirmation tokens are valid for three days.
        ...
        **Request Syntax**
        ...
        :param ReturnSubscriptionArn:
          ...
          subscriptions, but it includes an ARN value of "pending subscription" for subscriptions that are
          not yet confirmed. A subscription becomes confirmed when the subscriber calls the
    ...
    def tag_resource(
        ...
        * Tagging actions are limited to 10 TPS per AWS account. If your application requires a higher
        ...
        <https://docs.aws.amazon.com/sns/latest/dg/sns-limits.html#limits-topics>`__ in the *Amazon SNS
        Developer Guide* .
