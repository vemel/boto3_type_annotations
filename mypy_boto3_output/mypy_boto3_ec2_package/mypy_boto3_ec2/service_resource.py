"Main interface for ec2 ServiceResource"
...
class ServiceResource(Boto3ServiceResource):
    ...
    def create_dhcp_options(
        ...
        options. The following are the individual DHCP options you can specify. For more information about
        the options, see `RFC 2132 <http://www.ietf.org/rfc/rfc2132.txt>`__ .

        * ``domain-name-servers`` - The IP addresses of up to four domain name servers, or
        AmazonProvidedDNS. The default DHCP option set specifies AmazonProvidedDNS. If specifying more than
        one domain name server, specify the IP addresses in a single parameter, separated by commas. To
        have your instance receive a custom DNS hostname as specified in ``domain-name`` , you must set
        ``domain-name-servers`` to a custom DNS server.

        * ``domain-name`` - If you're using AmazonProvidedDNS in ``us-east-1`` , specify ``ec2.internal`` .
        If you're using AmazonProvidedDNS in another Region, specify ``region.compute.internal`` (for
        ...
        Linux operating systems accept multiple domain names separated by spaces. However, Windows and
        ...
        * ``netbios-node-type`` - The NetBIOS node type (1, 2, 4, or 8). We recommend that you specify 2
        ...
        a domain name server of your choice. For more information, see `DHCP Options Sets
        <https://docs.aws.amazon.com/vpc/latest/userguide/VPC_DHCP_Options.html>`__ in the *Amazon Virtual
        Private Cloud User Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/CreateDhcpOptions>`_
    ...
    def create_instances(
        ...
        * Some instance types must be launched into a VPC. If you do not have a default VPC, or if you do
        not specify a subnet ID, the request fails. For more information, see `Instance Types Available
        Only in a VPC
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-vpc.html#vpc-only-instance-types>`__ .

        * [EC2-VPC] All instances have a network interface with a primary private IPv4 address. If you
        ...
        * If you don't specify a security group ID, we use the default security group. For more
        ...
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-network-security.html>`__ .
        ...
        * If any of the AMIs have a product code attached for which the user has not subscribed, the
        ...
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-launch-templates.html>`__ , which is a
        resource that contains the parameters to launch an instance. When you launch an instance using
        RunInstances , you can specify the launch template instead of specifying the launch parameters.

        To ensure faster instance launches, break up large requests into smaller batches. For example,
        create five separate launch requests for 100 instances each instead of one launch request for 500
        instances.

        An instance is ready for you to use when it's in the ``running`` state. You can check the state of
        your instance using  DescribeInstances . You can tag instances and EBS volumes during launch, after
        launch, or both. For more information, see  CreateTags and `Tagging Your Amazon EC2 Resources
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Using_Tags.html>`__ .

        Linux instances have access to the public key of the key pair at boot. You can use this key to
        provide secure access to the instance. Amazon EC2 public images use this feature to provide secure
        access without passwords. For more information, see `Key Pairs
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-key-pairs.html>`__ in the *Amazon Elastic
        Compute Cloud User Guide* .

        For troubleshooting, see `What To Do If An Instance Immediately Terminates
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Using_InstanceStraightToTerminated.html>`__ ,
        and `Troubleshooting Connecting to Your Instance
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/TroubleshootingInstancesConnecting.html>`__ in
        the *Amazon Elastic Compute Cloud User Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/RunInstances>`_
        ...
        **Request Syntax**
        ...
        :param BlockDeviceMappings:
          ...
          - *(dict) --*
            ...
            - **VirtualName** *(string) --*
              ...
              The virtual device name (``ephemeral`` N). Instance store volumes are numbered starting from
              0. An instance type with 2 available instance store volumes can specify mappings for
              ``ephemeral0`` and ``ephemeral1`` . The number of available instance store volumes depends on
            ...
            - **Ebs** *(dict) --*
              ...
              - **DeleteOnTermination** *(boolean) --*
                ...
                see `Preserving Amazon EBS Volumes on Instance Termination
              ...
              - **Iops** *(integer) --*
                ...
                which the volume accumulates I/O credits for bursting. For more information, see `Amazon
                EBS Volume Types
                ...
                . Other instance families guarantee performance up to 32,000 IOPS. For more information,
              ...
              - **VolumeType** *(string) --*
                ...
                The volume type. If you set the type to ``io1`` , you must also specify the IOPS that the
                volume supports.
              ...
              - **KmsKeyId** *(string) --*
                ...
                Identifier (key ID, key alias, ID ARN, or alias ARN) for a customer managed CMK under which
                ...
                `RequestSpotFleet
                <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_RequestSpotFleet.html>`__ , and
        ...
        :param KernelId:
          ...
          .. warning::
            ...
            `PV-GRUB <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/UserProvidedkernels.html>`__ in
            the *Amazon Elastic Compute Cloud User Guide* .
        ...
        :param KeyName:
          ...
          <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateKeyPair.html>`__ or
          `ImportKeyPair <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_ImportKeyPair.html>`__
          .
        ...
        :param MaxCount: **[REQUIRED]**
          ...
          Constraints: Between 1 and the maximum number you're allowed for the specified instance type. For
          more information about the default limits, and how to request an increase, see `How many
          instances can I run in Amazon EC2
          <http://aws.amazon.com/ec2/faqs/#How_many_instances_can_I_run_in_Amazon_EC2>`__ in the Amazon EC2
          FAQ.
        ...
        :param Placement:
          ...
          - **Affinity** *(string) --*
            ...
            The affinity setting for the instance on the Dedicated Host. This parameter is not supported
          ...
          - **PartitionNumber** *(integer) --*
            ...
            The number of the partition the instance is in. Valid only if the placement group strategy is
            set to ``partition`` .
        ...
        :param SecurityGroupIds:
          ...
          <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateSecurityGroup.html>`__ .
        ...
        :param UserData:
          ...
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/user-data.html>`__ (Linux) and `Adding User
          Data
          <https://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/ec2-instance-metadata.html#instancedata-add-user-data>`__
          (Windows). If you are using a command line tool, base64-encoding is performed for you, and you
          can load the text from a file. Otherwise, you must provide base64-encoded text. User data is
          limited to 16 KB.
        ...
        :param DisableApiTermination:
          ...
          <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_ModifyInstanceAttribute.html>`__ .
        ...
        :param NetworkInterfaces:
          ...
          must specify any security groups and subnets as part of the network interface.
          ...
          - *(dict) --*
            ...
            - **DeleteOnTermination** *(boolean) --*
              ...
              specify ``true`` only if creating a new network interface when launching an instance.
            ...
            - **Ipv6AddressCount** *(integer) --*
              ...
              addresses from the range of the subnet. You cannot specify this option and the option to
              assign specific IPv6 addresses in the same request. You can specify this option if you've
            ...
            - **Ipv6Addresses** *(list) --*
              ...
              and the option to assign a number of IPv6 addresses in the same request. You cannot specify
            ...
            - **PrivateIpAddress** *(string) --*
              ...
              interface when launching an instance. You cannot specify this option if you're launching more
              than one instance in a `RunInstances
              <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_RunInstances.html>`__ request.
            ...
            - **SecondaryPrivateIpAddressCount** *(integer) --*
              ...
              more than one private IP address using the private IP addresses option. You cannot specify
            ...
            - **InterfaceType** *(string) --*
              ...
              <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/efa.html>`__ in the *Amazon Elastic
              Compute Cloud User Guide* .
        ...
        :param PrivateIpAddress:
          ...
          interface specification. You cannot specify this option if you're launching more than one
        ...
        :param ElasticGpuSpecification:
          ...
          more information, see `Amazon EC2 Elastic GPUs
          <https://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/elastic-graphics.html>`__ in the *Amazon
          Elastic Compute Cloud User Guide* .
          ...
          **InstanceInterruptionBehavior** is set to either ``hibernate`` or ``stop`` .
          ...
          - **SpotOptions** *(dict) --*
            ...
            - **MaxPrice** *(string) --*
              ...
              The maximum hourly price you're willing to pay for the Spot Instances. The default is the
              On-Demand price.

            - **SpotInstanceType** *(string) --*

              The Spot Instance request type. For  RunInstances , persistent Spot Instance requests are
              only supported when **InstanceInterruptionBehavior** is set to either ``hibernate`` or
              ``stop`` .

            - **BlockDurationMinutes** *(integer) --*

              The required duration for the Spot Instances (also known as Spot blocks), in minutes. This
        ...
        :param CreditSpecification:
          ...
          The credit option for CPU usage of the T2 or T3 instance. Valid values are ``standard`` and
          ``unlimited`` . To change this attribute after launch, use `ModifyInstanceCreditSpecification
          <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_ModifyInstanceCreditSpecification.html>`__
          . For more information, see `Burstable Performance Instances
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/burstable-performance-instances.html>`__ in
          the *Amazon Elastic Compute Cloud User Guide* .
        ...
        :param CpuOptions:
          ...
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-optimize-cpu.html>`__ in the
        ...
        :param HibernationOptions:
          ...
          Indicates whether an instance is enabled for hibernation. For more information, see `Hibernate
    ...
    def create_internet_gateway(
        ...
        to a VPC using  AttachInternetGateway .

        For more information about your VPC and internet gateway, see the `Amazon Virtual Private Cloud
        User Guide <https://docs.aws.amazon.com/vpc/latest/userguide/>`__ .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/CreateInternetGateway>`_
    ...
    def create_key_pair(
        ...
        displays the private key for you to save to a file. The private key is returned as an unencrypted
        PEM encoded PKCS#1 private key. If a key with the specified name already exists, Amazon EC2 returns
        an error.

        You can have up to five thousand key pairs per Region.

        The key pair returned to you is available only in the Region in which you create it. If you prefer,
        you can create your own key pair using a third-party tool and upload it to any Region using
        ImportKeyPair .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/CreateKeyPair>`_
    ...
    def create_network_acl(
        ...
        <https://docs.aws.amazon.com/vpc/latest/userguide/VPC_ACLs.html>`__ in the *Amazon Virtual Private
        Cloud User Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/CreateNetworkAcl>`_
    ...
    def create_network_interface(
        ...
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-eni.html>`__ in the *Amazon Virtual
        Private Cloud User Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/CreateNetworkInterface>`_
        ...
        **Request Syntax**
        ...
        :param Ipv6AddressCount:
          ...
          addresses. If your subnet has the ``AssignIpv6AddressOnCreation`` attribute set to ``true`` , you
          can specify ``0`` to override this setting.
        ...
        :param SecondaryPrivateIpAddressCount:
          ...
          more information, see `IP Addresses Per ENI Per Instance Type
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-eni.html#AvailableIpPerENI>`__ in the
        ...
        :param InterfaceType:
          ...
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/efa.html>`__ in the *Amazon Elastic Compute
          Cloud User Guide* .
    ...
    def create_placement_group(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/CreatePlacementGroup>`_
    ...
    def create_route_table(
        ...
        <https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Route_Tables.html>`__ in the *Amazon Virtual
        Private Cloud User Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/CreateRouteTable>`_
    ...
    def create_security_group(
        ...
        traffic. For more information, see `Amazon EC2 Security Groups
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-network-security.html>`__ in the *Amazon
        Elastic Compute Cloud User Guide* and `Security Groups for Your VPC
        <https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_SecurityGroups.html>`__ in the *Amazon
        Virtual Private Cloud User Guide* .

        When you create a security group, you specify a friendly name of your choice. You can have a
        security group for use in EC2-Classic with the same name as a security group for use in a VPC.
        However, you can't have two security groups for use in EC2-Classic with the same name or two
        security groups for use in a VPC with the same name.

        You have a default security group for use in EC2-Classic and a default security group for use in
        your VPC. If you don't specify a security group when you launch an instance, the instance is
        launched into the appropriate default security group. A default security group includes a default
        ...
        <https://docs.aws.amazon.com/vpc/latest/userguide/amazon-vpc-limits.html>`__ .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/CreateSecurityGroup>`_
    ...
    def create_snapshot(
        ...
        """
        Creates a snapshot of an EBS volume and stores it in Amazon S3. You can use snapshots for backups,
        to make copies of EBS volumes, and to save data before shutting down an instance.
        ...
        However, if you cannot pause all file writes to the volume, you should unmount the volume from
        within the instance, issue the snapshot command, and then remount the volume to ensure a consistent
        and complete snapshot. You may remount and use your volume while the snapshot status is ``pending``
        .

        To create a snapshot for EBS volumes that serve as root devices, you should stop the instance
        ...
        Resources <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Using_Tags.html>`__ in the *Amazon
        Elastic Compute Cloud User Guide* .

        For more information, see `Amazon Elastic Block Store
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/AmazonEBS.html>`__ and `Amazon EBS Encryption
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSEncryption.html>`__ in the *Amazon Elastic
        Compute Cloud User Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/CreateSnapshot>`_
    ...
    def create_subnet(
        ...
        create a subnet, you can't change its CIDR block. The size of the subnet's IPv4 CIDR block can be
        the same as a VPC's IPv4 CIDR block, or a subset of a VPC's IPv4 CIDR block. If you create more
        than one subnet in a VPC, the subnets' CIDR blocks must not overlap. The smallest IPv4 subnet (and
        VPC) you can create uses a /28 netmask (16 IPv4 addresses), and the largest uses a /16 netmask
        ...
        .. warning::
          ...
          AWS reserves both the first four and the last IPv4 address in each subnet's CIDR block. They're
          not available for use.

        If you add more than one subnet to a VPC, they're set up in a star topology with a logical router
        in the middle.

        If you launch an instance in a VPC using an Amazon EBS-backed AMI, the IP address doesn't change if
        you stop and restart the instance (unlike a similar instance launched outside a VPC, which gets a
        ...
        <https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Subnets.html>`__ in the *Amazon Virtual
        Private Cloud User Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/CreateSubnet>`_
    ...
    def create_volume(
        ...
        You can create encrypted volumes. Encrypted volumes must be attached to instances that support
        Amazon EBS encryption. Volumes that are created from encrypted snapshots are also automatically
        ...
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-creating-volume.html>`__ in the *Amazon
        Elastic Compute Cloud User Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/CreateVolume>`_
        ...
        **Request Syntax**
        ...
        :param Iops:
          ...
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-types.html#ec2-nitro-instances>`__
          . Other instance families guarantee performance up to 32,000 IOPS. For more information, see
        ...
        :param KmsKeyId:
          ...
          * Alias ARN. For example, arn:aws:kms:*us-east-1* :*012345678910* :alias/*ExampleAlias* .
          ...
          AWS authenticates the CMK asynchronously. Therefore, if you specify an ID, alias, or ARN that is
        ...
        :param Size:
          ...
          for ``sc1`` , and 1-1,024 for ``standard`` . If you specify a snapshot, the volume size must be
    ...
    def create_vpc(
        ...
        netmask (16 IPv4 addresses), and the largest uses a /16 netmask (65,536 IPv4 addresses). For more
        information about how large to make your VPC, see `Your VPC and Subnets
        <https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Subnets.html>`__ in the *Amazon Virtual
        Private Cloud User Guide* .

        You can optionally request an Amazon-provided IPv6 CIDR block for the VPC. The IPv6 CIDR block uses
        a /56 prefix length, and is allocated from Amazon's pool of IPv6 addresses. You cannot choose the
        IPv6 range for your VPC.

        By default, each instance you launch in the VPC has the default DHCP options, which include only a
        default DNS server that we provide (AmazonProvidedDNS). For more information, see `DHCP Options
        Sets <https://docs.aws.amazon.com/vpc/latest/userguide/VPC_DHCP_Options.html>`__ in the *Amazon
        Virtual Private Cloud User Guide* .

        You can specify the instance tenancy value for the VPC when you create it. You can't change this
        value for the VPC after you create it. For more information, see `Dedicated Instances
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/dedicated-instance.html>`__ in the *Amazon
        Elastic Compute Cloud User Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/CreateVpc>`_
        ...
        **Request Syntax**
        ...
        :param InstanceTenancy:
          ...
          VPC. For ``dedicated`` , instances are launched as dedicated tenancy instances by default. You
          can only launch instances with a tenancy of ``dedicated`` or ``host`` into a dedicated tenancy
          VPC.
    ...
    def create_vpc_peering_connection(
        ...
        VPC with which to create the connection. The accepter VPC can belong to another AWS account and can
        be in a different Region to the requester VPC. The requester VPC and accepter VPC cannot have
        ...
        .. note::
          ...
          `limitations
          <https://docs.aws.amazon.com/vpc/latest/peering/vpc-peering-basics.html#vpc-peering-limitations>`__
        ...
        The VPC peering connection request expires after 7 days, after which it cannot be accepted or
        rejected.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/CreateVpcPeeringConnection>`_
    ...
    def disassociate_route_table(self, AssociationId: str, DryRun: bool = None) -> None:
        ...
        After you perform this action, the subnet no longer uses the routes in the route table. Instead, it
        uses the routes in the VPC's main route table. For more information about route tables, see `Route
        Tables <https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Route_Tables.html>`__ in the *Amazon
        Virtual Private Cloud User Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DisassociateRouteTable>`_
    ...
    def import_key_pair(
        ...
        """
        Imports the public key from an RSA key pair that you created with a third-party tool. Compare this
        with  CreateKeyPair , in which AWS creates the key pair and gives the keys to you (AWS keeps a copy
        of the public key). With ImportKeyPair, you create the key pair and give AWS just the public key.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/ImportKeyPair>`_
    ...
    def register_image(
        ...
        Own AMIs <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/creating-an-ami.html>`__ in the
        *Amazon Elastic Compute Cloud User Guide* .

        .. note::

          For Amazon EBS-backed instances,  CreateImage creates and registers the AMI in a single request,
        ...
        root device volume. You specify the snapshot using the block device mapping. For more information,
        see `Launching a Linux Instance from a Backup
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-launch-snapshot.html>`__ in the
        *Amazon Elastic Compute Cloud User Guide* .

        You can't register an image where a secondary (non-root) snapshot has AWS Marketplace product codes.

        Windows and some Linux distributions, such as Red Hat Enterprise Linux (RHEL) and SUSE Linux
        Enterprise Server (SLES), use the EC2 billing product code associated with an AMI to verify the
        subscription status for package updates. To create a new AMI for operating systems that require a
        ...
        * Create a new AMI from the instance using  CreateImage to preserve the billing product code
        association.

        If you purchase a Reserved Instance to apply to an On-Demand Instance that was launched from an AMI
        with a billing product code, make sure that the Reserved Instance has the matching billing product
        code. If you purchase a Reserved Instance without the matching billing product code, the Reserved
        ...
        instance store volume invalidates its registration. If you make changes to an image, deregister the
        previous image and register the new image.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/RegisterImage>`_
        ...
        **Request Syntax**
        ...
        :param ImageLocation:
          ...
          EC2. For more information, see `Canned ACLs
          <https://docs.aws.amazon.com/AmazonS3/latest/dev/acl-overview.html#canned-acl>`__ in the *Amazon
          S3 Service Developer Guide* .
...
class ClassicAddress(Boto3ServiceResource):
    ...
    def associate(
        ...
        *Amazon Elastic Compute Cloud User Guide* .
        ...
        a different instance, it is disassociated from that instance and associated with the specified
        instance. If you associate an Elastic IP address with an instance that has an existing Elastic IP
        address, the existing address is disassociated from the instance, but remains allocated to your
        account.
        ...
        different instance or a network interface, you get an error unless you allow reassociation. You
        cannot associate an Elastic IP address with an instance or network interface that has an existing
        Elastic IP address.

        .. warning::

          This is an idempotent operation. If you perform the operation more than once, Amazon EC2 doesn't
          return an error, and you may be charged for each time the Elastic IP address is remapped to the
          same instance. For more information, see the *Elastic IP Addresses* section of `Amazon EC2
          Pricing <http://aws.amazon.com/ec2/pricing/>`__ .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/AssociateAddress>`_
        ...
        **Request Syntax**
        ...
        :param AllowReassociation:
          ...
          account, reassociation is automatic, therefore you can specify false to ensure the operation
    ...
    def disassociate(self, AssociationId: str = None, DryRun: bool = None) -> None:
        ...
        *Amazon Elastic Compute Cloud User Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DisassociateAddress>`_
    ...
    def release(self, AllocationId: str = None, DryRun: bool = None) -> None:
        ...
        you can release it. Otherwise, Amazon EC2 returns an error (``InvalidIPAddress.InUse`` ).

        After releasing an Elastic IP address, it is released to the IP address pool. Be sure to update
        your DNS records and any servers or devices that communicate with the address. If you attempt to
        release an Elastic IP address that you already released, you'll get an ``AuthFailure`` error if the
        address is already allocated to another AWS account.

        [EC2-VPC] After you release an Elastic IP address for use in a VPC, you might be able to recover
        it. For more information, see  AllocateAddress .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/ReleaseAddress>`_
...
class DhcpOptions(Boto3ServiceResource):
    ...
    def associate_with_vpc(self, VpcId: str, DryRun: bool = None) -> None:
        ...
        launch in that VPC use the options. You don't need to restart or relaunch the instances. They
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/AssociateDhcpOptions>`_
    ...
    def delete(self, DryRun: bool = None) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DeleteDhcpOptions>`_
...
class Image(Boto3ServiceResource):
    ...
    def deregister(self, DryRun: bool = None) -> None:
        ...
        instances; however, it doesn't affect any instances that you've already launched from the AMI.
        ...
        the root volume of the instance during the AMI creation process. When you deregister an instance
        store-backed AMI, it doesn't affect the files that you uploaded to Amazon S3 when you created the
        AMI.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DeregisterImage>`_
    ...
    def describe_attribute(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeImageAttribute>`_
        ...
        **Request Syntax**
        ...
        :param Attribute: **[REQUIRED]**
           ...
           **Note** : Depending on your account privileges, the ``blockDeviceMapping`` attribute may return
           a ``Client.AuthFailure`` error. If this happens, use  DescribeImages to get information about
            ...
            - **BlockDeviceMappings** *(list) --*
              ...
              - *(dict) --*
                ...
                - **VirtualName** *(string) --*
                  ...
                  The virtual device name (``ephemeral`` N). Instance store volumes are numbered starting
                  from 0. An instance type with 2 available instance store volumes can specify mappings for
                  ``ephemeral0`` and ``ephemeral1`` . The number of available instance store volumes
                  depends on the instance type. After you connect to the instance, you must mount the
                  volume.
                ...
                - **Ebs** *(dict) --*
                  ...
                  - **Iops** *(integer) --*
                    ...
                    volumes, this represents the number of IOPS that are provisioned for the volume. For
                    ``gp2`` volumes, this represents the baseline performance of the volume and the rate at
                    which the volume accumulates I/O credits for bursting. For more information, see
                    `Amazon EBS Volume Types
                  ...
                  - **VolumeSize** *(integer) --*
                    ...
                    SSD (``io1`` ), 500-16384 for Throughput Optimized HDD (``st1`` ), 500-16384 for Cold
                    HDD (``sc1`` ), and 1-1024 for Magnetic (``standard`` ) volumes. If you specify a
                    snapshot, the volume size must be equal to or larger than the snapshot size.

                  - **VolumeType** *(string) --*

                    The volume type. If you set the type to ``io1`` , you must also specify the IOPS that
                    the volume supports.
                  ...
                  - **Encrypted** *(boolean) --*
                    ...
                    Indicates whether the encryption state of an EBS volume is changed while being restored
                    from a backing snapshot. The effect of setting the encryption state to ``true`` depends
                    on the volume origin (new or from a snapshot), starting encryption state, ownership,
                    and whether encryption by default is enabled. For more information, see `Amazon EBS
                    Encryption
                    <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSEncryption.html#encryption-parameters>`__
                    in the *Amazon Elastic Compute Cloud User Guide* .
    ...
    def modify_attribute(
        ...
        """
        Modifies the specified attribute of the specified AMI. You can specify only one attribute at a
        time. You can use the ``Attribute`` parameter to specify the attribute or one of the following
        ...
        To enable the SriovNetSupport enhanced networking attribute of an image, enable SriovNetSupport on
        an instance and create an AMI from the instance.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/ModifyImageAttribute>`_
    ...
    def reset_attribute(self, Attribute: str, DryRun: bool = None) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/ResetImageAttribute>`_
    ...
    def wait_until_exists(
        ...
        """
        Waits until this Image is exists. This method calls :py:meth:`EC2.Waiter.image_exists.wait` which
...
class Instance(Boto3ServiceResource):
    ...
    def attach_classic_link_vpc(
        ...
        only link an instance that's in the ``running`` state. An instance is automatically unlinked from a
        VPC when it's stopped - you can link it to the VPC again when you restart it.

        After you've linked an instance, you cannot change the VPC security groups that are associated with
        it. To change the security groups, you must first unlink the instance, and then link it again.

        Linking your instance to a VPC is sometimes referred to as *attaching* your instance.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/AttachClassicLinkVpc>`_
    ...
    def attach_volume(
        ...
        Encrypted EBS volumes must be attached to instances that support Amazon EBS encryption. For more
        information, see `Amazon EBS Encryption
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSEncryption.html>`__ in the *Amazon Elastic
        Compute Cloud User Guide* .

        After you attach an EBS volume, you must make it available. For more information, see `Making an
        EBS Volume Available For Use
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-using-volumes.html>`__ .
        ...
        * The instance type and operating system of the instance must support the product. For example, you
        ...
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-attaching-volume.html>`__ in the *Amazon
        Elastic Compute Cloud User Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/AttachVolume>`_
    ...
    def console_output(
        ...
        attached to a computer. For Windows instances, the instance console output includes the last three
        system event log errors.

        By default, the console output returns buffered information that was posted shortly after an
        instance transition state (start, stop, reboot, or terminate). This information is available for at
        least one hour after the most recent post. Only the most recent 64 KB of console output is
        available.

        You can optionally retrieve the latest serial console output at any time during the instance
        lifecycle. This option is supported on instance types that use the Nitro hypervisor.

        For more information, see `Instance Console Output
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-console.html#instance-console-console-output>`__
        in the *Amazon Elastic Compute Cloud User Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/GetConsoleOutput>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Output** *(string) --*
              ...
              The console output, base64-encoded. If you are using a command line tool, the tool decodes
              the output for you.
    ...
    def create_image(
        ...
        device volume, the new AMI contains block device mapping information for those volumes. When you
        launch an instance from this new AMI, the instance automatically launches with those additional
        volumes.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/CreateImage>`_
        ...
        **Request Syntax**
        ...
        :param BlockDeviceMappings:
          ...
          The block device mappings. This parameter cannot be used to modify the encryption status of
    ...
    def delete_tags(
        ...
        To list the current tags, use  DescribeTags . For more information about tags, see `Tagging Your
        Resources <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Using_Tags.html>`__ in the *Amazon
        Elastic Compute Cloud User Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DeleteTags>`_
        ...
        **Request Syntax**
        ...
        :param Tags:
          ...
          not delete AWS-generated tags (tags that have the ``aws:`` prefix).
    ...
    def describe_attribute(
        ...
        """
        Describes the specified attribute of the specified instance. You can specify only one attribute at
        a time. Valid attribute values are: ``instanceType`` | ``kernel`` | ``ramdisk`` | ``userData`` |
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeInstanceAttribute>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **DisableApiTermination** *(dict) --*
              ...
              If the value is ``true`` , you can't terminate the instance through the Amazon EC2 console,
            ...
            - **SourceDestCheck** *(dict) --*
              ...
              Indicates whether source/destination checking is enabled. A value of ``true`` means that
    ...
    def detach_classic_link_vpc(
        ...
        the VPC security groups are no longer associated with it. An instance is automatically unlinked
        from a VPC when it's stopped.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DetachClassicLinkVpc>`_
    ...
    def detach_volume(
        ...
        your operating system before detaching the volume. Failure to do so can result in the volume
        becoming stuck in the ``busy`` state while detaching. If this happens, detachment can be delayed
        indefinitely until you unmount the volume, force detachment, reboot the instance, or all three. If
        an EBS volume is the root device of an instance, it can't be detached while the instance is
        ...
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-detaching-volume.html>`__ in the *Amazon
        Elastic Compute Cloud User Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DetachVolume>`_
    ...
    def modify_attribute(
         ...
         **Note:** Using this action to change the security groups associated with an elastic network
         interface (ENI) attached to an instance in a VPC can result in an error if the instance has more
         than one ENI. To change the security groups associated with an ENI attached to an instance that
         has multiple ENIs, we recommend that you use the  ModifyNetworkInterfaceAttribute action.

        To modify some attributes, the instance must be stopped. For more information, see `Modifying
        Attributes of a Stopped Instance
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Using_ChangingAttributesWhileInstanceStopped.html>`__
        in the *Amazon Elastic Compute Cloud User Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/ModifyInstanceAttribute>`_
        ...
        **Request Syntax**
        ...
        :param SourceDestCheck:
          ...
          Specifies whether source/destination checking is enabled. A value of ``true`` means that checking
          is enabled, and ``false`` means that checking is disabled. This value must be ``false`` for a NAT
        ...
        :param BlockDeviceMappings:
          ...
          To add instance store volumes to an Amazon EBS-backed instance, you must add them when you launch
          the instance. For more information, see `Updating the Block Device Mapping when Launching an
          Instance
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/block-device-mapping-concepts.html#Using_OverridingAMIBDM>`__
          in the *Amazon Elastic Compute Cloud User Guide* .
        ...
        :param Groups:
          ...
          group, even if it's just the default security group for the VPC. You must specify the security
        ...
        :param InstanceType:
          ...
          Changes the instance type to the specified value. For more information, see `Instance Types
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-types.html>`__ . If the instance
        ...
        :param Kernel:
          ...
          of kernels and RAM disks. For more information, see `PV-GRUB
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/UserProvidedKernels.html>`__ .
        ...
        :param Ramdisk:
          ...
          Changes the instance's RAM disk to the specified value. We recommend that you use PV-GRUB instead
          of kernels and RAM disks. For more information, see `PV-GRUB
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/UserProvidedKernels.html>`__ .
        ...
        :param UserData:
          ...
          Changes the instance's user data to the specified value. If you are using an AWS SDK or command
    ...
    def password_data(self, DryRun: bool = None) -> InstancePasswordDataResponseTypeDef:
        ...
        (Windows Server 2016 and later). This usually only happens the first time an instance is launched.
        For more information, see `EC2Config
        <https://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/UsingConfig_WinAMI.html>`__ and `EC2Launch
        <https://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/ec2launch.html>`__ in the Amazon Elastic
        Compute Cloud User Guide.
        ...
        When you launch an instance, password generation and encryption may take a few minutes. If you try
        to retrieve the password before it's available, the output returns an empty string. We recommend
        that you wait up to 15 minutes after launching an instance before trying to retrieve the generated
        password.
    ...
    def report_status(
        ...
        """
        Submits feedback about the status of an instance. The instance must be in the ``running`` state. If
        your experience with the instance differs from the instance status returned by
        DescribeInstanceStatus , use  ReportInstanceStatus to report your experience with the instance.
        Amazon EC2 collects this information to improve the accuracy of status checks.

        Use of this action does not change the value returned by  DescribeInstanceStatus .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/ReportInstanceStatus>`_
        ...
        **Request Syntax**
        ::
          ...
          response = instance.report_status(
              ...
              ReasonCodes=[
                  'instance-stuck-in-state'|'unresponsive'|'not-accepting-credentials'
    ...
    def reset_attribute(self, Attribute: str, DryRun: bool = None) -> None:
        ...
        default value is ``true`` , which means checking is enabled. This value must be ``false`` for a NAT
        instance to perform NAT. For more information, see `NAT Instances
        <https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_NAT_Instance.html>`__ in the *Amazon
        Virtual Private Cloud User Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/ResetInstanceAttribute>`_
    ...
    def wait_until_exists(
        ...
        """
        Waits until this Instance is exists. This method calls :py:meth:`EC2.Waiter.instance_exists.wait`
        which polls. :py:meth:`EC2.Client.describe_instances` every 5 seconds until a successful state is
    ...
    def wait_until_running(
        ...
        """
        Waits until this Instance is running. This method calls :py:meth:`EC2.Waiter.instance_running.wait`
        which polls. :py:meth:`EC2.Client.describe_instances` every 15 seconds until a successful state is
        reached. An error is returned after 40 failed checks.
    ...
    def wait_until_stopped(
        ...
        """
        Waits until this Instance is stopped. This method calls :py:meth:`EC2.Waiter.instance_stopped.wait`
        which polls. :py:meth:`EC2.Client.describe_instances` every 15 seconds until a successful state is
        reached. An error is returned after 40 failed checks.
    ...
    def wait_until_terminated(
        ...
        """
        Waits until this Instance is terminated. This method calls
        :py:meth:`EC2.Waiter.instance_terminated.wait` which polls.
        :py:meth:`EC2.Client.describe_instances` every 15 seconds until a successful state is reached. An
...
class InternetGateway(Boto3ServiceResource):
    ...
    def attach_to_vpc(self, VpcId: str, DryRun: bool = None) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/AttachInternetGateway>`_
    ...
    def delete(self, DryRun: bool = None) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DeleteInternetGateway>`_
    ...
    def detach_from_vpc(self, VpcId: str, DryRun: bool = None) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DetachInternetGateway>`_
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        ...
        InternetGateway resource. Note that the load and reload methods are the same method and can be used
        interchangeably.
...
class KeyPair(Boto3ServiceResource):
    ...
    def delete(self, DryRun: bool = None) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DeleteKeyPair>`_
...
class NetworkAcl(Boto3ServiceResource):
    ...
    def create_entry(
        ...
        a packet should be allowed in or out of a subnet associated with the ACL, we process the entries in
        the ACL according to the rule numbers, in ascending order. Each network ACL has a set of ingress
        ...
        not number them one right after the other (for example, 101, 102, 103, ...). This makes it easier
        to add a rule between existing ones without having to renumber the rules.

        After you add an entry, you can't modify it; you must either replace it, or create an entry and
        delete the old one.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/CreateNetworkAclEntry>`_
        ...
        **Request Syntax**
        ...
        :param Protocol: **[REQUIRED]**
          ...
          (ICMPv6) and specify an IPv4 CIDR block, traffic for all ICMP types and codes allowed, regardless
          of any that you specify. If you specify protocol "58" (ICMPv6) and specify an IPv6 CIDR block,
    ...
    def delete(self, DryRun: bool = None) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DeleteNetworkAcl>`_
    ...
    def delete_entry(self, Egress: bool, RuleNumber: int, DryRun: bool = None) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DeleteNetworkAclEntry>`_
    ...
    def replace_association(
        ...
        automatically associated with the default network ACL. For more information, see `Network ACLs
        <https://docs.aws.amazon.com/vpc/latest/userguide/VPC_ACLs.html>`__ in the *Amazon Virtual Private
        Cloud User Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/ReplaceNetworkAclAssociation>`_
    ...
    def replace_entry(
        ...
        """
        Replaces an entry (rule) in a network ACL. For more information, see `Network ACLs
        <https://docs.aws.amazon.com/vpc/latest/userguide/VPC_ACLs.html>`__ in the *Amazon Virtual Private
        Cloud User Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/ReplaceNetworkAclEntry>`_
...
class NetworkInterface(Boto3ServiceResource):
    ...
    def assign_private_ip_addresses(
        ...
        You can specify one or more specific secondary IP addresses, or you can specify the number of
        secondary IP addresses to be automatically assigned within the subnet's CIDR block range. The
        ...
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-types.html>`__ in the *Amazon Elastic
        Compute Cloud User Guide* . For more information about Elastic IP addresses, see `Elastic IP
        Addresses <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/elastic-ip-addresses-eip.html>`__ in
        the *Amazon Elastic Compute Cloud User Guide* .
        ...
        interface to another, check ``network/interfaces/macs/mac/local-ipv4s`` in the instance metadata to
        confirm that the remapping is complete.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/AssignPrivateIpAddresses>`_
    ...
    def attach(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/AttachNetworkInterface>`_
    ...
    def delete(self, DryRun: bool = None) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DeleteNetworkInterface>`_
    ...
    def describe_attribute(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeNetworkInterfaceAttribute>`_
    ...
    def detach(self, DryRun: bool = None, Force: bool = None) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DetachNetworkInterface>`_
        ...
        :param Force:
          ...
          .. note::
            ...
            * If you force the detachment of a network interface, the `instance metadata
            <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-metadata.html>`__ might not
            get updated. This means that the attributes associated with the detached network interface
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        ...
        NetworkInterface resource. Note that the load and reload methods are the same method and can be
    ...
    def modify_attribute(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/ModifyNetworkInterfaceAttribute>`_
        ...
        **Request Syntax**
        ...
        :param Groups:
          ...
          the current set. You must specify at least one group, even if it's just the default security
    ...
    def reset_attribute(self, DryRun: bool = None, SourceDestCheck: str = None) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/ResetNetworkInterfaceAttribute>`_
    ...
    def unassign_private_ip_addresses(self, PrivateIpAddresses: List[Any]) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/UnassignPrivateIpAddresses>`_
...
class NetworkInterfaceAssociation(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        """
        Calls :py:meth:`EC2.Client.describe_network_interfaces` to update the attributes of the
        NetworkInterfaceAssociation resource. Note that the load and reload methods are the same method and
...
class PlacementGroup(Boto3ServiceResource):
    ...
    def delete(self, DryRun: bool = None) -> None:
        ...
        before you can delete the placement group. For more information, see `Placement Groups
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/placement-groups.html>`__ in the *Amazon
        Elastic Compute Cloud User Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DeletePlacementGroup>`_
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        ...
        PlacementGroup resource. Note that the load and reload methods are the same method and can be used
        interchangeably.
...
class Route(Boto3ServiceResource):
    ...
    def delete(self, DestinationIpv6CidrBlock: str = None, DryRun: bool = None) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DeleteRoute>`_
    ...
    def replace(
        ...
        following: internet gateway or virtual private gateway, NAT instance, NAT gateway, VPC peering
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/ReplaceRoute>`_
        ...
        **Request Syntax**
        ...
        :param DestinationIpv6CidrBlock:
          ...
          The IPv6 CIDR address block used for the destination match. The value that you provide must match
...
class RouteTable(Boto3ServiceResource):
    ...
    def associate_with_subnet(
        ...
        route table. The action returns an association ID, which you need in order to disassociate the
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/AssociateRouteTable>`_
    ...
    def create_route(
        ...
        traffic is destined for the IPv4 address ``192.0.2.3`` , and the route table includes the following
        two IPv4 routes:
        ...
        * ``192.0.2.0/28`` (goes to some target B)
        ...
        covers a smaller number of IP addresses and is therefore more specific, so we use that route to
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/CreateRoute>`_
    ...
    def delete(self, DryRun: bool = None) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DeleteRouteTable>`_
...
class RouteTableAssociation(Boto3ServiceResource):
    ...
    def replace_subnet(
        ...
        subnet uses the routes in the new route table it's associated with. For more information about
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/ReplaceRouteTableAssociation>`_
...
class SecurityGroup(Boto3ServiceResource):
    ...
    def authorize_egress(
        ...
        ranges, or to the instances associated with the specified destination security groups.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/AuthorizeSecurityGroupEgress>`_
        ...
        :param IpPermissions:
          ...
          - *(dict) --*
            ...
            - **IpProtocol** *(string) --*
              ...
              optional; if you omit the port range, traffic for all types and codes is allowed.
            ...
            - **IpRanges** *(list) --*
              ...
              - *(dict) --*
                ...
                - **CidrIp** *(string) --*
                  ...
                  The IPv4 CIDR range. You can either specify a CIDR range or a source security group, not
            ...
            - **Ipv6Ranges** *(list) --*
              ...
              - *(dict) --*
                ...
                - **CidrIpv6** *(string) --*
                  ...
                  The IPv6 CIDR range. You can either specify a CIDR range or a source security group, not
            ...
            - **PrefixListIds** *(list) --*
              ...
              service to access through a VPC endpoint from instances associated with the security group.
            ...
            - **UserIdGroupPairs** *(list) --*
              ...
              - *(dict) --*
                ...
                - **GroupName** *(string) --*
                  ...
                  The name of the security group. In a request, use this parameter for a security group in
                  EC2-Classic or a default VPC only. For a security group in a nondefault VPC, use the
                  security group ID.
    ...
    def authorize_ingress(
        ...
        ranges, or from the instances associated with the specified destination security groups.

        You specify a protocol for each rule (for example, TCP). For TCP and UDP, you must also specify the
        destination port or port range. For ICMP/ICMPv6, you must also specify the ICMP/ICMPv6 type and
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/AuthorizeSecurityGroupIngress>`_
        ...
        **Request Syntax**
        ...
        :param CidrIp:
          ...
          Alternatively, use a set of IP permissions to specify multiple rules and a description for the
          rule.
        ...
        :param FromPort:
          ...
          number, use ``-1`` to specify all types. If you specify all ICMP types, you must specify all
          codes.
        ...
        :param GroupName:
          ...
          [EC2-Classic, default VPC] The name of the security group. You must specify either the security
        ...
        :param IpProtocol:
          ...
          <http://www.iana.org/assignments/protocol-numbers/protocol-numbers.xhtml>`__ ). To specify
          ``icmpv6`` , use a set of IP permissions.

          [VPC only] Use ``-1`` to specify all protocols. If you specify ``-1`` or a protocol other than
          ``tcp`` , ``udp`` , or ``icmp`` , traffic on all ports is allowed, regardless of any ports you
          specify.
        ...
        :param SourceSecurityGroupName:
          ...
          the port range, the IP protocol, and the end of the port range. Creates rules that grant full
          ICMP, UDP, and TCP access. To create a rule with a specific IP protocol and port range, use a set
          of IP permissions instead. For EC2-VPC, the source security group must be in the same VPC.

        :type SourceSecurityGroupOwnerId: string
        :param SourceSecurityGroupOwnerId:

          [nondefault VPC] The AWS account ID for the source security group, if the source security group
          is in a different account. You can't specify this parameter in combination with the following
          parameters: the CIDR IP address range, the IP protocol, the start of the port range, and the end
          of the port range. Creates rules that grant full ICMP, UDP, and TCP access. To create a rule with
          a specific IP protocol and port range, use a set of IP permissions instead.

        :type ToPort: integer
        :param ToPort:

          The end of port range for the TCP and UDP protocols, or an ICMP code number. For the ICMP code
          number, use ``-1`` to specify all codes. If you specify all ICMP types, you must specify all
          codes.
    ...
    def delete(self, GroupName: str = None, DryRun: bool = None) -> None:
        ...
        another security group, the operation fails with ``InvalidGroup.InUse`` in EC2-Classic or
        ``DependencyViolation`` in EC2-VPC.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DeleteSecurityGroup>`_
    ...
    def revoke_egress(
        ...
        doesn't apply to security groups for use in EC2-Classic. To remove a rule, the values that you
        specify (for example, ports) must match the existing rule's values exactly.

        Each rule consists of the protocol and the IPv4 or IPv6 CIDR range or source security group. For
        the TCP and UDP protocols, you must also specify the destination port or range of ports. For the
        ICMP protocol, you must also specify the ICMP type and code. If the security group rule has a
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/RevokeSecurityGroupEgress>`_
    ...
    def revoke_ingress(
        ...
        """
        Removes the specified ingress rules from a security group. To remove a rule, the values that you
        specify (for example, ports) must match the existing rule's values exactly.

        .. note::

          [EC2-Classic only] If the values you specify do not match the existing rule's values, no error is
          returned. Use  DescribeSecurityGroups to verify that the rule has been removed.

        Each rule consists of the protocol and the CIDR range or source security group. For the TCP and UDP
        protocols, you must also specify the destination port or range of ports. For the ICMP protocol, you
        must also specify the ICMP type and code. If the security group rule has a description, you do not
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/RevokeSecurityGroupIngress>`_
        ...
        **Request Syntax**
        ...
        :param IpPermissions:
          ...
          The sets of IP permissions. You can't specify a source security group and a CIDR IP address range
        ...
        :param IpProtocol:
          ...
          The IP protocol name (``tcp`` , ``udp`` , ``icmp`` ) or number (see `Protocol Numbers
          <http://www.iana.org/assignments/protocol-numbers/protocol-numbers.xhtml>`__ ). Use ``-1`` to
          specify all.
        ...
        :param SourceSecurityGroupOwnerId:
          ...
          a different account. You can't specify this parameter in combination with the following
          parameters: the CIDR IP address range, the IP protocol, the start of the port range, and the end
          of the port range. To revoke a specific rule for an IP protocol and port range, use a set of IP
          permissions instead.
        ...
        :param ToPort:
          ...
          The end of port range for the TCP and UDP protocols, or an ICMP code number. For the ICMP code
          number, use ``-1`` to specify all ICMP codes for the ICMP type.
...
class Snapshot(Boto3ServiceResource):
    ...
    def copy(
        ...
        snapshot copies use the default AWS Key Management Service (AWS KMS) customer master key (CMK);
        however, you can specify a different CMK.

        To copy an encrypted snapshot that has been shared from another account, you must have permissions
        for the CMK used to encrypt the snapshot.

        Snapshots created by copying another snapshot have an arbitrary volume ID that should not be used
        for any purpose.

        For more information, see `Copying an Amazon EBS Snapshot
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-copy-snapshot.html>`__ in the *Amazon
        Elastic Compute Cloud User Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/CopySnapshot>`_
        ...
        **Request Syntax**
        ...
        :param DestinationRegion:
          ...
          example, ``ec2.us-east-1.amazonaws.com`` ). With the AWS CLI, this is specified using the
        ...
        :param Encrypted:
          ...
          encryption using this parameter. Otherwise, omit this parameter. Encrypted snapshots are
          encrypted, even if you omit this parameter and encryption by default is not enabled. You cannot
          set this parameter to false. For more information, see `Amazon EBS Encryption
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSEncryption.html>`__ in the *Amazon
          Elastic Compute Cloud User Guide* .
        ...
        :param PresignedUrl:
          ...
          `Query Requests <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/Query-Requests.html>`__ .
          ...
          ``PresignedUrl`` must be signed using AWS Signature Version 4. Because EBS snapshots are stored
          in Amazon S3, the signing algorithm for this parameter uses the same logic that is described in
          `Authenticating Requests by Using Query Parameters (AWS Signature Version 4)
          <https://docs.aws.amazon.com/AmazonS3/latest/API/sigv4-query-string-auth.html>`__ in the *Amazon
          Simple Storage Service API Reference* . An invalid or improperly signed ``PresignedUrl`` will
          cause the copy operation to fail asynchronously, and the snapshot will move to an ``error`` state.
    ...
    def delete(self, DryRun: bool = None) -> None:
        ...
        the device that have changed since your last snapshot are saved in the new snapshot. When you
        delete a snapshot, only the data not needed for any other snapshot is removed. So regardless of
        which prior snapshots have been deleted, all active snapshots will have access to all the
        ...
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-deleting-snapshot.html>`__ in the *Amazon
        Elastic Compute Cloud User Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DeleteSnapshot>`_
    ...
    def describe_attribute(
        ...
        """
        Describes the specified attribute of the specified snapshot. You can specify only one attribute at
        a time.

        For more information about EBS snapshots, see `Amazon EBS Snapshots
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSSnapshots.html>`__ in the *Amazon Elastic
        Compute Cloud User Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeSnapshotAttribute>`_
    ...
    def modify_attribute(
        ...
        account IDs from a snapshot's list of create volume permissions, but you cannot do both in a single
        operation. If you need to both add and remove account IDs for a snapshot, you must use multiple
        operations. You can make up to 500 modifications to a snapshot in a single operation.

        Encrypted snapshots and snapshots with AWS Marketplace product codes cannot be made public.
        Snapshots encrypted with your default CMK cannot be shared with other accounts.

        For more information about modifying snapshot permissions, see `Sharing Snapshots
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-modifying-snapshot-permissions.html>`__ in
        the *Amazon Elastic Compute Cloud User Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/ModifySnapshotAttribute>`_
    ...
    def reset_attribute(self, Attribute: str, DryRun: bool = None) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/ResetSnapshotAttribute>`_
    ...
    def wait_until_completed(
        ...
        """
        Waits until this Snapshot is completed. This method calls
        :py:meth:`EC2.Waiter.snapshot_completed.wait` which polls. :py:meth:`EC2.Client.describe_snapshots`
...
class Subnet(Boto3ServiceResource):
    ...
    def delete(self, DryRun: bool = None) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DeleteSubnet>`_
...
class Volume(Boto3ServiceResource):
    ...
    def delete(self, DryRun: bool = None) -> None:
        ...
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-deleting-volume.html>`__ in the *Amazon
        Elastic Compute Cloud User Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DeleteVolume>`_
    ...
    def describe_attribute(
        ...
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSVolumes.html>`__ in the *Amazon Elastic
        Compute Cloud User Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeVolumeAttribute>`_
    ...
    def describe_status(
         ...
         *Status* : Reflects the current status of the volume. The possible values are ``ok`` ,
         ...
         ``insufficient-data`` , then the checks may still be taking place on your volume at the time. We
         recommend that you retry the request. For more information about volume status, see `Monitoring
         the Status of Your Volumes
         <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/monitoring-volume-status.html>`__ in the
         *Amazon Elastic Compute Cloud User Guide* .

         *Events* : Reflect the cause of a volume status and may require you to take action. For example,
         if your volume returns an ``impaired`` status, then the volume event might be
         ``potential-data-inconsistency`` . This means that your volume has been affected by an issue with
         the underlying host, has all I/O operations disabled, and may have inconsistent data.

         *Actions* : Reflect the actions you may have to take in response to an event. For example, if the
         status of the volume is ``impaired`` and the volume event shows ``potential-data-inconsistency`` ,
         then the action shows ``enable-volume-io`` . This means that you may want to enable the I/O
         operations for the volume by calling the  EnableVolumeIO action and then check the volume for data
         consistency.
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          If this parameter is not used, then ``DescribeVolumeStatus`` returns all results. You cannot
          specify this parameter and the volume IDs parameter in the same request.

        :type NextToken: string
        :param NextToken:

          The ``NextToken`` value to include in a future ``DescribeVolumeStatus`` request. When the results
          of the request exceed ``MaxResults`` , this value can be used to retrieve the next page of
    ...
    def enable_io(self, DryRun: bool = None) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/EnableVolumeIO>`_
    ...
    def modify_attribute(
        ...
        determined to be potentially inconsistent, to prevent undetectable, latent data corruption. The I/O
        access to the volume can be resumed by first enabling I/O access and then checking the data
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/ModifyVolumeAttribute>`_
...
class Vpc(Boto3ServiceResource):
    ...
    def delete(self, DryRun: bool = None) -> None:
        ...
        VPC, delete all security groups associated with the VPC (except the default one), delete all route
        tables associated with the VPC (except the default one), and so on.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DeleteVpc>`_
    ...
    def describe_attribute(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeVpcAttribute>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **EnableDnsSupport** *(dict) --*
              ...
              Indicates whether DNS resolution is enabled for the VPC. If this attribute is ``true`` , the
              Amazon DNS server resolves DNS hostnames for your instances to their corresponding IP
    ...
    def disable_classic_link(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DisableVpcClassicLink>`_
    ...
    def enable_classic_link(
        ...
        VPC to allow communication over private IP addresses. You cannot enable your VPC for ClassicLink if
        any of your VPC route tables have existing routes for address ranges within the ``10.0.0.0/8`` IP
        address range, excluding local routes for VPCs in the ``10.0.0.0/16`` and ``10.1.0.0/16`` IP
        address ranges. For more information, see `ClassicLink
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/vpc-classiclink.html>`__ in the *Amazon
        Elastic Compute Cloud User Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/EnableVpcClassicLink>`_
    ...
    def modify_attribute(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/ModifyVpcAttribute>`_
    ...
    def wait_until_available(
        ...
        """
        Waits until this Vpc is available. This method calls :py:meth:`EC2.Waiter.vpc_available.wait` which
    ...
    def wait_until_exists(
        ...
        """
        Waits until this Vpc is exists. This method calls :py:meth:`EC2.Waiter.vpc_exists.wait` which
...
class VpcPeeringConnection(Boto3ServiceResource):
    ...
    def accept(self, DryRun: bool = None) -> VpcPeeringConnectionAcceptResponseTypeDef:
        ...
        the ``pending-acceptance`` state, and you must be the owner of the peer VPC. Use
        DescribeVpcPeeringConnections to view your outstanding VPC peering connection requests.

        For an inter-Region VPC peering connection request, you must accept the VPC peering connection in
        the Region of the accepter VPC.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/AcceptVpcPeeringConnection>`_
              ...
              - **AccepterVpcInfo** *(dict) --*
                ...
                - **PeeringOptions** *(dict) --*
                  ...
                  - **AllowEgressFromLocalClassicLinkToRemoteVpc** *(boolean) --*
                    ...
                    Indicates whether a local ClassicLink connection can communicate with the peer VPC over
                    the VPC peering connection.

                  - **AllowEgressFromLocalVpcToRemoteClassicLink** *(boolean) --*

                    Indicates whether a local VPC can communicate with a ClassicLink connection in the peer
    ...
    def delete(self, DryRun: bool = None) -> VpcPeeringConnectionDeleteResponseTypeDef:
        ...
        accepter VPC can delete the VPC peering connection if it's in the ``active`` state. The owner of
        the requester VPC can delete a VPC peering connection in the ``pending-acceptance`` state. You
        cannot delete a VPC peering connection that's in the ``failed`` state.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DeleteVpcPeeringConnection>`_
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        ...
        VpcPeeringConnection resource. Note that the load and reload methods are the same method and can be
        used interchangeably.
    ...
    def reject(self, DryRun: bool = None) -> VpcPeeringConnectionRejectResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/RejectVpcPeeringConnection>`_
    ...
    def wait_until_exists(
        ...
        """
        Waits until this VpcPeeringConnection is exists. This method calls
        :py:meth:`EC2.Waiter.vpc_peering_connection_exists.wait` which polls.
        :py:meth:`EC2.Client.describe_vpc_peering_connections` every 15 seconds until a successful state is
        reached. An error is returned after 40 failed checks.
...
class classic_addresses(ResourceCollection):
    ...
    def filter(
        ...
        """
        Creates an iterable of all ClassicAddress resources in the collection filtered by kwargs passed to
        method.
...
class dhcp_options_sets(ResourceCollection):
    ...
    def filter(
        ...
        """
        Creates an iterable of all DhcpOptions resources in the collection filtered by kwargs passed to
        method.
...
class key_pairs(ResourceCollection):
    ...
    def filter(
        ...
        """
        Creates an iterable of all KeyPairInfo resources in the collection filtered by kwargs passed to
        method.
...
class placement_groups(ResourceCollection):
    ...
    def all(self) -> List[service_resource_scope.PlacementGroup]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribePlacementGroups>`_
    ...
    def filter(
        ...
        """
        Creates an iterable of all PlacementGroup resources in the collection filtered by kwargs passed to
        method.
...
class vpc_peering_connections(ResourceCollection):
    ...
    def filter(
        ...
        """
        Creates an iterable of all VpcPeeringConnection resources in the collection filtered by kwargs
        passed to method.
    ...
    def page_size(
        ...
        """
        Creates an iterable of all VpcPeeringConnection resources in the collection, but limits the number
