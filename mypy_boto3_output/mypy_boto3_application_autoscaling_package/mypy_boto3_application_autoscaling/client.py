...
class Client(BaseClient):
    ...
    def describe_scalable_targets(
        ...
        **Request Syntax**
        ...
        :param ScalableDimension:
          ...
          The scalable dimension associated with the scalable target. This string consists of the service
          namespace, resource type, and scaling property. If you specify a scalable dimension, you must
    ...
    def put_scaling_policy(
        ...
        However, there is a chance that multiple policies could conflict, instructing the scalable target
        to scale out or in at the same time. Application Auto Scaling gives precedence to the policy that
    ...
    def register_scalable_target(
        ...
        **Request Syntax**
        ...
        :param RoleARN:
          ...
          For Amazon EMR, this parameter is required, and it must specify the ARN of an IAM role that
