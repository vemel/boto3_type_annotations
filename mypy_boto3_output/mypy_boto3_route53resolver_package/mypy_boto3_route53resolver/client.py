...
class Client(BaseClient):
    ...
    def create_resolver_endpoint(
        ...
        **Request Syntax**
        ...
        :param IpAddresses: **[REQUIRED]**
          ...
          The subnets and IP addresses in your VPC that you want DNS queries to pass through on the way
          from your VPCs to your network (for outbound endpoints) or on the way from your network to your
    ...
    def get_resolver_rule(
        ...
        """
        Gets information about a specified resolver rule, such as the domain name that the rule forwards
        DNS queries for and the ID of the outbound resolver endpoint that the rule is associated with.
    ...
    def put_resolver_rule_policy(
        ...
        **Request Syntax**
        ...
        :param ResolverRulePolicy: **[REQUIRED]**
          ...
          An AWS Identity and Access Management policy statement that lists the permissions that you want
          to grant to another AWS account.
    ...
    def tag_resource(
        ...
        **Request Syntax**
        ...
        :param ResourceArn: **[REQUIRED]**
          ...
          The Amazon Resource Name (ARN) for the resource that you want to add tags to. To get the ARN for
