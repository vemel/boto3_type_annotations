    ...
    def create_project(
        ...
        **Request Syntax**
        ...
        :param sourceCode:
          ...
          A list of the Code objects submitted with the project request. If this parameter is specified,
          the request must also include the toolchain parameter.
    ...
    def delete_project(
        ...
        **Request Syntax**
        ...
        :param deleteStack:
          ...
          (except for any buckets in Amazon S3) as well as deleting the project itself. Recommended for
          most use cases.
