...
class Client(BaseClient):
    ...
    def add_tags_to_resource(
        ...
        ``Condition`` statement in an AWS Identity and Access Management (IAM) policy for Amazon DocumentDB.
    ...
    def copy_db_cluster_snapshot(
        ...
        **Request Syntax**
        ...
        :param KmsKeyId:
          ...
          Resource Name (ARN), AWS KMS key identifier, or the AWS KMS key alias for the AWS KMS encryption
          key.
          ...
          for ``KmsKeyId`` , then the copy of the DB cluster snapshot is encrypted with the same AWS KMS
        ...
        :param PreSignedUrl:
          ...
          be executed in the source AWS Region that contains the encrypted DB cluster snapshot to be
          ...
          * ``SourceDBClusterSnapshotIdentifier`` - The DB cluster snapshot identifier for the encrypted DB
          ...
          the us-west-2 AWS Region, then your ``SourceDBClusterSnapshotIdentifier`` looks like the
          following example:
    ...
    def create_db_cluster(
        ...
        **Request Syntax**
        ...
        :param KmsKeyId:
          ...
          you are creating a DB cluster using the same AWS account that owns the AWS KMS encryption key
          that is used to encrypt the new DB cluster, you can use the AWS KMS key alias instead of the ARN
    ...
    def create_db_cluster_parameter_group(
        ...
        associate it with your DB cluster. For the new DB cluster parameter group and associated settings
        to take effect, you must then reboot the DB instances in the DB cluster without failover.
    ...
    def delete_db_cluster(
        ...
        """
        Deletes a previously provisioned DB cluster. When you delete a DB cluster, all automated backups
        for that DB cluster are deleted and can't be recovered. Manual DB cluster snapshots of the
    ...
    def describe_certificates(
        ...
        **Request Syntax**
        ...
        :param CertificateIdentifier:
          ...
          The user-supplied certificate identifier. If this parameter is specified, information for only
          the specified certificate is returned. If this parameter is omitted, a list of up to
    ...
    def describe_db_cluster_parameter_groups(
        ...
        parameter is specified, the list contains only the description of the specified DB cluster
        parameter group.
    ...
    def describe_db_cluster_snapshots(
        ...
        **Request Syntax**
        ...
        :param DBClusterIdentifier:
          ...
          be used with the ``DBClusterSnapshotIdentifier`` parameter. This parameter is not case sensitive.
        ...
        :param IncludeShared:
          ...
          AWS account has been given permission to copy or restore, and otherwise ``false`` . The default
          is ``false`` .
    ...
    def describe_db_clusters(
        ...
        **Request Syntax**
        ...
        :param DBClusterIdentifier:
          ...
          The user-provided DB cluster identifier. If this parameter is specified, information from only
    ...
    def describe_events(
        ...
        for the past 14 days. You can obtain events specific to a particular DB instance, DB security
        group, DB snapshot, or DB parameter group by providing the name as a parameter. By default, the
    ...
    def describe_pending_maintenance_actions(
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          * ``db-cluster-id`` - Accepts DB cluster identifiers and DB cluster Amazon Resource Names (ARNs).
          The results list includes only pending maintenance actions for the DB clusters identified by
          these ARNs.
    ...
    def modify_db_cluster_snapshot_attribute(
        ...
        **Request Syntax**
        ...
        :param ValuesToAdd:
          ...
          account, set it to ``all`` . Do not add the ``all`` value for any manual DB cluster snapshots
          that contain private information that you don't want to be available to all AWS accounts.
        ...
        :param ValuesToRemove:
          ...
          an AWS account whose account ID is explicitly added to the ``restore`` attribute can still copy
    ...
    def modify_db_instance(
        ...
        **Request Syntax**
        ...
        :param PreferredMaintenanceWindow:
          ...
          an outage. Changing this parameter doesn't result in an outage except in the following situation,
          and the change is asynchronously applied as soon as possible. If there are pending actions that
          cause a reboot, and the maintenance window is changed to include the current time, changing this
        ...
        :param NewDBInstanceIdentifier:
          ...
          the DB instance identifier, an instance reboot occurs immediately if you set ``Apply
    ...
    def reboot_db_instance(
        ...
        make certain changes, or if you change the DB cluster parameter group that is associated with the
    ...
    def restore_db_cluster_from_snapshot(
        ...
        **Request Syntax**
        ...
        :param KmsKeyId:
          ...
          The AWS KMS key identifier is the Amazon Resource Name (ARN) for the AWS KMS encryption key. If
          you are restoring a DB cluster with the same AWS account that owns the AWS KMS encryption key
          used to encrypt the new DB cluster, then you can use the AWS KMS key alias instead of the ARN for
          ...
          * If the DB snapshot or DB cluster snapshot in ``SnapshotIdentifier`` is encrypted, then the
          restored DB cluster is encrypted using the AWS KMS key that was used to encrypt the DB snapshot
          or the DB cluster snapshot.
