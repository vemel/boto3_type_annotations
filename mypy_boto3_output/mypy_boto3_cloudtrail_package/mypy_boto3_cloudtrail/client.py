...
class Client(BaseClient):
    ...
    def lookup_events(
        ...
        captured by CloudTrail. You can look up events that occurred in a region within the last 90 days.
        Lookup supports the following attributes:
        ...
        * User name
        ...
        .. warning::
          ...
          Events that occurred during the selected time range will not be available for lookup if
