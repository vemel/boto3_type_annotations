...
class Client(BaseClient):
    ...
    def create_server(
        ...
        **Request Syntax**
        ...
        :param IdentityProviderType:
          ...
          ``SERVICE_MANAGED`` , which allows you to store and access SFTP user credentials within the AWS
          Transfer for SFTP service. Use the ``API_GATEWAY`` value to integrate with an identity provider
          of your choosing. The ``API_GATEWAY`` setting requires you to provide an API Gateway endpoint URL
          to call for authentication using the ``IdentityProviderDetails`` parameter.
    ...
    def create_user(
        ...
        You can only create and associate users with SFTP servers that have the ``IdentityProviderType``
        set to ``SERVICE_MANAGED`` . Using parameters for ``CreateUser`` , you can specify the user name,
        set the home directory, store the user's public key, and assign the user's AWS Identity and Access
    ...
    def list_tags_for_resource(
        ...
        """
        Lists all of the tags associated with the Amazon Resource Number (ARN) you specify. The resource
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          parameter is returned in the input. You can then pass in a subsequent command to the
    ...
    def test_identity_provider(
        ...
        """
        If the ``IdentityProviderType`` of the server is ``API_Gateway`` , tests whether your API Gateway
        is set up successfully. We highly recommend that you call this operation to test your
        authentication method as soon as you create your server. By doing so, you can troubleshoot issues
        with the API Gateway integration to ensure that your users can successfully use the service.
    ...
    def untag_resource(self, Arn: str, TagKeys: List[str]) -> None:
        ...
        **Request Syntax**
        ...
        :param Arn: **[REQUIRED]**
          ...
          This is the value of the resource that will have the tag removed. An Amazon Resource Name (ARN)
          is an identifier for a specific AWS resource, such as a server, user, or role.

        :type TagKeys: list
        :param TagKeys: **[REQUIRED]**

          TagKeys are key-value pairs assigned to ARNs that can be used to group and search for resources
          by type. This metadata can be attached to resources for any purpose.
    ...
    def update_user(
        ...
        **Request Syntax**
        ...
        :param Policy:
          ...
          Access Management (IAM) role across multiple users. The policy scopes down user access to
          portions of your Amazon S3 bucket. Variables you can use inside this policy include
