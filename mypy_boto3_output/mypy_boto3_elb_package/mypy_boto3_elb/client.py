...
class Client(BaseClient):
    ...
    def create_app_cookie_stickiness_policy(
        ...
        application-generated cookie specified in the policy configuration. The load balancer only inserts
        a new stickiness cookie when the application response includes a new application cookie.
    ...
    def create_lb_cookie_stickiness_policy(
        ...
        instance for each request. When the load balancer receives a request, it first checks to see if
        this cookie is present in the request. If so, the load balancer sends the request to the
        ...
        server. The validity of the cookie is based on the cookie expiration time, which is specified in
    ...
    def create_load_balancer(
        ...
        You can add listeners, security groups, subnets, and tags when you create your load balancer, or
        you can add them later using  CreateLoadBalancerListeners ,  ApplySecurityGroupsToLoadBalancer ,
    ...
    def describe_instance_health(
        ...
        instances are specified, the call describes the state of all instances that are currently
        registered with the load balancer. If instances are specified, their state is returned even if they
        are no longer registered with the load balancer. The state of terminated instances is not returned.
    ...
    def describe_load_balancer_policies(
        ...
        If you specify a load balancer name, the action returns the descriptions of all policies created
        for the load balancer. If you specify a policy name associated with your load balancer, the action
    ...
    def register_instances_with_load_balancer(
        ...
        The instance must be a running instance in the same network as the load balancer (EC2-Classic or
        the same VPC). If you have EC2-Classic instances and a load balancer in a VPC with ClassicLink
        enabled, you can link the EC2-Classic instances to that VPC and then register the linked
    ...
    def set_load_balancer_policies_for_backend_server(
        ...
        **Request Syntax**
        ...
        :param PolicyNames: **[REQUIRED]**
          ...
          The names of the policies. If the list is empty, then all current polices are removed from the
          EC2 instance.
    ...
    def set_load_balancer_policies_of_listener(
        ...
        **Request Syntax**
        ...
        :param PolicyNames: **[REQUIRED]**
          ...
          The names of the policies. This list must include all policies to be enabled. If you omit a
          policy that is currently enabled, it is disabled. If the list is empty, all current policies are
          disabled.
