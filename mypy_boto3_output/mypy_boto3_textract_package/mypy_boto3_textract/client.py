...
class Client(BaseClient):
    ...
    def analyze_document(
        ...
        * Words and lines that are related to nearby lines and words. The related information is returned
        in two  Block objects each of type ``KEY_VALUE_SET`` : a KEY Block object and a VALUE Block object.
        For example, *Name: Ana Silva Carolina* contains a key and value. *Name:* is the key. *Ana Silva
        ...
        **Request Syntax**
        ...
        :param FeatureTypes: **[REQUIRED]**
          ...
          A list of the types of analysis to perform. Add TABLES to the list to return information about
          the tables detected in the input document. Add FORMS to return detected fields and the associated
    ...
    def detect_document_text(
        ...
        make up a line of text. The input document must be an image in JPG or PNG format.
    ...
    def get_document_analysis(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          Textract returns a pagination token in the response. You can use this pagination token to
    ...
    def get_document_text_detection(
        ...
        If so, call ``GetDocumentTextDetection`` , and pass the job identifier (``JobId`` ) from the
    ...
    def start_document_analysis(
        ...
        key and value pairs, tables, and selection elements.
         ...
         the operation. When text analysis is finished, Amazon Textract publishes a completion status to
         ...
         status value published to the Amazon SNS topic is ``SUCCEEDED`` . If so, call  GetDocumentAnalysis
         , and pass the job identifier (``JobId`` ) from the initial call to ``StartDocumentAnalysis`` .
        ...
        **Request Syntax**
        ...
        :param FeatureTypes: **[REQUIRED]**
          ...
          A list of the types of analysis to perform. Add TABLES to the list to return information about
          the tables that are detected in the input document. Add FORMS to return detected fields and the
          associated text. To perform both types of analysis, add TABLES and FORMS to ``FeatureTypes`` .
          All selectable elements (``SELECTION_ELEMENT`` ) that are detected are returned, whatever the
    ...
    def start_document_text_detection(
        ...
        and the words that make up a line of text.
         ...
         the operation. When text detection is finished, Amazon Textract publishes a completion status to
         the Amazon Simple Notification Service (Amazon SNS) topic that you specify in
         ``NotificationChannel`` . To get the results of the text detection operation, first check that the
