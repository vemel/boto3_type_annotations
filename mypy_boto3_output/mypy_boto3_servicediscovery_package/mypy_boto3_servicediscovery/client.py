...
class Client(BaseClient):
    ...
    def create_service(
        ...
        * Optionally, a health check
        ...
        After you create the service, you can submit a  RegisterInstance request, and AWS Cloud Map uses
        the values in the configuration to create the specified entities.
    ...
    def deregister_instance(
        ...
        """
        Deletes the Amazon Route 53 DNS records and health check, if any, that AWS Cloud Map created for
    ...
    def get_instances_health_status(
        ...
        **Request Syntax**
        ...
        :param Instances:
          ...
          If you omit ``Instances`` , AWS Cloud Map returns the health status for all the instances that
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          .. note::
            ...
            specified criteria but that subsequent groups of ``MaxResults`` namespaces do contain
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          .. note::
            ...
            specified criteria but that subsequent groups of ``MaxResults`` operations do contain
    ...
    def register_instance(
        ...
        **Request Syntax**
        ...
        :param InstanceId: **[REQUIRED]**
          ...
          * If you specify an existing ``InstanceId`` and ``ServiceId`` , AWS Cloud Map updates the
          existing DNS records, if any. If there's also an existing health check, AWS Cloud Map deletes the
          old health check and creates a new one.
    ...
    def update_instance_custom_health_status(
        ...
        checks, which you define using ``HealthCheckCustomConfig`` when you create a service. You can't use
        it to change the status for Route 53 health checks, which you define using ``HealthCheckConfig`` .
        ...
        **Request Syntax**
        ...
        :param ServiceId: **[REQUIRED]**
          ...
          The ID of the service that includes the configuration for the custom health check that you want
    ...
    def update_service(
        ...
        * Add, update, or delete ``HealthCheckConfig`` for a specified service
        ...
        settings in all the records and health checks that were created by using the specified service.
