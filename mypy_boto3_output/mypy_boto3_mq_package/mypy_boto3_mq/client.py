...
class Client(BaseClient):
    ...
    def create_broker(
        ...
        **Request Syntax**
        ...
        brokers, as Apache releases the versions. The automatic upgrades occur during the maintenance
        ...
        MQ passes your ID with the API action. Note: We recommend using a Universally Unique Identifier
        (UUID) for the creatorRequestId. You may omit the creatorRequestId if your application doesn't
        require idempotency.This field is autopopulated if not provided.
    ...
    def create_user(
        ...
        **Request Syntax**
        ...
        :param Password: Required. The password of the user. This value must be at least 12 characters
    ...
    def update_broker(
        ...
        **Request Syntax**
        ...
        :type EngineVersion: string
        :param EngineVersion: The version of the broker engine. For a list of supported engine versions,
        see https://docs.aws.amazon.com/amazon-mq/latest/developer-guide/broker-engine.html
    ...
    def update_user(
        ...
        **Request Syntax**
        ...
        only alphanumeric characters, dashes, periods, underscores, and tildes (- . _ ~). This value must
