...
class Client(BaseClient):
        ...
        :param Identifiers: **[REQUIRED]**
          ...
          - *(dict) --*
            ...
            - **SnapshotClusterIdentifier** *(string) --*
              ...
              required if your IAM user has a policy containing a snapshot resource element that specifies
    ...
    def copy_cluster_snapshot(
        ...
        """
        Copies the specified automated cluster snapshot to a new manual cluster snapshot. The source must
        be an automated snapshot and it must be in the available state.
            ...
            - **Cluster** *(dict) --*
              ...
              - **PendingModifiedValues** *(dict) --*
                ...
                - **EnhancedVpcRouting** *(boolean) --*
                  ...
                  more information, see `Enhanced VPC Routing
                  <https://docs.aws.amazon.com/redshift/latest/mgmt/enhanced-vpc-routing.html>`__ in the
                  Amazon Redshift Cluster Management Guide.
    ...
    def create_cluster_subnet_group(
        ...
        <https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-cluster-subnet-groups.html>`__ in
    ...
    def create_event_subscription(
        ...
        events for the objects of that type in your AWS account. If you do not specify either the
        SourceType nor the SourceIdentifier, you will be notified of events generated from all Amazon
        Redshift sources belonging to your AWS account. You must specify a source type if you specify a
        source ID.
        ...
        **Request Syntax**
        ...
        :param SourceIds:
          ...
          A list of one or more identifiers of Amazon Redshift source objects. All of the objects must be
          of the same type as was specified in the source type parameter. The event subscription will
          return only events generated by the specified objects. If not specified, then events are returned
          for all objects within the source type specified.
    ...
    def create_hsm_configuration(
        ...
        to store and use database encryption keys in a Hardware Security Module (HSM). After creating the
        HSM configuration, you can specify it as a parameter when creating a cluster. The cluster will then
    ...
    def create_snapshot_copy_grant(
        ...
        Encryption <https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-db-encryption.html>`__ in
        the *Amazon Redshift Cluster Management Guide* .
    ...
    def create_tags(
        ...
        **Request Syntax**
        ...
        :param Tags: **[REQUIRED]**
          ...
          . The ``Key`` and ``Value`` parameters are separated by a comma (,). Separate multiple tags with
          a space. For example, ``--tags "Key"="owner","Value"="admin" "Key"="environment","Value"="test"
    ...
    def delete_cluster(
        ...
        the request was received correctly. Use  DescribeClusters to monitor the status of the deletion.
        The delete operation cannot be canceled or reverted once submitted. For more information about
        ...
        to ``false`` and specify a name for *FinalClusterSnapshotIdentifier* . You can later restore this
        snapshot to resume using the cluster. If a final cluster snapshot is requested, the status of the
        cluster will be "final-snapshot" while the snapshot is being taken, then it's "deleting" once
        Amazon Redshift begins deleting the cluster.
    ...
    def delete_cluster_snapshot(
        ...
        Amazon Redshift does not delete your manual snapshots. You must delete manual snapshot explicitly
        to avoid getting charged. If other accounts are authorized to access the snapshot, you must revoke
    ...
    def describe_cluster_db_revisions(
        ...
        **Request Syntax**
        ...
        :param MaxRecords:
          ...
          response records exceeds the specified MaxRecords value, a value is returned in the ``marker``
                ...
                - **RevisionTargets** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **DatabaseRevision** *(string) --*
                      ...
                      this value in  ModifyClusterDbRevision .
    ...
    def describe_cluster_parameter_groups(
        ...
        **Request Syntax**
        ...
        :param MaxRecords:
          ...
          field of the response. You can retrieve the next set of records by retrying the command with the
        ...
        :param TagKeys:
          ...
          keys in the request, Amazon Redshift returns a response with the parameter groups that have
    ...
    def describe_cluster_security_groups(
        ...
        *Amazon Redshift Cluster Management Guide* .
        ...
        If both tag keys and values are omitted from the request, security groups are returned regardless
        of whether they have tag keys or values associated with them.
        ...
        **Request Syntax**
        ...
        :param TagKeys:
          ...
          associated with the specified key or keys. For example, suppose that you have security groups
          that are tagged with keys called ``owner`` and ``environment`` . If you specify both of these tag
          keys in the request, Amazon Redshift returns a response with the security groups that have either
    ...
    def describe_cluster_snapshots(
        ...
        **Request Syntax**
        ...
        :param SnapshotType:
          ...
          The type of snapshots for which you are requesting information. By default, snapshots of all
          types are returned.
        ...
        :param EndTime:
          ...
          is specified in ISO 8601 format. For more information about ISO 8601, go to the `ISO8601
          Wikipedia page. <http://en.wikipedia.org/wiki/ISO_8601>`__
            ...
            - **Snapshots** *(list) --*
              ...
              - *(dict) --*
                ...
                - **OwnerAccount** *(string) --*
                  ...
                  For manual snapshots, the AWS customer account used to create or copy the snapshot. For
                  automatic snapshots, the owner of the cluster. The owner can perform all snapshot
    ...
    def describe_cluster_subnet_groups(
        ...
        **Request Syntax**
        ...
        :param Marker:
          ...
          An optional parameter that specifies the starting point to return a set of response records. When
          the results of a  DescribeClusterSubnetGroups request exceed the value specified in
          ``MaxRecords`` , AWS returns a value in the ``Marker`` field of the response. You can retrieve
          the next set of response records by providing the returned marker value in the ``Marker``
          parameter and retrying the request.
        ...
        :param TagKeys:
          ...
          in the request, Amazon Redshift returns a response with the subnet groups that have either or
    ...
    def describe_cluster_tracks(
        ...
        **Request Syntax**
        ...
        :param Marker:
          ...
          Amazon Redshift returns a value in the ``Marker`` field of the response. You can retrieve the
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Marker** *(string) --*
              ...
              set of response records by providing the returned marker value in the ``Marker`` parameter
              and retrying the request.
    ...
    def describe_event_subscriptions(
        ...
        notification subscriptions that match any combination of the specified keys and values. For
        ...
        **Request Syntax**
        ...
        :param TagKeys:
          ...
          that are tagged with keys called ``owner`` and ``environment`` . If you specify both of these tag
          keys in the request, Amazon Redshift returns a response with the subscriptions that have either
          or both of these tag keys associated with them.
    ...
    def describe_events(
        ...
        """
        Returns events related to clusters, security groups, snapshots, and parameter groups for the past
        14 days. Events specific to a particular cluster, security group, snapshot or parameter group can
        be obtained by providing the name as a parameter. By default, the past hour of events are returned.
    ...
    def describe_hsm_client_certificates(
        ...
        client certificates that match any combination of the specified keys and values. For example, if
        ...
        **Request Syntax**
        ...
        :param HsmClientCertificateIdentifier:
          ...
          identifier is specified, information is returned for all HSM client certificates owned by your
    ...
    def describe_hsm_configurations(
        ...
        """
        Returns information about the specified Amazon Redshift HSM configuration. If no configuration ID
        is specified, returns information about all the HSM configurations owned by your AWS customer
        account.
        ...
        If both tag keys and values are omitted from the request, HSM connections are returned regardless
        of whether they have tag keys or values associated with them.
        ...
        **Request Syntax**
        ...
        :param TagKeys:
          ...
          associated with the specified key or keys. For example, suppose that you have HSM configurations
          that are tagged with keys called ``owner`` and ``environment`` . If you specify both of these tag
          keys in the request, Amazon Redshift returns a response with the HSM configurations that have
          either or both of these tag keys associated with them.
        ...
        :param Filters:
          ...
          - *(dict) --*
            ...
            - **Operator** *(string) --*
              ...
              one value to evaluate for 'eq', 'lt', 'le', 'gt', and 'ge'. Provide two values to evaluate
            ...
            - **Values** *(list) --*
              ...
              values can range from 0 to 200. If filter Name is EstimatedDiskUtilizationPercent, then
              values can range from 0 to 100. For example, filter NumberOfNodes (name) GT (operator) 3
              (values).
    ...
    def describe_orderable_cluster_options(
        ...
        **Request Syntax**
        ...
        :param ClusterVersion:
          ...
          The version filter value. Specify this parameter to show only the available offerings matching
    ...
    def describe_reserved_node_offerings(
        ...
        will be reserved for you. These descriptions help you determine which reserve node offering you
        want to purchase. You then use the unique offering ID in you call to  PurchaseReservedNodeOffering
    ...
    def describe_reserved_nodes(
        ...
        **Request Syntax**
        ...
        :param Marker:
          ...
          An optional parameter that specifies the starting point to return a set of response records. When
          the results of a  DescribeReservedNodes request exceed the value specified in ``MaxRecords`` ,
          AWS returns a value in the ``Marker`` field of the response. You can retrieve the next set of
          response records by providing the returned marker value in the ``Marker`` parameter and retrying
          the request.
    ...
    def describe_snapshot_copy_grants(
        ...
        **Request Syntax**
        ...
        :param TagKeys:
          ...
          A tag key or keys for which you want to return all matching resources that are associated with
          the specified key or keys. For example, suppose that you have resources tagged with keys called
        ...
        :param TagValues:
          ...
          A tag value or values for which you want to return all matching resources that are associated
          with the specified value or values. For example, suppose that you have resources tagged with
          values called ``admin`` and ``test`` . If you specify both of these tag values in the request,
          Amazon Redshift returns a response with all resources that have either or both of these tag
    ...
    def disable_snapshot_copy(
        ...
        If your cluster and its snapshots are encrypted using a customer master key (CMK) from AWS KMS, use
         DeleteSnapshotCopyGrant to delete the grant that grants Amazon Redshift permission to the CMK in
    ...
    def get_cluster_credentials(
        ...
        <https://docs.aws.amazon.com/redshift/latest/mgmt/generating-user-credentials.html>`__ in the
        Amazon Redshift Cluster Management Guide.
    ...
    def modify_cluster(
        ...
        resizing a cluster, you must specify both the number of nodes and the node type even if one of the
        ...
        **Request Syntax**
        ...
        :param NodeType:
          ...
          The new node type of the cluster. If you specify a new node type, you must also specify the
          ...
          access permissions for the cluster are restored. You can use  DescribeResize to track the
        ...
        :param AutomatedSnapshotRetentionPeriod:
          ...
          automated snapshots that fall outside of the new retention period will be immediately deleted.
        ...
        :param PreferredMaintenanceWindow:
          ...
          current time, there must be at least 120 minutes between the current time and end of the window
        ...
        :param MaintenanceTrackName:
          ...
          next maintenance window. When the maintenance track changes, the cluster is switched to the
          latest cluster release available for the maintenance track. At this point, the maintenance track
          name is applied.
    ...
    def modify_cluster_maintenance(
        ...
        """
        Modifies the maintenance settings of a cluster. For example, you can defer a maintenance window.
        You can also update or cancel a deferment.
    ...
    def modify_cluster_snapshot(
        ...
        **Request Syntax**
        ...
        :param ManualSnapshotRetentionPeriod:
          ...
          If the manual snapshot falls outside of the new retention period, you can specify the force
          option to immediately delete the snapshot.
    ...
    def purchase_reserved_node_offering(
        ...
        DescribeReservedNodeOfferings API to obtain the available reserved node offerings. You can call
        this API by providing a specific reserved node offering and the number of nodes you want to reserve.
    ...
    def reboot_cluster(
        ...
        """
        Reboots a cluster. This action is taken as soon as possible. It results in a momentary outage to
        the cluster, during which the cluster status is set to ``rebooting`` . A cluster event is created
        when the reboot is completed. Any pending cluster modifications (see  ModifyCluster ) are applied
        at this reboot. For more information about managing clusters, go to `Amazon Redshift Clusters
        <https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-clusters.html>`__ in the *Amazon
        Redshift Cluster Management Guide* .
    ...
    def reset_cluster_parameter_group(
        ...
        source values of the parameters to "engine-default". To reset the entire parameter group specify
        the *ResetAllParameters* parameter. For parameter changes to take effect you must reboot any
        associated clusters.
    ...
    def restore_from_cluster_snapshot(
        ...
        with the same configuration as the original cluster from which the snapshot was created, except
        that the new cluster is created with the default cluster security and parameter groups. After
        Amazon Redshift creates the cluster, you can use the  ModifyCluster API to associate a different
        security group and different parameter group with the restored cluster. If you are using a DS node
        type, you can also choose to change to another DS node type of the same size during restore.
        ...
        **Request Syntax**
        ...
        :param ClusterSubnetGroupName:
          ...
          A snapshot of cluster in VPC can be restored only in VPC. Therefore, you must provide subnet
        ...
        :param MaintenanceTrackName:
          ...
          snapshot inherits the ``MaintenanceTrack`` value from the cluster. The snapshot might be on a
          different track than the cluster that was the source for the snapshot. For example, suppose that
          you take a snapshot of a cluster that is on the current track and then change the cluster to be
          on the trailing track. In this case, the snapshot and the source cluster are on different tracks.
    ...
    def restore_table_from_cluster_snapshot(
        ...
        . When you have renamed your original table, then you can pass the original name of the table as
        the ``NewTableName`` parameter value in the call to ``RestoreTableFromClusterSnapshot`` . This way,
    ...
    def revoke_cluster_security_group_ingress(
        ...
        **Request Syntax**
        ...
        :param CIDRIP:
          ...
          Routing (CIDR) block of IP addresses. If ``CIDRIP`` is specified, ``EC2SecurityGroupName`` and
