...
class Client(BaseClient):
    ...
    def create_stream(
        ...
        **Request Syntax**
        ...
        :param MediaType:
          ...
          The media type of the stream. Consumers of the stream can use this information when processing
          the stream. For more information about media types, see `Media Types
    ...
    def delete_stream(
        ...
        **Request Syntax**
        ...
        :param CurrentVersion:
          ...
          Specify the version as a safeguard to ensure that your are deleting the correct stream. To get
          the stream version, use the ``DescribeStream`` API.
    ...
    def get_data_endpoint(
        ...
        application to read from the specified stream (using the ``GetMedia`` or
        ``GetMediaForFragmentList`` operations) or write to it (using the ``PutMedia`` operation).

        .. note::

          The returned endpoint does not have the API name appended. The client needs to add the API name
    ...
    def update_data_retention(
        ...
        * If the data retention period is increased, existing data is retained for the new retention
        period. For example, if the data retention period is increased from one hour to seven hours, all
    ...
    def update_stream(
        ...
        **Request Syntax**
        ...
        :param MediaType:
          ...
          contains to the consumers of the stream. For more information about media types, see `Media Types
          <http://www.iana.org/assignments/media-types/media-types.xhtml>`__ . If you choose to specify the
