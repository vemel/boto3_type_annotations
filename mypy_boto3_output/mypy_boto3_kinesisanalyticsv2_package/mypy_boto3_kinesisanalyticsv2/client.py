...
class Client(BaseClient):
    ...
    def add_application_input_processing_configuration(
        ...
        **Request Syntax**
        ...
        :param InputId: **[REQUIRED]**
          ...
          list of the input IDs for an application using the  DescribeApplication operation.
    ...
    def add_application_reference_data_source(
        ...
        **Request Syntax**
        ...
        :param CurrentApplicationVersionId: **[REQUIRED]**
          ...
          The version of the application for which you are adding the reference data source. You can use
    ...
    def create_application(
        ...
        **Request Syntax**
        ...
        :param Tags:
          ...
          The maximum number of user-defined application tags is 50. For more information, see `Using Cost
          Allocation Tags
    ...
    def delete_application_input_processing_configuration(
        ...
        **Request Syntax**
        ...
        :param InputId: **[REQUIRED]**
          ...
          can get a list of the input IDs for an application by using the  DescribeApplication operation.
    ...
    def discover_input_schema(
        ...
        stream) or Amazon S3 object. In the response, the operation returns the inferred schema and also
    ...
    def list_applications(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          set of results. For more information about pagination, see `Using the AWS Command Line
