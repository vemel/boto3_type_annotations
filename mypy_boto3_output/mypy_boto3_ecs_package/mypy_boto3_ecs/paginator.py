    ...
    def paginate(
        ...
        **Request Syntax**
        ...
        :param effectiveSettings:
          ...
          root user or the default setting for the ``principalArn`` are returned. If ``false`` , the
    ...
    def paginate(
        ...
        **Request Syntax**
        ...
        :param cluster:
          ...
          The short name or full Amazon Resource Name (ARN) of the cluster to list attributes. If you do
    ...
    def paginate(
        ...
        **Request Syntax**
        ...
        :param status:
          ...
          results. By default, both ``ACTIVE`` and ``INACTIVE`` task definition families are listed. If
    ...
    def paginate(
        ...
        **Request Syntax**
        ...
        :param sort:
          ...
          Setting this parameter to ``DESC`` reverses the sort order on family name and revision so that
          the newest task definitions in a family are listed first.
