...
class Client(BaseClient):
    ...
    def define_index_field(
        ...
        the field exists, the new configuration replaces the old one. For more information, see
    ...
    def describe_analysis_schemes(
        ...
        text processing options for a ``text`` field. Can be limited to specific analysis schemes by name.
        By default, shows all analysis schemes and includes any pending changes to the configuration. Set
    ...
    def describe_domains(
        ...
        domains. Shows all domains by default. To get the number of searchable documents in a domain, use
        the console or submit a ``matchall`` request to your domain's search endpoint:
    ...
    def describe_index_fields(
        ...
        **Request Syntax**
        ...
        :param FieldNames:
          ...
          A list of the index fields you want to describe. If not specified, information is returned for
          all configured index fields.
    ...
    def describe_service_access_policies(
        ...
        endpoints. By default, shows the configuration with any pending changes. Set the ``Deployed``
    ...
    def describe_suggesters(
        ...
        before users finish typing their queries. Can be limited to specific suggesters by name. By
        default, shows all suggesters and includes any pending changes to the configuration. Set the
        ``Deployed`` option to ``true`` to show the active configuration and exclude pending changes. For
        more information, see `Getting Search Suggestions
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/getting-suggestions.html>`__ in the
        *Amazon CloudSearch Developer Guide* .
    ...
    def update_availability_options(
        ...
        tolerance in the event of a service disruption. Changes to the Multi-AZ option can take about half
        an hour to become active. For more information, see `Configuring Availability Options
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/configuring-availability-options.html>`__
        in the *Amazon CloudSearch Developer Guide* .
    ...
    def update_scaling_parameters(
        ...
        search instance type and replication count. Amazon CloudSearch will still automatically scale your
        domain based on the volume of data and traffic, but not below the desired instance type and
        replication count. If the Multi-AZ option is enabled, these values control the resources used per
