...
class Client(BaseClient):
    ...
    def create_device_pool(
        ...
        **Request Syntax**
        ...
        :param maxDevices:
          ...
          are available and that meet the criteria that you assign for the ``rules`` parameter. Depending
          on how many devices meet these constraints, your device pool might contain fewer devices than the
    ...
    def create_instance_profile(
        ...
        **Request Syntax**
        ...
        :param packageCleanup:
          ...
          When set to ``true`` , Device Farm will remove app packages after a test run. The default value
        ...
        :param rebootAfterUse:
          ...
          When set to ``true`` , Device Farm will reboot the instance after a test run. The default value
          is ``true`` .
    ...
    def create_remote_access_session(
        ...
        **Request Syntax**
        ...
        :param instanceArn:
          ...
          The Amazon Resource Name (ARN) of the device instance for which you want to create a remote
          access session.
    ...
    def create_upload(
        ...
        **Request Syntax**
        ...
        :param name: **[REQUIRED]**
          ...
          the file name needs to end with the ``.ipa`` extension. If uploading an Android app, the file
          name needs to end with the ``.apk`` extension. For all others, the file name must end with the
          ``.zip`` file extension.
    ...
    def get_account_settings(
        ...
        """
        Returns the number of unmetered iOS and/or unmetered Android devices that have been purchased by
        the account.
    ...
    def get_offering_status(
        ...
        available in the next period. The API returns a ``NotEligible`` error if the user is not permitted
    ...
    def list_devices(
        ...
        **Request Syntax**
        ...
        :param filters:
          ...
          Used to select a set of devices. A filter is made up of an attribute, an operator, and one or
          more values.
    ...
    def list_offerings(
        ...
        record indicates the recurring price per unit and the frequency for that offering. The API returns
        a ``NotEligible`` error if the user is not permitted to invoke the operation. Please contact
        `aws-devicefarm-support@amazon.com <mailto:aws-devicefarm-support@amazon.com>`__ if you believe
