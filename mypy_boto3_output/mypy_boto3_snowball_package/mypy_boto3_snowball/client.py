...
class Client(BaseClient):
    ...
    def create_cluster(
        ...
        separately to create the jobs for each of these nodes. The cluster does not ship until these five
        ...
        **Request Syntax**
        ...
        :param ShippingOption: **[REQUIRED]**
          ...
          * In the European Union (EU), you have access to express shipping. Typically, Snowball Edges
          shipped express are delivered in about a day. In addition, most countries in the EU have access
          to standard shipping, which typically takes less than a week, one way.
    ...
    def create_job(
        ...
        account must have the right trust policies and permissions in place to create a job for Snowball.
        If you're creating a job for a node in a cluster, you only need to provide the ``clusterId`` value;
        ...
        **Request Syntax**
        ...
        :param SnowballCapacityPreference:
          ...
          If your job is being created in one of the US regions, you have the option of specifying what
          size Snowball you'd like for this job. In all other regions, Snowballs come with 80 TB in storage
          capacity.
        ...
        :param SnowballType:
          ...
          The type of AWS Snowball device to use for this job. Currently, the only supported device type
    ...
    def list_compatible_images(
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          The maximum number of results for the list of compatible images. Currently, a Snowball Edge
    ...
    def list_jobs(
        ...
        """
        Returns an array of ``JobListEntry`` objects of the specified length. Each ``JobListEntry`` object
        contains a job's state, a job's ID, and a value that indicates whether the job is a job part, in
        the case of export jobs. Calling this API action in one of the US regions will return jobs from the
    ...
    def update_job(
        ...
        with a job. Once the job changes to a different job state, usually within 60 minutes of the job
        ...
        **Request Syntax**
        ...
        :param RoleARN:
          ...
          The new role Amazon Resource Name (ARN) that you want to associate with this job. To create a
          role ARN, use the `CreateRole
