...
class Client(BaseClient):
    ...
    def add_job_flow_steps(
        ...
        function must exit with a zero exit code and all Hadoop jobs started while the step was running
        must have completed and run successfully.
        ...
        **Request Syntax**
        ...
        :param JobFlowId: **[REQUIRED]**
          ...
          can also be obtained from  ListClusters .
    ...
    def cancel_steps(
        ...
        **Request Syntax**
        ...
        :param ClusterId:
          ...
          The ``ClusterID`` for which specified steps will be canceled. Use  RunJobFlow and  ListClusters
          to get ClusterIDs.
    ...
    def list_security_configurations(
        ...
        times, and their names. This call returns a maximum of 50 clusters per call, but returns a marker
        to track the paging of the cluster list across multiple ListSecurityConfigurations calls.
                    ...
                    'Rules': [
                        {
                            ...
                            'Trigger': {
                                'CloudWatchAlarmDefinition': {
                                    ...
                                    |'GIGA_BYTES_PER_SECOND'|'TERA_BYTES_PER_SECOND'|'BITS_PER_SECOND'
                                    |'KILO_BITS_PER_SECOND'|'MEGA_BITS_PER_SECOND'|'GIGA_BITS_PER_SECOND'
                                    |'TERA_BITS_PER_SECOND'|'COUNT_PER_SECOND',
                                    'Dimensions': [
                                        {
                                            'Key': 'string',
    ...
    def run_job_flow(
        ...
        **Request Syntax**
        ...
        :param LogUri:
          ...
          The location in Amazon S3 to write the log files of the job flow. If a value is not provided,
        ...
        :param NewSupportedProducts:
          ...
          * "mapr" with the user arguments specifying "--edition,m3" or "--edition,m5" - launch the job
        ...
        :param Configurations:
          ...
          For Amazon EMR releases 4.0 and later. The list of configurations supplied for the EMR cluster
          you are creating.
        ...
        :param ScaleDownBehavior:
          ...
          ``TERMINATE_AT_TASK_COMPLETION`` indicates that Amazon EMR blacklists and drains tasks from nodes
          before terminating the Amazon EC2 instances, regardless of the instance-hour boundary. With
          either behavior, Amazon EMR removes the least active nodes first and blocks instance termination
          if it could lead to HDFS corruption. ``TERMINATE_AT_TASK_COMPLETION`` available only in Amazon
          EMR version 4.1.0 and later, and is the default for versions of Amazon EMR earlier than 5.1.0.
        ...
        :param CustomAmiId:
          ...
          <https://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-custom-ami.html>`__ in the *Amazon
        ...
        :param RepoUpgradeOnBoot:
          ...
          the default is ``SECURITY`` , which indicates that only security updates are applied. If ``NONE``
    ...
    def set_termination_protection(
        ...
        on a cluster is similar to calling the Amazon EC2 ``DisableAPITermination`` API on all EC2
