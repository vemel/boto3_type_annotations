...
class Client(BaseClient):
    ...
    def get_backup_selection(
        ...
        """
        Returns selection metadata and a document in JSON format that specifies a list of resources that
        are associated with a backup plan.
    ...
    def tag_resource(self, ResourceArn: str, Tags: List[str]) -> None:
        ...
        **Request Syntax**
        ...
        :param Tags: **[REQUIRED]**
          ...
          Key-value pairs that are used to help organize your resources. You can assign your own metadata
          to the resources you create.
