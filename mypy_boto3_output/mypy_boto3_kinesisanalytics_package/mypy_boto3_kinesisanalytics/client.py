...
class Client(BaseClient):
    ...
    def add_application_cloud_watch_logging_option(
        ...
        Adds a CloudWatch log stream to monitor application configuration errors. For more information
        about using CloudWatch log streams with Amazon Kinesis Analytics applications, see `Working with
    ...
    def add_application_input(
        ...
        new version of the application. You can use the `DescribeApplication
    ...
    def add_application_input_processing_configuration(
        ...
        **Request Syntax**
        ...
        :param InputId: **[REQUIRED]**
          ...
          The ID of the input configuration to add the input processing configuration to. You can get a
          list of the input IDs for an application using the `DescribeApplication
          <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html>`__
          operation.
    ...
    def add_application_output(
        ...
        Firehose delivery stream, or an AWS Lambda function), you add the relevant configuration to your
    ...
    def create_application(
        ...
        streaming source as input, application code to process the input, and up to three destinations
        where you want Amazon Kinesis Analytics to write the output data from your application. For an
        ...
        in-application stream and map each data column in the in-application stream to a data element in
        ...
        **Request Syntax**
        ...
        :param Outputs:
          ...
          You can configure application output to write data from any of the in-application streams to up
          ...
          In the configuration, you specify the in-application stream name, the destination stream or
          Lambda function Amazon Resource Name (ARN), and the format to use when writing data. You must
          also provide an IAM role that Amazon Kinesis Analytics can assume to write to the destination
          stream or Lambda function on your behalf.

          In the output configuration, you also provide the output stream or Lambda function ARN. For
          stream destinations, you provide the format of data in the stream (for example, JSON, CSV). You
          also must provide an IAM role that Amazon Kinesis Analytics can assume to write to the stream or
        ...
        :param Tags:
          ...
          identifies an application. Note that the maximum number of application tags includes system tags.
    ...
    def delete_application_cloud_watch_logging_option(
        ...
        Deletes a CloudWatch log stream from an application. For more information about using CloudWatch
        log streams with Amazon Kinesis Analytics applications, see `Working with Amazon CloudWatch Logs
        <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/cloudwatch-logs.html>`__ .
    ...
    def delete_application_input_processing_configuration(
        ...
        **Request Syntax**
        ...
        :param InputId: **[REQUIRED]**
          ...
          The ID of the input configuration from which to delete the input processing configuration. You
          can get a list of the input IDs for an application by using the `DescribeApplication
          <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html>`__
          operation.
    ...
    def delete_application_output(
        ...
        **Request Syntax**
        ...
        :param OutputId: **[REQUIRED]**
          ...
          application, either when the application is created or later using the `AddApplicationOutput
    ...
    def delete_application_reference_data_source(
        ...
        table that you created using the `AddApplicationReferenceDataSource
    ...
    def describe_application(
        ...
        You can use ``DescribeApplication`` to get the current application versionId, which you need to
        call other operations such as ``Update`` .
