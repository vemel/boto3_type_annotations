"Main interface for dynamodb Client"
...
class Client(BaseClient):
    ...
    def batch_get_item(
        ...
        provisioned throughput is exceeded, or an internal processing failure occurs. If a partial result
        is returned, the operation returns a value for ``UnprocessedKeys`` . You can use this value to
        ...
        items consume the minimum read capacity units according to the type of read. For more information,
        ...
        **Request Syntax**
        ...
        :param ReturnConsumedCapacity:
          ...
          * ``INDEXES`` - The response includes the aggregate ``ConsumedCapacity`` for the operation,
          together with ``ConsumedCapacity`` for each table and secondary index that was accessed. Note
          that some operations, such as ``GetItem`` and ``BatchGetItem`` , do not access any indexes at
    ...
    def batch_write_item(
        ...
        call to ``BatchWriteItem`` can write up to 16 MB of data, which can comprise as many as 25 put or
        ...
        atomic; however ``BatchWriteItem`` as a whole is not. If any requested operations fail because the
        table's provisioned throughput is exceeded or an internal processing failure occurs, the failed
          ...
          * ``DeleteRequest`` - Perform a ``DeleteItem`` operation on the specified item. The item to be
          deleted is identified by a ``Key`` subelement:
            ...
            * ``Key`` - A map of primary key attribute values that uniquely identify the item. Each entry
            in this map consists of an attribute name and an attribute value. For each primary key, you
            must provide *all* of the key attributes. For example, with a simple primary key, you only need
            to provide a value for the partition key. For a composite primary key, you must provide values
          ...
          * ``PutRequest`` - Perform a ``PutItem`` operation on the specified item. The item to be put is
          identified by an ``Item`` subelement:
            ...
            * ``Item`` - A map of attributes and their values. Each entry in this map consists of an
            ...
            type attributes must have lengths greater than zero; and set type attributes must not be empty.
    ...
    def create_backup(
        ...
        When you create an on-demand backup, a time marker of the request is cataloged, and the backup is
        created asynchronously, by applying all changes until the time of the request to the last full
        table snapshot. Backup requests are processed instantaneously and become available for restore
        within minutes.
        ...
        If you submit a backup request on 2018-12-14 at 14:25:00, the backup is guaranteed to contain all
        data committed to the table up to 14:24:00, and data committed after 14:26:00 will not be. The
        backup might contain data modifications made between 14:24:00 and 14:26:00. On-demand backup does
        ...
        * Provisioned read and write capacity
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/CreateBackup>`_
    ...
    def create_global_table(
        ...
        * The global secondary indexes must have the same hash key and sort key (if present).
        ...
        .. warning::
          ...
          indexes. DynamoDB strongly recommends enabling auto scaling to manage the write capacity settings
          for all of your global tables replicas and indexes.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/CreateGlobalTable>`_
        ...
        **Request Syntax**
        ...
        :param KeySchema: **[REQUIRED]**
          ...
          * ``KeyType`` - The role that the key attribute will assume:
          ...
          in this order: The first element must have a ``KeyType`` of ``HASH`` , and the second element
          must have a ``KeyType`` of ``RANGE`` .
          ...
          * ``Projection`` - Specifies attributes that are copied (projected) from the table into the
          ...
          automatically projected. Each attribute specification is composed of:
            ...
            * ``NonKeyAttributes`` - A list of one or more non-key attribute names that are projected into
            ...
            into two different indexes, this counts as two distinct attributes when determining the total.
        ...
        :param SSESpecification:
          ...
          - **KMSMasterKeyId** *(string) --*
            ...
            The KMS customer master key (CMK) that should be used for the AWS KMS encryption. To specify a
            CMK, use its key ID, Amazon Resource Name (ARN), alias name, or alias ARN. Note that you should
            only provide this parameter if the key is different from the default DynamoDB customer master
    ...
    def delete_backup(self, BackupArn: str) -> ClientDeleteBackupResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/DeleteBackup>`_
    ...
    def delete_table(self, TableName: str) -> ClientDeleteTableResponseTypeDef:
        ...
        request, the specified table is in the ``DELETING`` state until DynamoDB completes the deletion. If
        the table is in the ``ACTIVE`` state, you can delete it. If a table is in ``CREATING`` or
    ...
    def describe_backup(self, BackupArn: str) -> ClientDescribeBackupResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/DescribeBackup>`_
    ...
    def describe_continuous_backups(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/DescribeContinuousBackups>`_
    ...
    def describe_endpoints(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/DescribeEndpoints>`_
    ...
    def describe_global_table(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/DescribeGlobalTable>`_
    ...
    def describe_global_table_settings(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/DescribeGlobalTableSettings>`_
    ...
    def describe_limits(
        ...
        """
        Returns the current provisioned-capacity limits for your AWS account in a Region, both for the
        Region as a whole and for any one DynamoDB table that you create there.

        When you establish an AWS account, the account has initial limits on the maximum read capacity
        units and write capacity units that you can provision across all of your DynamoDB tables in a given
        Region. Also, there are per-table limits that apply when you create a table there. For more
        information, see `Limits
        <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Limits.html>`__ page in the
        *Amazon DynamoDB Developer Guide* .

        Although you can increase these limits by filing a case at `AWS Support Center
        <https://console.aws.amazon.com/support/home#/>`__ , obtaining the increase is not instantaneous.
        The ``DescribeLimits`` action lets you write code to compare the capacity you are currently using
        to those limits imposed by your account so that you have enough time to apply for an increase
        before you hit a limit.

        For example, you could use one of the AWS SDKs to do the following:

        * Call ``DescribeLimits`` for a particular Region to obtain your current account limits on
        ...
        * Report the account limits for that Region returned by ``DescribeLimits`` , along with the total
        ...
        extremely rapidly. But the only upper limit that applies is that the aggregate provisioned capacity
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/DescribeLimits>`_
    ...
    def describe_time_to_live(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/DescribeTimeToLive>`_
    ...
    def list_backups(
        ...
        ``TableName`` . ``ListBackups`` returns a paginated list of results with at most 1 MB worth of
        items in a page. You can also specify a limit for the maximum number of entries to be returned in a
        page.

        In the request, start time is inclusive, but end time is exclusive. Note that these limits are for
        ...
        **Request Syntax**
        ...
        :param ExclusiveStartBackupArn:
           ...
           ``LastEvaluatedBackupArn`` is the Amazon Resource Name (ARN) of the backup last evaluated when
           the current page of results was returned, inclusive of the current page of results. This value
           may be specified as the ``ExclusiveStartBackupArn`` of a new ``ListBackups`` operation in order
    ...
    def list_global_tables(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/ListGlobalTables>`_
    ...
    def list_tags_of_resource(
        ...
        For an overview on tagging DynamoDB resources, see `Tagging for DynamoDB
        <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Tagging.html>`__ in the *Amazon
        DynamoDB Developer Guide* .
    ...
    def put_item(
        ...
        ExpressionAttributeNames: Dict[str, str] = None,
        ExpressionAttributeValues: Dict[
            str, ClientPutItemExpressionAttributeValuesTypeDef
        ] = None,
    ) -> ClientPutItemResponseTypeDef:
        """
        ...
        specified primary key doesn't exist), or replace an existing item if it has certain attribute
        values. You can return the item's attribute values in the same operation, using the
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ItemCollectionMetrics** *(dict) --*
              ...
              was specified. If the table does not have any local secondary indexes, this information is
    ...
    def query(
        ...
        ExpressionAttributeNames: Dict[str, str] = None,
        ExpressionAttributeValues: Dict[
            str, ClientQueryExpressionAttributeValuesTypeDef
        ] = None,
    ) -> ClientQueryResponseTypeDef:
        """
        ...
        value. You can optionally narrow the scope of the ``Query`` operation by specifying a sort key
        value and a comparison operator in ``KeyConditionExpression`` . To further refine the ``Query``
        results, you can optionally provide a ``FilterExpression`` . A ``FilterExpression`` determines
        ...
        a strongly consistent result. Global secondary indexes support eventually consistent reads only, so
        do not specify ``ConsistentRead`` when querying a global secondary index.
        ...
        **Request Syntax**
        ...
        :param Select:
          ...
          * ``ALL_ATTRIBUTES`` - Returns all of the item attributes from the specified table or index. If
          ...
          entire item from the parent table. If the index is configured to project all item attributes,
          then all of the data can be obtained from the local secondary index, and no fetching is required.
          ...
          * ``SPECIFIC_ATTRIBUTES`` - Returns only the attributes listed in ``AttributesToGet`` . This
          ...
          projected into that index, the operation will read only the index and not the table. If any of
          the requested attributes are not projected into the local secondary index, DynamoDB fetches each
          of these attributes from the parent table. This extra fetching incurs additional throughput cost
          and latency. If you query or scan a global secondary index, you can only request attributes that
          are projected into the index. Global secondary index queries cannot fetch attributes from the
          parent table.
        ...
        :param KeyConditionExpression:
          ...
          This allows ``Query`` to retrieve one item with a given partition key value and sort key value,
          ...
          * ``sortKeyName``  ``BETWEEN``  ``:sortkeyval1``  ``AND``  ``:sortkeyval2`` - true if the sort
          key value is greater than or equal to ``:sortkeyval1`` , and less than or equal to
          ``:sortkeyval2`` .
    ...
    def restore_table_from_backup(
        ...
        """
        Creates a new table from an existing backup. Any number of users can execute up to 4 concurrent
        ...
        * Time to Live (TTL) settings
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/RestoreTableFromBackup>`_
    ...
    def restore_table_to_point_in_time(
        ...
        35 days. Any number of users can execute up to 4 concurrent restores (any type of restore) in a
        given account.

        When you restore using point in time recovery, DynamoDB restores your table data to the state based
        on the selected date and time (day:hour:minute:second) to a new table.
        ...
        * Point in time recovery settings
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/RestoreTableToPointInTime>`_
    ...
    def scan(
        ...
        ExpressionAttributeNames: Dict[str, str] = None,
        ExpressionAttributeValues: Dict[
            str, ClientScanExpressionAttributeValuesTypeDef
        ] = None,
        ConsistentRead: bool = None,
    ) -> ClientScanResponseTypeDef:
        """
        ...
        the *Amazon DynamoDB Developer Guide* .
         ...
         ``Scan`` uses eventually consistent reads when accessing the data in a table; therefore, the
         result set might not include the changes to data in the table immediately before the operation
         began. If you need a consistent copy of the data, as of the time that the ``Scan`` begins, you can
    ...
    def tag_resource(self, ResourceArn: str, Tags: List[TypeDefEC2Tag]) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/TagResource>`_
    ...
    def transact_get_items(
        ...
        """
         ...
         can contain up to 25 ``TransactGetItem`` objects, each of which contains a ``Get`` structure that
         specifies an item to retrieve from a table in the account and Region. A call to
         ``TransactGetItems`` cannot retrieve items from tables in more than one AWS account or Region. The
        ...
        * The aggregate size of the items in the transaction cannot exceed 4 MB.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/TransactGetItems>`_
    ...
    def transact_write_items(
        ...
        * ``Put`` — Initiates a ``PutItem`` operation to write a new item. This structure specifies the
        primary key of the item to be written, the name of the table to write it in, an optional condition
        ...
        * There is a user error, such as an invalid data format.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/TransactWriteItems>`_
        ...
        **Request Syntax**
        ...
        :param TransactItems: **[REQUIRED]**
          ...
          different tables, but the tables must reside in the same AWS account and Region, and no two of
        ...
        :param ReturnItemCollectionMetrics:
          ...
          Determines whether item collection metrics are returned. If set to ``SIZE`` , the response
          includes statistics about item collections (if any), that were modified during the operation and
          are returned in the response. If set to ``NONE`` (the default), no statistics are returned.
    ...
    def untag_resource(self, ResourceArn: str, TagKeys: List[Any]) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/UntagResource>`_
    ...
    def update_continuous_backups(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/UpdateContinuousBackups>`_
    ...
    def update_global_table(
        ...
        able to use this operation. Any replica to be added must be empty, have the same name as the global
        table, have the same key schema, have DynamoDB Streams enabled, and have the same provisioned and
        ...
        * The global secondary indexes must have the same provisioned and maximum write capacity units.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/UpdateGlobalTable>`_
    ...
    def update_global_table_settings(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/UpdateGlobalTableSettings>`_
              ...
              - **ScalingPolicyUpdate** *(dict) --*
                ...
                - **TargetTrackingScalingPolicyConfiguration** *(dict) --* **[REQUIRED]**
                  ...
                  - **ScaleOutCooldown** *(integer) --*
                    ...
                    has been added by the previous scale out event that initiated the cooldown is
                  ...
                  - **ScalingPolicyUpdate** *(dict) --*
                    ...
                    - **TargetTrackingScalingPolicyConfiguration** *(dict) --* **[REQUIRED]**
                      ...
                      - **ScaleInCooldown** *(integer) --*
                        ...
                        policy during the cooldown period after a scale-in, application auto scaling scales
          ...
          - *(string) --*
            ...
            - *(dict) --*
              ...
              - **Action** *(string) --*
                ...
                * ``PUT`` - Adds the specified attribute to the item. If the attribute already exists, it
        ...
        :param UpdateExpression:
          ...
          * ``SET`` - Adds one or more attributes and values to an item. If any of these attributes already
          ...
          the following functions:
            ...
            * ``if_not_exists (path, operand)`` - if the item does not contain an attribute at the
            ...
            You can use this function to avoid overwriting an attribute that may already be present in the
            item.
          ...
          * ``ADD`` - Adds the specified value to the item, if the attribute does not already exist. If the
          attribute does exist, then the behavior of ``ADD`` depends on the data type of the attribute:
            ...
            * If the existing data type is a set and if ``Value`` is also a set, then ``Value`` is added to
            ...
            action specified ``[3]`` , then the final attribute value is ``[1,2,3]`` . An error occurs if
            an ``ADD`` action is specified for a set attribute and the attribute type specified does not
            match the existing set type.  Both sets must have the same primitive data type. For example, if
          ...
          * ``DELETE`` - Deletes an element from a set. If a set of values is specified, then those values
          ...
          .. warning::
             ...
             The ``DELETE`` action only supports set data types. In addition, ``DELETE`` can only be used
             on top-level attributes, not nested attributes.
    ...
    def update_time_to_live(
        ...
        .. warning::
          ...
          DynamoDB typically deletes expired items within two days of expiration. The exact duration within
          which an item gets deleted after expiration is specific to the nature of the workload. Items that
          have expired and not been deleted will still show up in reads, queries, and scans.
        ...
        <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/TTL.html>`__ in the Amazon
        DynamoDB Developer Guide.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/UpdateTimeToLive>`_
