...
class Client(BaseClient):
    ...
    def add_tags_to_resource(
        ...
        Classic FAQs <http://aws.amazon.com/cloudhsm/faqs-classic/>`__ , the `AWS CloudHSM Classic User
        Guide <http://docs.aws.amazon.com/cloudhsm/classic/userguide/>`__ , and the `AWS CloudHSM Classic
        API Reference <http://docs.aws.amazon.com/cloudhsm/classic/APIReference/>`__ .
    ...
    def create_hsm(
        ...
        .. warning::
          ...
          It can take up to 20 minutes to create and provision an HSM. You can monitor the status of the
          HSM with the  DescribeHsm operation. The HSM is ready to be initialized when the status changes
          to ``RUNNING`` .
        ...
        **Request Syntax**
        ...
        :param ClientToken:
          ...
          A user-defined token to ensure idempotence. Subsequent calls to this operation with the same
    ...
    def modify_hsm(
        ...
        .. warning::
          ...
          CloudHSM service is configured for high availability, and consider executing this operation
