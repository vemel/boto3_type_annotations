...
class Client(BaseClient):
    ...
    def add_permission(
        ...
        **Request Syntax**
        ...
        :param SourceAccount:
          ...
          account's Amazon S3 buckets). Or use it together with ``SourceArn`` to ensure that the resource
          is owned by the specified account. For example, an Amazon S3 bucket could be deleted by its owner
    ...
    def create_function(
        ...
        ``Publish`` parameter to create version ``1`` of your function from its initial configuration.
    ...
    def list_aliases(
        ...
        <https://docs.aws.amazon.com/lambda/latest/dg/versioning-aliases.html>`__ for a Lambda function.
    ...
    def list_functions(
        ...
        Set ``FunctionVersion`` to ``ALL`` to include all published versions of each function in addition
        to the unpublished version. To get more information about a function or version, use  GetFunction .
    ...
    def list_layers(
        ...
        <https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html>`__ and shows information
        about the latest version of each. Specify a `runtime identifier
    ...
    def publish_layer_version(
        ...
        <https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html>`__ from a ZIP archive.
        Each time you call ``PublishLayerVersion`` with the same version name, a new version is created.
