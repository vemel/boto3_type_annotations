...
class Client(BaseClient):
    ...
    def associate_drt_log_bucket(self, LogBucket: str) -> Dict[str, Any]:
        ...
        AWS WAF logs. You can associate up to 10 Amazon S3 buckets with your subscription.
    ...
    def create_protection(
        ...
        <https://console.aws.amazon.com/waf/>`__ . For more information see `Getting Started with AWS
        Shield Advanced
        <https://docs.aws.amazon.com/waf/latest/developerguide/getting-started-ddos.html>`__ and `Add AWS
        Shield Advanced Protection to more AWS Resources
    ...
    def create_subscription(self, *args: Any, **kwargs: Any) -> Dict[str, Any]:
        ...
        When you initally create a subscription, your subscription is set to be automatically renewed at
        the end of the existing subscription period. You can change this by submitting an
    ...
    def disassociate_drt_log_bucket(self, LogBucket: str) -> Dict[str, Any]:
        ...
        To make a ``DisassociateDRTLogBucket`` request, you must be subscribed to the `Business Support
        plan <https://aws.amazon.com/premiumsupport/business-support/>`__ or the `Enterprise Support plan
    ...
    def list_attacks(
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          That is, the number of  AttackSummary objects returned could be less than ``MaxResults`` , even
          if there are still more  AttackSummary objects yet to return. If there are more  AttackSummary
