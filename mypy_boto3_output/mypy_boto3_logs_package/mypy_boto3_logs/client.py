...
class Client(BaseClient):
    ...
    def associate_kms_key(self, logGroupName: str, kmsKeyId: str) -> None:
        ...
        CMK is still within Amazon CloudWatch Logs. This enables Amazon CloudWatch Logs to decrypt this
    ...
    def create_export_task(
        ...
        """
        Creates an export task, which allows you to efficiently export data from a log group to an Amazon
        S3 bucket.
        ...
        separate out log data for each export task, you can specify a prefix to be used as the Amazon S3
    ...
    def delete_destination(self, destinationName: str) -> None:
        ...
        publish to it. This operation does not delete the physical resource encapsulated by the destination.
    ...
    def describe_log_streams(
        ...
        **Request Syntax**
        ...
        :param orderBy:
          ...
          00:00:00 UTC. lastEventTimeStamp updates on an eventual consistency basis. It typically updates
          in less than an hour from ingestion, but may take longer in some rare situations.
    ...
    def describe_metric_filters(
        ...
        """
        Lists the specified metric filters. You can list all the metric filters or filter the results by
    ...
    def describe_queries(
        ...
        executed recently in this account. You can request all queries, or limit it to queries of a
    ...
    def filter_log_events(
        ...
        or all the events found within the time range that you specify. If the results include a token,
        then there are more log events available, and you can get additional results by specifying the
    ...
    def get_log_record(
        ...
        **Request Syntax**
        ...
        :param logRecordPointer: **[REQUIRED]**
          ...
          response of a ``GetQueryResults`` operation. In that response, the value of the ``@ptr`` field
          for a log event is the value to use as ``logRecordPointer`` to retrieve that complete log event
          record.
    ...
    def put_log_events(
        ...
        * The log events in the batch must be in chronological ordered by their timestamp. The timestamp is
        ...
        UTC. (In AWS Tools for PowerShell and the AWS SDK for .NET, the timestamp is specified in .NET
    ...
    def put_retention_policy(self, logGroupName: str, retentionInDays: int) -> None:
        ...
        **Request Syntax**
        ...
        :param retentionInDays: **[REQUIRED]**
          ...
          3, 5, 7, 14, 30, 60, 90, 120, 150, 180, 365, 400, 545, 731, 1827, and 3653.
    ...
    def put_subscription_filter(
        ...
        **Request Syntax**
        ...
        :param filterName: **[REQUIRED]**
          ...
          filter with a log group. To find the name of the filter currently associated with a log group,
