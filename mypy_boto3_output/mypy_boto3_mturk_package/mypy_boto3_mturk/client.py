...
class Client(BaseClient):
    ...
    def associate_qualification_with_worker(
        ...
        .. note::
          ...
          Qualification request made by the Worker, the granting of the request may modify the
    ...
    def create_hit(
        ...
        **Request Syntax**
        ...
        :param RequesterAnnotation:
          ...
          data to the HIT for tracking purposes. For example, this parameter could be an identifier
          ...
          The RequesterAnnotation parameter may be different for each HIT you submit. It does not affect
        ...
        :param UniqueRequestToken:
          ...
          not the call succeeded on the server. If the HIT already exists in the system from a previous
    ...
    def create_qualification_type(
        ...
        **Request Syntax**
        ...
        :param RetryDelayInSeconds:
          ...
          enabled. If you want to disable retries, you must delete existing retry-enabled Qualification
    ...
    def delete_qualification_type(self, QualificationTypeId: str) -> Dict[str, Any]:
        ...
        .. note::
          ...
          deleted before completing. It may take up to 48 hours before DeleteQualificationType completes
          and the unique name of the Qualification type is available for reuse with CreateQualificationType.
    ...
    def get_file_upload_url(
        ...
        temporary URL is generated the instant the GetFileUploadURL operation is called, and is valid for
        60 seconds. You can get a temporary file upload URL any time until the HIT is disposed. After the
        HIT is disposed, any uploaded files are deleted, and cannot be retrieved. Pending Deprecation on
    ...
    def list_assignments_for_hit(
        ...
        requested multiple assignments, and has received some results but has not yet become Reviewable,
        you can still retrieve the partial results with this operation.

        Use the AssignmentStatus parameter to control which set of assignments for a HIT are returned. The
        ListAssignmentsForHIT operation can return submitted assignments awaiting approval, or it can
        return assignments that have already been approved or rejected. You can set
    ...
    def list_qualification_types(
        ...
        **Request Syntax**
        ...
        :param MustBeRequestable: **[REQUIRED]**
          ...
          Specifies that only Qualification types that a user can request through the Amazon Mechanical
          Turk web site, such as by taking a Qualification test, are returned as results of the search.
          Some Qualification types, such as those assigned automatically by the system, cannot be requested
    ...
    def list_review_policy_results_for_hit(
        ...
        taken in the course of executing your Review Policies for a given HIT. For information about how to
        ...
        **Request Syntax**
        ...
        :param PolicyLevels:
          ...
          behavior is to retrieve all data for both policy levels. For a list of all the described
          policies, see Review Policies.
    ...
    def reject_assignment(
        ...
        Status section of the web site. When you include a feedback message with the rejection, it helps
        the Worker understand why the assignment was rejected, and can improve the quality of the results
    ...
    def send_bonus(
        ...
        **Request Syntax**
        ...
        :param BonusAmount: **[REQUIRED]**
          ...
          The Bonus amount is a US Dollar amount specified using a string (for example, "5" represents
          $5.00 USD and "101.42" represents $101.42 USD). Do not include currency symbols or currency codes.
        ...
        :param UniqueRequestToken:
          ...
          A unique identifier for this request, which allows you to retry the call on error without
          granting multiple bonuses. This is useful in cases such as network timeouts where it is unclear
          whether or not the call succeeded on the server. If the bonus already exists in the system from a
    ...
    def update_notification_settings(
        ...
        for a HIT type. If you call the UpdateNotificationSettings operation for a HIT type that already
        has a notification specification, the operation replaces the old specification with a new one. You
        can call the UpdateNotificationSettings operation to enable or disable notifications for the HIT
        type, without having to modify the notification specification itself by providing updates to the
        Active status without specifying a new notification specification. To change the Active status of a
        HIT type's notifications, the HIT type must already have a notification specification, or one must
    ...
    def update_qualification_type(
        ...
        the Name and Keywords fields cannot be modified. The RetryDelayInSeconds parameter can be modified
        or added to change the delay or to enable retries, but RetryDelayInSeconds cannot be used to
        disable retries.
        ...
        **Request Syntax**
        ...
        :param RetryDelayInSeconds:
          ...
          to disable retries for a Qualification type after it has been created with retries enabled. If
          you want to disable retries, you must dispose of the existing retry-enabled Qualification type
          using DisposeQualificationType and then create a new Qualification type with retries disabled
