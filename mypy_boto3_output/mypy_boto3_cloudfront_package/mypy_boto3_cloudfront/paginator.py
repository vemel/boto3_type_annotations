        ...
        **Request Syntax**
                  ...
                  - **OriginGroups** *(dict) --*
                    ...
                    - **Items** *(list) --*
                      ...
                      - *(dict) --*
                        ...
                        to support origin failover in CloudFront. When you create or update a distribution,
                        you can specifiy the origin group instead of a single origin, and CloudFront will
                  ...
                  - **DefaultCacheBehavior** *(dict) --*
                    ...
                    - **ForwardedValues** *(dict) --*
                      ...
                      - **QueryString** *(boolean) --*
                        ...
                        string parameters and values you have, this can adversely affect performance
        ...
        <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/RequestAndResponseBehaviorCustomOrigin.html#request-custom-headers-behavior>`__
                    ...
                    - **ViewerProtocolPolicy** *(string) --*
                      ...
                      * ``https-only`` : If a viewer sends an HTTP request, CloudFront returns an HTTP
                      ...
                      .. note::
                        ...
                        cache because cached objects are protocol agnostic. That means that an edge
                    ...
                    - **AllowedMethods** *(dict) --*
                      ...
                      * CloudFront forwards ``GET, HEAD, OPTIONS, PUT, PATCH, POST`` , and ``DELETE``
                      ...
                      bucket or to your custom origin so users can't perform operations that you don't want
                      them to. For example, you might not want users to have permissions to delete objects
                      from your origin.
                    ...
                    - **SmoothStreaming** *(boolean) --*
                      ...
                      Streaming format using the origin that is associated with this cache behavior. If so,
                      specify ``true`` ; if not, specify ``false`` . If you specify ``true`` for
                    ...
                    - **DefaultTTL** *(integer) --*
                      ...
                      add HTTP headers such as ``Cache-Control max-age`` , ``Cache-Control s-maxage`` , and
                        ...
                        - *(dict) --*
                          ...
                          - **EventType** *(string) --*
                            ...
                            * ``viewer-request`` : The function executes when CloudFront receives a request
                            from a viewer and before it checks to see whether the requested object is in
                            the edge cache.
                      ...
                      - *(dict) --*
                        ...
                        - **ForwardedValues** *(dict) --*
                          ...
                          - **Cookies** *(dict) --*
                            ...
                            the origin and, if so, which ones. For more information about forwarding
                        ...
                        - **ViewerProtocolPolicy** *(string) --*
                          ...
                          * ``https-only`` : If a viewer sends an HTTP request, CloudFront returns an HTTP
                          ...
                          .. note::
                            ...
                            that an edge location will return an object from the cache regardless of
                  ...
                  - **ViewerCertificate** *(dict) --*
                    ...
                    - **SSLSupportMethod** *(string) --*
                      ...
                      * ``sni-only`` : CloudFront can respond to HTTPS requests from viewers that support
                      ...
                      . To learn about options to explore if you have users with browsers that don't
                      include SNI support, see `Choosing How CloudFront Serves HTTPS Requests
                      ...
                      * ``vip`` : CloudFront uses dedicated IP addresses for your content and can respond
                      to HTTPS requests from any viewer. However, there are additional monthly charges. For
        ...
        <https://docs.aws.amazon.com/cloudfront/latest/APIReference/API_ViewerCertificate.html#cloudfront-Type-ViewerCertificate-CloudFrontDefaultCertificate>`__
                  ...
                  - **Restrictions** *(dict) --*
                    ...
                    - **GeoRestriction** *(dict) --*
                      ...
                      - **Items** *(list) --*
                        ...
                        the *International Organization for Standardization* website. You can also refer to
                        the country list on the CloudFront console, which includes both country names and
                        codes.
                  ...
                  - **AliasICPRecordals** *(list) --*
                    ...
                    as a CNAME, that they've added to CloudFront. AliasICPRecordal provides the ICP
