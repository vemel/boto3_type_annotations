...
class Client(BaseClient):
    ...
    def create_cluster(
        ...
        **Request Syntax**
        ...
        :param SubnetIds: **[REQUIRED]**
          ...
          The identifiers (IDs) of the subnets where you are creating the cluster. You must specify at
          least one subnet. If you specify multiple subnets, they must meet the following criteria:
        ...
        :param SourceBackupId:
          ...
          The identifier (ID) of the cluster backup to restore. Use this value to restore the cluster from
          a backup instead of creating a new cluster. To find the backup ID, use  DescribeBackups .
    ...
    def delete_hsm(
        ...
        """
        Deletes the specified HSM. To specify an HSM, you can use its identifier (ID), the IP address of
        the HSM's elastic network interface (ENI), or the ID of the HSM's ENI. You need to specify only one
        of these values. To find these values, use  DescribeClusters .
    ...
    def describe_backups(
        ...
        This is a paginated operation, which means that each response might contain only a subset of all
        the backups. When the response contains only a subset of backups, it includes a ``NextToken``
    ...
    def describe_clusters(
        ...
        This is a paginated operation, which means that each response might contain only a subset of all
        the clusters. When the response contains only a subset of clusters, it includes a ``NextToken``
        value. Use this value in a subsequent ``DescribeClusters`` request to get more clusters. When you
        receive a response with no ``NextToken`` (or an empty or null value), that means there are no more
        clusters to get.
    ...
    def initialize_cluster(
        ...
        sign the cluster's certificate signing request (CSR) with your issuing CA. To get the cluster's
        CSR, use  DescribeClusters .
        ...
        **Request Syntax**
        ...
        :param TrustAnchor: **[REQUIRED]**
          ...
          cluster certificate. This can be a root (self-signed) certificate or a certificate chain that
          begins with the certificate that issued the cluster certificate and ends with a root certificate.
          The certificate or certificate chain must be in PEM format and can contain a maximum of 5000
          characters.
    ...
    def list_tags(
        ...
        This is a paginated operation, which means that each response might contain only a subset of all
        the tags. When the response contains only a subset of tags, it includes a ``NextToken`` value. Use
        this value in a subsequent ``ListTags`` request to get more tags. When you receive a response with
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          The maximum number of tags to return in the response. When there are more tags than the number
