...
class Client(BaseClient):
    ...
    def continue_update_rollback(
        ...
        the ``UPDATE_ROLLBACK_COMPLETE`` state. Depending on the cause of the failure, you can manually
        `fix the error
        ...
        **Request Syntax**
        ...
        :param RoleARN:
          ...
          If you don't specify a value, AWS CloudFormation uses the role that was previously associated
          with the stack. If no role is available, AWS CloudFormation uses a temporary session that is
        ...
        :param ResourcesToSkip:
          ...
          for other reasons, for example, because an update was cancelled. To check why a resource update
          ...
          .. warning::
            ...
            <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/troubleshooting.html#troubleshooting-errors-update-rollback-failed>`__
            resources before skipping them. AWS CloudFormation sets the status of the specified resources
            to ``UPDATE_COMPLETE`` and continues to roll back the stack. After the rollback is complete,
            the state of the skipped resources will be inconsistent with the state of the resources in the
            stack template. Before performing another stack update, you must update the stack or resources
            to be consistent with each other. If you don't, subsequent stack updates might fail, and the
        ...
        :param ClientRequestToken:
          ...
          A unique identifier for this ``ContinueUpdateRollback`` request. Specify this token if you plan
          to retry requests so that AWS CloudFormation knows that you're not attempting to continue the
    ...
    def create_change_set(
        ...
        set and lists the differences. Use change sets to understand which resources AWS CloudFormation
        will create or change, and how it will change resources in an existing stack, before you create or
        update a stack.
        ...
        **Request Syntax**
        ...
        :param StackName: **[REQUIRED]**
          ...
          information that you submit, such as a modified template or different parameter input values.
        ...
        :param TemplateURL:
          ...
          The location of the file that contains the revised template. The URL must point to a template
          (max size: 460,800 bytes) that is located in an S3 bucket. AWS CloudFormation generates the
        ...
        :param ResourceTypes:
          ...
          set, such as ``AWS::EC2::Instance`` , ``AWS::EC2::*`` , or ``Custom::MyCustomInstance`` .
          ...
          Management
          <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-iam-template.html>`__ in
        ...
        :param ChangeSetType:
          ...
          If you create a change set for a new stack, AWS Cloudformation creates a stack with a unique
    ...
    def create_stack(
        ...
        **Request Syntax**
        ...
        :param TemplateURL:
          ...
          460,800 bytes) that is located in an Amazon S3 bucket. For more information, go to the `Template
        ...
        :param RoleARN:
          ...
          The Amazon Resource Name (ARN) of an AWS Identity and Access Management (IAM) role that AWS
          CloudFormation assumes to create the stack. AWS CloudFormation uses the role's credentials to
          make calls on your behalf. AWS CloudFormation always uses this role for all future operations on
          the stack. As long as users have permission to operate on the stack, AWS CloudFormation uses this
          role even if the users don't have permission to pass it. Ensure that the role grants least
          privilege.
        ...
        :param Tags:
          ...
          Key-value pairs to associate with this stack. AWS CloudFormation also propagates these tags to
          the resources created in the stack. A maximum number of 50 tags can be specified.
        ...
        :param ClientRequestToken:
          ...
          same name. You might retry ``CreateStack`` requests to ensure that AWS CloudFormation
    ...
    def create_stack_set(
        ...
        **Request Syntax**
        ...
        :param Description:
          ...
          A description of the stack set. You can use the description to identify the stack set's purpose
        ...
        :param Tags:
          ...
          ``CreateStackSet`` action fails with an ``access denied`` error, and the stack set is not created.
    ...
    def delete_stack(
        ...
        **Request Syntax**
        ...
        :param RetainResources:
          ...
          with the resources you want to retain. During deletion, AWS CloudFormation deletes the stack but
          does not delete the retained resources.
        ...
        :param RoleARN:
          ...
          The Amazon Resource Name (ARN) of an AWS Identity and Access Management (IAM) role that AWS
          CloudFormation assumes to delete the stack. AWS CloudFormation uses the role's credentials to
        ...
        :param ClientRequestToken:
          ...
          same name. You might retry ``DeleteStack`` requests to ensure that AWS CloudFormation
          successfully received them.
    ...
    def delete_stack_instances(
        ...
        **Request Syntax**
        ...
        :param RetainStacks: **[REQUIRED]**
          ...
          Removes the stack instances from the specified stack set, but doesn't delete the stacks. You
    ...
    def describe_change_set(
        ...
        """
        Returns the inputs for the change set and a list of changes that AWS CloudFormation will make if
        you execute the change set. For more information, see `Updating Stacks Using Change Sets
    ...
    def describe_stack_resources(
        ...
        """
        Returns AWS resource descriptions for running and deleted stacks. If ``StackName`` is specified,
        ...
        can specify ``LogicalResourceId`` to filter the returned result. For more information about
        resources, the ``LogicalResourceId`` and ``PhysicalResourceId`` , go to the `AWS CloudFormation
        User Guide <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/>`__ .
    ...
    def describe_stacks(
        ...
        the description for all the stacks created.
    ...
    def detect_stack_drift(
        ...
        For each resource in the stack that supports drift detection, AWS CloudFormation compares the
        actual configuration of the resource with its expected template configuration. Only resource
        properties explicitly defined in the stack template are checked for drift. A stack is considered to
        have drifted if one or more of its resources differ from their expected template configurations.
    ...
    def detect_stack_resource_drift(
        ...
        template parameters. This information includes actual and expected property values for resources in
        which AWS CloudFormation detects drift. Only resource properties explicitly defined in the stack
        template are checked for drift. For more information about stack and resource drift, see `Detecting
    ...
    def estimate_template_cost(
        ...
        **Request Syntax**
        ...
        :param TemplateURL:
          ...
          Location of file containing the template body. The URL must point to a template that is located
          in an Amazon S3 bucket. For more information, go to `Template Anatomy
          <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-anatomy.html>`__ in the
          AWS CloudFormation User Guide.
    ...
    def execute_change_set(
        ...
        **Request Syntax**
        ...
        :param ClientRequestToken:
          ...
          A unique identifier for this ``ExecuteChangeSet`` request. Specify this token if you plan to
          retry requests so that AWS CloudFormation knows that you're not attempting to execute a change
          set to update a stack with the same name. You might retry ``ExecuteChangeSet`` requests to ensure
    ...
    def get_template_summary(
        ...
        **Request Syntax**
        ...
        :param TemplateURL:
          ...
          Location of file containing the template body. The URL must point to a template (max size:
          460,800 bytes) that is located in an Amazon S3 bucket. For more information about templates, see
          `Template Anatomy
          <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-anatomy.html>`__ in the
          AWS CloudFormation User Guide.
    ...
    def update_stack(
        ...
        **Request Syntax**
        ...
        :param StackPolicyDuringUpdateBody:
          ...
          this update. If you do not specify a stack policy, the current policy that is associated with the
          stack will be used.
        ...
        :param RoleARN:
          ...
          The Amazon Resource Name (ARN) of an AWS Identity and Access Management (IAM) role that AWS
          CloudFormation assumes to update the stack. AWS CloudFormation uses the role's credentials to
          make calls on your behalf. AWS CloudFormation always uses this role for all future operations on
          the stack. As long as users have permission to operate on the stack, AWS CloudFormation uses this
          role even if the users don't have permission to pass it. Ensure that the role grants least
          privilege.
        ...
        :param ClientRequestToken:
          ...
          same name. You might retry ``UpdateStack`` requests to ensure that AWS CloudFormation
          successfully received them.
    ...
    def update_stack_instances(
        ...
        During stack set updates, any parameters overridden for a stack instance are not updated, but
        ...
        **Request Syntax**
        ...
        :param ParameterOverrides:
          ...
          * To leave all parameters set to their present values, do not specify this property at all.
          ...
          You can only override the parameter *values* that are specified in the stack set; to add or
          delete a parameter itself, use ``UpdateStackSet`` to update the stack set template. If you add a
    ...
    def update_stack_set(
        ...
        **Request Syntax**
        ...
        :param AdministrationRoleARN:
          ...
          Specify an IAM role only if you are using customized administrator roles to control which users
          or groups can manage specific stack sets within the same administrator account. For more
          information, see `Granting Permissions for Stack Set Operations
          <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacksets-prereqs.html>`__ in the
          *AWS CloudFormation User Guide* .
        ...
        :param ExecutionRoleName:
          ...
          If you specify a customized execution role, AWS CloudFormation uses that role to update the
          stack. If you do not specify a customized execution role, AWS CloudFormation performs the update
          using the role previously associated with the stack set, so long as you have permissions to
        ...
        :param Accounts:
          ...
          The accounts in which to update associated stack instances. If you specify accounts, you must
          also specify the regions in which to update stack set instances.
    ...
    def validate_template(
        ...
        """
        Validates a specified template. AWS CloudFormation first checks if the template is valid JSON. If
        it isn't, AWS CloudFormation checks if the template is valid YAML. If both these checks fail, AWS
        ...
        **Request Syntax**
        ...
        :param TemplateURL:
          ...
          Location of file containing the template body. The URL must point to a template (max size:
          460,800 bytes) that is located in an Amazon S3 bucket. For more information, go to `Template
          Anatomy <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-anatomy.html>`__
          in the AWS CloudFormation User Guide.
