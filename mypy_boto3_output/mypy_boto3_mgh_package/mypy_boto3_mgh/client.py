...
class Client(BaseClient):
    ...
    def delete_progress_update_stream(
        ...
        * ``CreateProgressUpdateStream`` , ``ImportMigrationTask`` , ``NotifyMigrationTaskState`` , and all
        Associate[*] APIs realted to the tasks belonging to the stream will throw "InvalidInputException"
    ...
    def put_resource_attributes(
        ...
        Application Discovery Service (ADS)'s repository. This association occurs asynchronously after
        ...
        **Request Syntax**
        ...
        :param ResourceAttributeList: **[REQUIRED]**
          ...
          a resource in the Application Discovery Service (ADS)'s repository.
          ...
          .. warning::
            ...
            * If any "VM" related value is set for a ``ResourceAttribute`` object, it is required that
            ...
            server in Application Discovery Service (ADS)'s repository. See the `Example
