...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_get_execution_history_paginator(client: Client) -> GetExecutionHistoryPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_activities_paginator(client: Client) -> ListActivitiesPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_executions_paginator(client: Client) -> ListExecutionsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_state_machines_paginator(client: Client) -> ListStateMachinesPaginator:
    """
