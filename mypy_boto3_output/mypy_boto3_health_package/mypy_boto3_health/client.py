...
class Client(BaseClient):
    ...
    def describe_event_aggregates(
        ...
        notification). If no filter is specified, the counts of all events in each category are returned.
    ...
    def describe_event_details(
        ...
        event data (region, service, etc., as returned by  DescribeEvents ), a detailed event description,
        and possible additional metadata that depends upon the nature of the event. Affected entities are
