...
class Client(BaseClient):
    ...
    def create_schema(self, Name: str) -> ClientCreateSchemaResponseTypeDef:
        ...
        * *Applied:* Applied schemas are mutable in a way that allows you to add new schema facets. You can
        also add new, nonrequired attributes to existing schema facets. You can apply only published
        schemas to directories.
    ...
    def delete_object(
        ...
        """
        Deletes an object and its associated attributes. Only objects with no children and no parents can
        be deleted. The maximum number of attributes that can be deleted during an object deletion is 30.
    ...
    def detach_object(
        ...
        """
        Detaches a given object from the parent object. The object that is to be detached from the parent
        is specified by the link name.
    ...
    def list_tags_for_resource(
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          The ``MaxResults`` parameter sets the maximum number of results returned in a single page. This
    ...
    def lookup_policy(
        ...
        have the policies attached, it returns the ``ObjectIdentifier`` for such objects. If policies are
        present, it returns ``ObjectIdentifier`` , ``policyId`` , and ``policyType`` . Paths that don't
    ...
    def update_typed_link_facet(
        ...
        **Request Syntax**
        ...
        :param IdentityAttributeOrder: **[REQUIRED]**
          ...
          order in which they are supplied to any API calls. For more information about identity
    ...
    def upgrade_published_schema(
        ...
        **Request Syntax**
        ...
        :param DryRun:
          ...
          Used for testing whether the Development schema provided is backwards compatible, or not, with
          the publish schema provided by the user to be upgraded. If schema compatibility fails, an
          exception would be thrown else the call would succeed. This parameter is optional and defaults to
          false.
