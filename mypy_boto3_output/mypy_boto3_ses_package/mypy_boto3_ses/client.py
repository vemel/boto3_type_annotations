...
class Client(BaseClient):
    ...
    def list_configuration_sets(
        ...
        AWS Region. For information about using configuration sets, see `Monitoring Your Amazon SES Sending
        ...
        configuration sets, this operation will also return a NextToken element. You can then execute the
    ...
    def list_custom_verification_email_templates(
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          The maximum number of custom verification email templates to return. This value must be at least
          1 and less than or equal to 50. If you do not specify a value, or if you specify a value less
          than 1 or greater than 50, the operation will return up to 50 results.
    ...
    def list_templates(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          A token returned from a previous call to ``ListTemplates`` to indicate the position in the list
          of email templates.

        :type MaxItems: integer
        :param MaxItems:

          The maximum number of templates to return. This value must be at least 1 and less than or equal
          to 10. If you do not specify a value, or if you specify a value less than 1 or greater than 10,
    ...
    def send_bounce(
        ...
        **Request Syntax**
        ...
        :param Explanation:
          ...
          Human-readable text for the bounce message to explain the failure. If not specified, the text
          will be auto-generated based on the bounced recipient information.
        ...
        :param BounceSenderArn:
          ...
          "From" header of the bounce. For more information about sending authorization, see the `Amazon
          SES Developer Guide
          <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/sending-authorization.html>`__ .
    ...
    def send_bulk_templated_email(
        ...
        * Each ``Destination`` parameter must include at least one recipient email address. The recipient
        ...
        entire message will be rejected, even if the message contains other recipients that are valid.
        ...
        **Request Syntax**
        ...
        :param Source: **[REQUIRED]**
          ...
          .. note::
            ...
            characters <https://en.wikipedia.org/wiki/Email_address#Local-part>`__ . If the *domain part*
            of an address (the part after the @ sign) contains non-ASCII characters, they must be encoded
            using Punycode, as described in `RFC3492 <https://tools.ietf.org/html/rfc3492.html>`__ . The
            sender name (also known as the *friendly name* ) may contain non-ASCII characters. These
            characters must be encoded using MIME encoded-word syntax, as described in `RFC 2047
        ...
        :param ReturnPath:
          ...
          This email address must be either individually verified with Amazon SES, or from a domain that
    ...
    def send_custom_verification_email(
        ...
        Region and attempts to verify it. As a result of executing this operation, a customized
    ...
    def send_raw_email(
        ...
        * If you are using sending authorization to send on behalf of another user, ``SendRawEmail``
        ...
        parameters in one of two ways: you can pass optional parameters ``SourceArn`` , ``FromArn`` ,
        and/or ``ReturnPathArn`` to the API, or you can include the following X-headers in the header of
        your raw email:
        ...
        **Request Syntax**
        ...
        :param Source:
          ...
          The identity's email address. If you do not provide a value for this parameter, you must specify
          a "From" address in the raw text of the message. (You can also specify both.)
    ...
    def send_templated_email(
        ...
        * The ``Destination`` parameter must include at least one recipient email address. The recipient
        ...
        .. warning::
          ...
          Amazon SES API
          <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/send-personalized-email-api.html>`__ in
    ...
    def set_identity_dkim_enabled(self, Identity: str, DkimEnabled: bool) -> Dict:
        ...
        that domain. If Easy DKIM signing is enabled for an email address, then Amazon SES uses DKIM to
        ...
        You can enable DKIM signing for an identity at any time after you start the verification process
        for the identity, even if the verification process isn't complete.
    ...
    def set_identity_feedback_forwarding_enabled(
        ...
        **Request Syntax**
        ...
        :param ForwardingEnabled: **[REQUIRED]**
          ...
          specifies that Amazon SES will forward bounce and complaint notifications as email, in addition
          to any Amazon SNS topic publishing otherwise specified. ``false`` specifies that Amazon SES will
    ...
    def set_identity_headers_in_notifications_enabled(
        ...
        **Request Syntax**
        ...
        :param Enabled: **[REQUIRED]**
          ...
          specified notification type. A value of ``true`` specifies that Amazon SES will include headers
          in notifications, and a value of ``false`` specifies that Amazon SES will not include headers in
          notifications.
    ...
    def set_identity_mail_from_domain(
        ...
        """
        Enables or disables the custom MAIL FROM domain setup for a verified identity (an email address or
        a domain).
    ...
    def verify_domain_dkim(self, Domain: str) -> ClientVerifyDomainDkimResponseTypeDef:
        ...
        .. warning::
          ...
          list of identities that are associated with your account. This is true even if you haven't
          already associated the domain with your account by using the ``VerifyDomainIdentity`` operation.
          However, you can't send email from the domain until you either successfully `verify it
        ...
        detects that you've added these records to the DNS configuration for a domain, you can start
        sending email from that domain. You can start sending email even if you haven't added the TXT
        record provided by the VerifyDomainIdentity operation to the DNS configuration for your domain. All
