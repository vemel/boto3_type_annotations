"Helper functions for importexport service"
...
def boto3_client(
    ...
    """
    Equivalent of `boto3.client('importexport')`, returns a correct type.
    """
    kwargs: Dict[str, Any] = {}
    ...
    if session is not None:
        return session.client("importexport", **kwargs)
    return boto3.client("importexport", **kwargs)
