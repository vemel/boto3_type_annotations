...
class Client(BaseClient):
    ...
    def cancel_job(
        ...
        """
        This operation cancels a specified job. Only the job owner can cancel it. The operation fails if
        the job has already started or is complete.
    ...
    def create_job(
        ...
        **Request Syntax**
        ...
        :param ValidateOnly: **[REQUIRED]** Validate the manifest and parameter values in the request but
    ...
    def get_shipping_label(
        ...
        **Request Syntax**
        ...
        :type street2: string
        :param street2: Specifies the optional second part of the street address for the return address,
        for example Suite 100.
